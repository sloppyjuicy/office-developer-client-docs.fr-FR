...
> [!NOTE]
> Vous voulez développer des solutions qui étendent l’expérience Office sur [plusieurs plateformes](https://docs.microsoft.com/fr-FR/office/dev/add-ins/overview/office-add-in-availability) ? Consultez le nouveau [modèle de compléments Office](https://docs.microsoft.com/fr-FR/office/dev/add-ins/overview/office-add-ins). 
  
### <a name="viewed-most"></a>Articles populaires
  
- [Référence de la bibliothèque d’objets VBA Office](https://msdn.microsoft.com/fr-FR/library/office/ff862474.aspx)
  
- [Référence de langage VBA pour Office](https://msdn.microsoft.com/fr-FR/library/office/gg264383.aspx)
  
- [Office 2010](https://msdn.microsoft.com/fr-FR/library/office/cc313152%28v=office.12%29.aspx)
  
### <a name="office-add-ins"></a>Compléments Office
  
- [Prise en main](https://dev.office.com/getting-started/addins)
  
- [Vue d’ensemble de la plateforme](https://msdn.microsoft.com/fr-FR/library/office/jj220082.aspx)
  
### <a name="sharepoint-add-ins"></a>Compléments SharePoint
  
- [Prise en main](https://dev.office.com/getting-started)
  
- [Vue d’ensemble de la plateforme](https://msdn.microsoft.com/fr-FR/library/office/fp179930.aspx)
...
- [Access](https://msdn.microsoft.com/fr-FR/library/fp179695.aspx)
  
- [Excel](https://msdn.microsoft.com/fr-FR/library/fp179694.aspx)
  
- [InfoPath](https://msdn.microsoft.com/fr-FR/library/fp179694.aspx)
  
- [Référence de la bibliothèque d’objets VBA Office](https://msdn.microsoft.com/fr-FR/library/office/ff862474.aspx)
  
- [Référence de langage VBA pour Office](https://msdn.microsoft.com/fr-FR/library/office/gg264383.aspx)
  
- [Office partagé](https://msdn.microsoft.com/fr-FR/library/hh872753.aspx)
  
- [OneNote](https://msdn.microsoft.com/fr-FR/library/jj680121.aspx) (API uniquement pour les solutions de client de bureau OneNote Win32 dans les scénarios non connectés) 
  
- [Outlook](https://msdn.microsoft.com/fr-FR/library/fp161224.aspx)
  
- [PowerPoint](https://msdn.microsoft.com/fr-FR/library/fp161225.aspx)
  
- [Project](https://msdn.microsoft.com/fr-FR/library/fp161358.aspx)
  
- [Publisher](https://msdn.microsoft.com/fr-FR/library/jj684499.aspx)
  
- [Visio](https://msdn.microsoft.com/fr-FR/library/fp161226.aspx)
  
- [Word](https://msdn.microsoft.com/fr-FR/library/fp179696.aspx)
