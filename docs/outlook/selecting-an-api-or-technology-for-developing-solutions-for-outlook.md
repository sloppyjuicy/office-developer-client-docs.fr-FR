...
|Objets principaux  <br/> |L’API JavaScript pour Office fournit quelques objets au niveau supérieur qui sont partagés par tous les types de compléments Office : [Office](https://msdn.microsoft.com/library/c490b13d-ee52-4291-af5d-f4a5a11d3af0%28Office.15%29.aspx), [Contexte](https://msdn.microsoft.com/library/662883d5-b86f-4bdc-99f0-9ee9129ed16c%28Office.15%29.aspx), et [AysncResult](https://msdn.microsoft.com/library/540c114f-0398-425c-baf3-7363f2f6bc47%28Office.15%29.aspx). Le niveau suivant de l’API applicable et spécifique aux applications de messagerie comprend le [Boîte aux lettres](https://msdn.microsoft.com/library/a3880d3b-8a09-4cf9-9274-f2682cb3b769%28Office.15%29.aspx), [Élément](https://msdn.microsoft.com/library/ad288df1-3ca2-474c-bea4-c51f46e6fc43%28Office.15%29.aspx), et [UserProfile](https://msdn.microsoft.com/library/6d0a36ec-0d5c-40e3-9f6f-9a7fcf0ac3d8%28Office.15%29.aspx) objets, qui prennent en charge l’accès aux informations sur l’utilisateur et l’élément actuellement sélectionné dans la boîte aux lettres de l’utilisateur. Au niveau des données, le [CustomProperties](https://msdn.microsoft.com/library/95a69bd6-c4dc-429a-8b27-e2b68f74f3e3%28Office.15%29.aspx) et [RoamingSettings](https://msdn.microsoft.com/library/cf21bb08-7274-4ad6-ae9e-b2c12f92abc9%28Office.15%29.aspx) les objets prennent en charge les propriétés persistantes configurées par l’application de messagerie pour l’élément sélectionné et pour la boîte aux lettres de l’utilisateur, respectivement. Les objets au niveau de l’élément incluent [Rendez-vous](https://msdn.microsoft.com/library/08ebffff-eb52-4e21-9d4e-8f79e426f992%28Office.15%29.aspx) et [Message](https://msdn.microsoft.com/library/909ad9eb-a1bc-4caa-b51e-fd59a02b9569%28Office.15%29.aspx) objets qui héritent de **Élément**, et l’objet [MeetingRequest](https://msdn.microsoft.com/library/c658fa3d-1138-4a67-9a4b-c9edd11f8385%28Office.15%29.aspx) qui hérite de **Message**. Ceux-ci représentent les types d’éléments Outlook qui prennent en charge les applications de messagerie : les éléments de calendrier des rendez-vous et des réunions, et les éléments de message tels que les messages électroniques, les demandes de réunion, les réponses et les annulations. Au-delà de ce niveau dans l’API se trouvent les propriétés au niveau de l’élément (telles que [Appointment.subject](https://msdn.microsoft.com/library/ffa6812c-34b8-4b0a-8f92-22c3580c8379%28Office.15%29.aspx)) ainsi que des objets et des propriétés qui prennent en charge certains éléments connus [Entités](https://msdn.microsoft.com/library/1a06c8d1-dafe-46f4-967e-dd9b1d5b20e9%28Office.15%29.aspx) objets (par exemple [Contact](https://msdn.microsoft.com/library/2604b44c-7b79-47f0-ac3e-7d99bc9e6751%28Office.15%29.aspx), [MeetingSuggestion](https://msdn.microsoft.com/library/9726fbff-0f4f-4b70-8deb-effc14607d4e%28Office.15%29.aspx), [PhoneNumber](https://msdn.microsoft.com/library/cc86426a-2730-4774-9067-0611e5c8e9c1%28Office.15%29.aspx), et [TaskSuggestion](https://msdn.microsoft.com/library/16b0c3d6-adf4-4a88-ad09-4bb5565816b1%28Office.15%29.aspx)). Voir [Présentation de l’architecture et des fonctionnalités des compléments Outlook](https://msdn.microsoft.com/library/2cd5641b-492b-4431-8388-7fc589163e9c%28Office.15%29.aspx) pour un résumé des fonctionnalités prises en charge pour les applications de messagerie. |
...
|Méthodes de déploiement  <br/> |Vous pouvez publier des applications de messagerie sur Office Store ou sur un catalogue Exchange qui met l’application à la disposition des utilisateurs sur ce serveur Exchange. Les administrateurs ou les utilisateurs peuvent ensuite choisir d’installer une application de messagerie à partir du catalogue Office Store ou Exchange, en utilisant soit le centre d’administration Exchange (EAC), soit en exécutant des applets de commande Windows PowerShell à distance. Vous pouvez accéder au CAE à partir du mode Outlook Backstage ou d’Outlook Web App, ou en vous connectant directement au CAE pour votre boîte aux lettres. Pour plus d’informations, voir [Déployer et installer des compléments Outlook à des fins de test](https://msdn.microsoft.com/library/d6eea4c4-bb21-4f24-bcba-1eccbb4e12dd%28Office.15%29.aspx). |
...
Si votre solution Outlook est destinée à s’exécuter sur Outlook 2010 et non sur des versions antérieures, vous pouvez choisir d’utiliser le modèle d’objet ou le PIA pour prendre en charge les scénarios présentés dans cette section suivante. Cette section spécifie les principaux objets ou membres que vous pouvez utiliser dans le modèle d’objet Outlook pour étendre chaque scénario (à l’exception des interfaces [IRibbonControl](/office/vba/api/Office.IRibbonControl), [IRibbonExtensibility](/office/vba/api/Office.IRibbonExtensibility) et [IRibbonUI](/office/vba/api/Office.IRibbonUI) qui se trouvent dans le modèle d’objet Office, que vous pouvez intégrer à l’objet Outlook maquette). 
...
- [Créer une carte de visite pour une entrée d’adresse](/office/vba/api/Outlook.NameSpace.CreateContactCard)
...
- [Afficher tous les contacts du dossier actuel](/office/vba/api/Outlook.peopleview)
...
- [Détecter si les propriétés d’élément de lecture sont complètes](/office/vba/outlook/How-to/Items-Folders-and-Stores/outlook-item-objects)
...
[Vue d'ensemble de la plateforme des compléments pour Office](/office/dev/add-ins/overview/office-add-ins) fournit une bonne introduction sur les Compléments Office, notamment l'architecture et le cycle de vie de développement. 
  
Consultez l’article [Compléments Outlook](/office/dev/add-ins/outlook/outlook-add-ins-overview) pour une feuille de route détaillée des ressources concernant le développement d’applications de courrier. 
...
- Objet [Account](/office/vba/api/Outlook.Account) 

    
- Propriété [NameSpace.Accounts](/office/vba/api/Outlook.NameSpace.Accounts) 
...
- [Obtenir une instance de Outlook et s’y connecter](https://msdn.microsoft.com/library/ef369364-6500-2759-3ef4-ed4411112e96%28Office.15%29.aspx)
...
- [Présentation : Ajouter une zone de formulaire à une page existante d'un formulaire](https://msdn.microsoft.com/library/3c988dac-f171-966d-cf9a-17139353d604%28Office.15%29.aspx)
...
- [Référence pour développeur Outlook 2013](/office/vba/api/overview/outlook)   
- [Référence pour l'assembly PIA (Primary Interop Assembly) d'Outlook 2010](./pia/welcome-to-the-outlook-primary-interop-assembly-reference.md)   
- [Référence MAPI Outlook](./mapi/outlook-mapi-reference.md)   
...
- Exemples de code de modèle objet : [Comment faire... (Référence du développeur outlook 2013)](/office/vba/outlook/concepts/miscellaneous/how-do-i-outlook-vba-reference)  
- Exemples de code d'assembly PIA : [Comment faire... dans Outlook 2010](./pia/how-do-i-outlook-2013-pia-reference.md)  
- [Exemples MAPI](./mapi/mapi-samples.md)
