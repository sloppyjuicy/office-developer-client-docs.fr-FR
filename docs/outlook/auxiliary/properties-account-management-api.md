...
|[PROP_ACCT_MINI_UID](prop_acct_mini_uid.md) <br/> |Renvoie un identificateur de compte unique dans les profils Outlook.  <br/> |
...
|[PROP_MAPI_TRANSPORT_FLAGS](prop_mapi_transport_flags.md) <br/> |Représente les paramètres de transport qu’Outlook utilise pour déterminer les tâches de synchronisation nécessaires et pour désactiver les éléments d’interface utilisateur que le compte ne prend pas en charge.  <br/> |
