...
Annule l'inscription d'un client avec le gestionnaire de comptes pour les notifications pour tous les comptes. 
...
> dans Cookie renvoyé par [IOlkAccountManager:: Advise](iolkaccountmanager-advise.md).
