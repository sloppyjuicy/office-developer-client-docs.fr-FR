...
Indique s'il faut utiliser l'authentification pour le compte SMTP.
...
Si la valeur est zéro, l'authentification n'est pas utilisée, sinon l'authentification est utilisée.
