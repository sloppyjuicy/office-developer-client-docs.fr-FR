...
Prend en charge la relocalisation des rendez-vous dans un dossier de calendrier.
...
|Exposé sur:  <br/> |Objet de relocalisation Outlook  <br/> |
...
|**[BeginRebaseAppointments](iolkapptrebaser-beginrebaseappointments.md)** <br/> |Commence une tâche pour la relocalisation des rendez-vous en fonction d'une liste de rendez-vous, généralement obtenue à partir de **EndEnumerateAppointments**.  <br/> |
