...
Indique s'il faut utiliser l'authentification par mot de passe sécurisé (SPA) pour une boîte aux lettres Internet générale.
...
Une valeur nulle signifie ne pas utiliser SPA, sinon utiliser SPA.
