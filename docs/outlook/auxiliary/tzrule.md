...
> Les indicateurs définis pour ce membre identifient des détails plus spécifiques pour cette règle de fuseau horaire. Les indicateurs possibles sont les suivantes :
   ...
   - **TZRULE_FLAG_RECUR_CURRENT_TZREG** — des réunions périodiques, identifie la règle de correspondance de la règle de [PidLidTimeZoneStruct](https://msdn.microsoft.com/library/2acf0036-2f3e-4f90-8614-7aa667860f74%28Office.15%29.aspx). Cela peut être utilisé pour détecter si **PidLidTimeZoneStruct** a été modifié considérablement par un client hérité, qui doit être ignore la nouvelle propriété plus complète. 
