...
1. [ISocialSession::LoggedOnUserID](isocialsession-loggedonuserid.md) : OSC obtient l’ID utilisateur de l’utilisateur Office connecté au réseau social. 
