...
Cette propriété contient un flux de données XML arbitraire. Autres propriétés dans le message peuvent impliquer des schémas spécifiques à utiliser dans cette propriété.
