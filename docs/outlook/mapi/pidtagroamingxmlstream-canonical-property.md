...
Cette propriété contient un flux arbitraire de données XML. Les autres propriétés du message peuvent impliquer des schémas spécifiques à utiliser dans cette propriété.
