...
Lorsque la demande de réunion représente une série périodique ou une exception, il s’agit de la valeur du champ CalendarType à partir de la propriété **dispidApptRecur** . Dans le cas contraire, cette propriété n’est pas définie et par défaut est 0. 
