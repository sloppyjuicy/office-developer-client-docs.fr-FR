...
Contient une valeur de champ d'en-tête de classe Content-class [RFC3282].
...
Pour définir la valeur de cette propriété, les clients MIME (Multipurpose Internet Message extensions) doivent écrire un champ d'en-tête de classe content avec la valeur souhaitée. Les lecteurs MIME doivent copier la valeur d'un champ d'en-tête Content-class à la valeur de cette propriété. 
