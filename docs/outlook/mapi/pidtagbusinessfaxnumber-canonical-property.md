...
Contient le numéro de téléphone de l’ordinateur de télécopie du destinataire business. 
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |NUMÉRO_FAX_BUREAU_PR, PR_BUSINESS_FAX_NUMBER_A, PR_BUSINESS_FAX_NUMBER_W  <br/> |
...
Ces propriétés sont des exemples de propriétés qui fournit l’identification et accéder aux informations sur un destinataire. Ces propriétés sont définies par le destinataire et l’organisation du destinataire. 
