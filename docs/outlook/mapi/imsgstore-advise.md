...
Si vous choisissez prendre en charge de notification vous-même, appelez la méthode de [IUnknown::AddRef](https://msdn.microsoft.com/library/ms691379%28v=VS.85%29.aspx) du récepteur advise représenté par le paramètre _lpAdviseSink_ de conserver une copie de ce pointeur. Mettre à jour cette copie jusqu'à ce que votre méthode [IMsgStore::Unadvise](imsgstore-unadvise.md) est appelée pour annuler l’inscription. 
