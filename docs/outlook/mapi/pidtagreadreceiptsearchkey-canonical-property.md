...
Contient une clé de recherche pour l'utilisateur de messagerie auquel le système de messagerie doit diriger un rapport de lecture pour un message.
...
Si une application cliente souhaite recevoir lui-même des rapports de lecture, elle peut laisser cette propriété définie ou la clé de recherche contenue dans la propriété **PR_SENDER_SEARCH_KEY** ([PidTagSenderSearchKey](pidtagsendersearchkey-canonical-property.md)) au moment de l'envoi du message.
