...
Contient des métadonnées relatives à la feuille.
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |dispidLogFlags  <br/> |
|Jeu de propriétés:  <br/> |PSETID_Log  <br/> |
|ID long (couvercle):  <br/> |0x0000870C  <br/> |
|Type de données :  <br/> |PT_LONG  <br/> |
|Domaine :  <br/> |Journal  <br/> |
   
## <a name="remarks"></a>Remarques

Le champ de bits qui contient les métadonnées relatives au journal doit être nul ou «0x40000000».
