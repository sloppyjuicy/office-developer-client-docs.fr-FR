...
La chaîne contient un code de pays/région de deux caractères unique. 
...
[Propriété canonique PidTagLanguages](pidtaglanguages-canonical-property.md)
