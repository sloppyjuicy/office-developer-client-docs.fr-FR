...
|ID long (couvercle):  <br/> |0x00008517  <br/> |
...
Cette valeur doit être l'équivalent du temps universel coordonné (UTC) de la propriété **dispidTaskDueDate** ([PidLidTaskDueDate](pidlidtaskduedate-canonical-property.md)).
