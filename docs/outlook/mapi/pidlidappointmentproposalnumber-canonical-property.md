...
Spécifie le nombre de participants qui ont envoyé des propositions de compteurs qui n'ont pas été acceptées ou refusées par l'organisateur.
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |dispidApptProposalNum  <br/> |
|Jeu de propriétés:  <br/> |PSETID_Appointment  <br/> |
|ID long (couvercle):  <br/> |0x00008259  <br/> |
