...
---
# <a name="pidlidremotemessageclass-canonical-property"></a>Propri t canonique PidLidRemoteMessageClass

  
  
**S’applique à** : Outlook 2013 | Outlook 2016 
  
Indique la classe de message d’un élément distant.
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |dispidRemoteMsgClass  <br/> |
|Jeu de propriétés :  <br/> |PSETID_Remote  <br/> |
|ID long (LID) :  <br/> |0x00008F02  <br/> |
|Type de données :  <br/> |Aucun  <br/> |
