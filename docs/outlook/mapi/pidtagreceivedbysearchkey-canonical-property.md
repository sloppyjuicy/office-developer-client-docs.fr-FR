...
Cette propriété est une des propriétés d’adresse de l’utilisateur de messagerie qui reçoit le message. Elle doit être définie par le fournisseur de transport entrant.
