...
|ID long (couvercle):  <br/> |0x00008514  <br/> |
...
Il indique si l'objet message n'a pas de pièces jointes visibles par l'utilisateur final. Cette propriété peut être désdésactivée; Si c'est le cas, la valeur par défaut FALSe est supposée.
