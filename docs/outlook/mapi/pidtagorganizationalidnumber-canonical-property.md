...
Contient un numéro d'identification d'organisation pour le contact, tel qu'un numéro d'identification d'employé.
...
Il s'agit de propriétés facultatives. Leur utilisation est déterminée par l'utilisateur ou l'organisation de messagerie.
