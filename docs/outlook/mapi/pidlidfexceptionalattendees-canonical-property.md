...
La valeur FALSE, ou l’absence de cette propriété, indique que l’objet calendar n’a pas d’exceptions, ou aucun des messages d’exception incorporé a RecipientRows.
