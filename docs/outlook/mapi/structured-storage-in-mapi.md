...
Les objets de stockage sont superposés au-dessus du flux ou verrouillent des objets d’octets ; Ils peuvent contenir un ou plusieurs de ces objets, ainsi que d’autres objets de stockage. Les objets de stockage implémentent l’interface **IStorage** qui définit les méthodes de création, d’accès et de maintenance des objets imbrmbrés. 
...
**Fonctions pour accéder aux objets de stockage et de flux**
...
3. Recherchez les structures **STATSTG** qui sont marquées avec des STGTY_STREAM. 
