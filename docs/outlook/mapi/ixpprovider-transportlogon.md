...
_ulUIParam_: [in] Handle to the parent window of any dialog boxes or windows this method displays. Le _paramètre ulUIParam_ peut être non null, par exemple lorsque l’indicateur LOGON_SETUP est définie dans le paramètre _lpulFlags._ 
