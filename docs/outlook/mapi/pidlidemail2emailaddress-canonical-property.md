...
Spécifie le deuxième adresse de messagerie du contact.
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |dispidEmail2EmailAddress  <br/> |
|Jeu de propriétés :  <br/> |PSETID_Address  <br/> |
|ID de type long (capot) :  <br/> |0x00008093  <br/> |
|Type de données :  <br/> |PT_UNICODE  <br/> |
|Zone :  <br/> |Contact  <br/> |
   
## <a name="remarks"></a>Remarques

La valeur de cette propriété doit être appropriée pour le type d’adresse pour cette adresse de messagerie.
