...
|Content-type  <br/> |Texte/simple ou multiparte/mixte. Voir la section « Contenu des messages ».  <br/> |
...
Le premier jeton est le nom de fichier, qui peut contenir des espaces incorporés, afin que cet en-tête soit à partir de la droite sur les messages entrants. La taille est en octets ; la date est mise en  _forme mm-dd-yyyy et_ l’heure sous la forme  _hh:mm._
