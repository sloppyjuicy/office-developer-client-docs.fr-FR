...
ms.openlocfilehash: 4f32b715e0ae1abcab76cd20a064398f17b4f7fa
ms.sourcegitcommit: 2411ec8262cd0ed92f8a072fb53b51e3e496d49e
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 01/24/2022
ms.locfileid: "62180669"
---
...
|[Télécharger hiérarchie](upload-hierarchy-state.md) <br/> |Dossiers  <br/> |**LR_SYNC_UPLOAD_HIERARCHY** <br/> |**[UPHIER](uphier.md)** <br/> |
...
|[Télécharger l’état de la hiérarchie](download-hierarchy-state.md) <br/> |Dossiers  <br/> |**LR_SYNC_DOWNLOAD_HIERARCHY** <br/> |**[DNHIER](dnhier.md)** <br/> |
...
|8.  <br/> |Le client avertit le magasin local de la fin du chargement de la hiérarchie : en cas de réussite, le client définit l’indicateur [in] dans **UPHIER** avec **UPH_OK,** puis appelle **IOSTX::SetSyncResult (S_OK)** et **IOSTX::SyncEnd**. En cas d’échec, le client ne définirait pas **l’UPH_OK** défaut. Il appelle **IOSTX::SetSyncResult**, en passant la valeur **HRESULT** et **IOSTX::SyncEnd**.  <br/> |**LR_SYNC_UPLOAD_HIERARCHY** <br/> |**UPHIER** <br/> |
