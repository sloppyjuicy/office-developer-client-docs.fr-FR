...
Indique si le document a été envoyé par courrier électronique ou publié dans un dossier de serveur lors de la journalisation.
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |dispidLogDocPosted  <br/> |
|Jeu de propriétés:  <br/> |PSETID_Log  <br/> |
|ID long (couvercle):  <br/> |0x00008711  <br/> |
