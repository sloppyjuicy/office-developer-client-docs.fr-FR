...
Doit être égal à 0, sauf en cas de substitution par d'autres protocoles qui étendent le protocole d'objet message et pièce jointe, comme indiqué dans [[MS-OXCMSG]](https://msdn.microsoft.com/library/daa9120f-f325-4afb-a738-28f91049ab3c%28Office.15%29.aspx).
...
> Spécifie les propriétés et les opérations autorisées pour les objets journal.
