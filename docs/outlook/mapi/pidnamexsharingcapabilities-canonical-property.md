...
|Nom de la propriété :  <br/> |X--fonctionnalités de partage  <br/> |
|Type de données :  <br/> |PT_UNICODE  <br/> |
|Zone :  <br/> |Partage  <br/> |
   
## <a name="remarks"></a>Remarques

Cette propriété contient une valeur qui indique les fonctionnalités de partage de l’objet du message.
