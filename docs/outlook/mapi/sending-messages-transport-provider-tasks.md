...
- Définissez la propriété **PR_PROVIDER_SUBMIT_TIME** ([PidTagProviderSubmitTime](pidtagprovidersubmittime-canonical-property.md)) du message pour indiquer la date et l'heure auxquelles le fournisseur de banque de messages a marqué le message comme envoyé. 
