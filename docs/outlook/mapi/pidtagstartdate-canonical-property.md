...
Les applications de planification doivent définir à la fois cette propriété et les propriétés **PR_END_DATE** ([PidTagEndDate](pidtagenddate-canonical-property.md)) lors de l'envoi de demandes de réunion.
