...
|ID de type long (capot) :  <br/> |0x00008232  <br/> |
|Type de données :  <br/> |PT_UNICODE  <br/> |
|Zone :  <br/> |Calendrier  <br/> |
   
## <a name="remarks"></a>Remarques

Si cette propriété est définie, elle doit être définie pour une description de la périodicité qui est spécifiée par la propriété **dispidApptRecur** ([PidLidAppointmentRecur](pidlidappointmentrecur-canonical-property.md)).
