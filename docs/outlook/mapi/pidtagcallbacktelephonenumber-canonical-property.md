...
Ces propriétés sont des exemples de propriétés qui fournissent des informations d'identification et d'accès à un destinataire. Elles sont définies par le destinataire et l'organisation du destinataire. 
