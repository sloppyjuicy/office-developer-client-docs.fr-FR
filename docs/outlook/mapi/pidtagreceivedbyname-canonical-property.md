...
Ces propriétés sont un exemple des propriétés d’adresse de l’utilisateur de messagerie qui reçoit le message. Elles doivent être définies par le fournisseur de transport entrant.
