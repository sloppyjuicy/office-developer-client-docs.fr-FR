...
> [in] Handle vers un jeu défini dans mimeole.h de Windows Mail de caractères. Spécifiez **null** pour spécifier que vous ne souhaitez pas appliquer n’importe quel jeu de caractères spécifique. Pour des valeurs non - **null** , utilisez la fonction telles que [MimeOleGetCodePageCharset](http://msdn.microsoft.com/en-us/library/ms714746%28VS.85%29.aspx) pour obtenir un handle vers le jeu de caractères. 
