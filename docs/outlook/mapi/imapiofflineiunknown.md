...
Fournit des informations sur un objet hors connexion.
...
|**[GetCurrentState](imapioffline-getcurrentstate.md)** <br/> |Obtient l'État en ligne ou hors connexion actuel d'un objet hors connexion.  <br/> |
...
Un membre de cette interface est un espace réservé réservé à l'usage interne de Microsoft Outlook 2013 et peut faire l'objet de modifications. Les autres membres de cette interface doivent être utilisés uniquement comme document. 
