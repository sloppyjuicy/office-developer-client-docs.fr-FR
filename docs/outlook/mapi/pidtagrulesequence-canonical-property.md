...
Les règles sont évaluées en séquence en fonction de l'ordre croissant de cette valeur. L'ordre d'évaluation des règles qui ont la même valeur dans cette propriété n'est pas défini.
