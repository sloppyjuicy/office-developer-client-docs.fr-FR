...
Contient la valeur de chaque participant figurant dans la propriété **dispidNonSendableTo** ([PidLidNonSendableTo](pidlidnonsendableto-canonical-property.md)).
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |dispidNonSendToTrackStatus  <br/> |
|Jeu de propriétés:  <br/> |PSETID_Common  <br/> |
|ID long (couvercle):  <br/> |0x00008543  <br/> |
|Type de données :  <br/> |PT_MV_LONG  <br/> |
|Domaine :  <br/> |Messagerie générale  <br/> |
   
## <a name="remarks"></a>Remarques

Cette propriété est requise uniquement lorsque la propriété **dispidNonSendableTo** est définie. Le nombre de valeurs de cette propriété doit être égal au nombre de valeurs dans **dispidNonSendableTo**. Chaque valeur PT_LONG de cette propriété correspond au participant dans la propriété **dispidNonSendableTo** au même index. 
