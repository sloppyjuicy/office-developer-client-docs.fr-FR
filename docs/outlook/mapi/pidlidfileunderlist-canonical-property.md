...
|ID de type long (capot) :  <br/> |0x00008026  <br/> |
|Type de données :  <br/> |PT_MV_LONG  <br/> |
|Domaine :  <br/> |Contact  <br/> |
   
## <a name="remarks"></a>Remarques

Chaque valeur de la propriété à valeurs multiples doit être une des valeurs autorisées pour **dispidFileUnderId** spécifié dans [[MS-OXOCNTC]](https://msdn.microsoft.com/library/9b636532-9150-4836-9635-9c9b756c9ccf%28Office.15%29.aspx).
