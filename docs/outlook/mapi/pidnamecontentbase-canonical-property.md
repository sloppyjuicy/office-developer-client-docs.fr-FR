...
|Nom de la propriété :  <br/> |Base de contenu  <br/> |
|Type de données :  <br/> |PT_UNICODE  <br/> |
|Domaine :  <br/> |E-mail  <br/> |
   
## <a name="remarks"></a>Remarques

Pour définir la valeur de cette propriété, les clients Message Extensions MIME (Multipurpose Internet) doivent écrire la valeur souhaitée pour un champ d’en-tête Content-Base sur une entité MIME qui mappe sur un corps de message. Lecteurs MIME doivent copier la valeur d’un champ d’en-tête Content-Base sur ce une entité MIME sur la valeur de cette propriété.
