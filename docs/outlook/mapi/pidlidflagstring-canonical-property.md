...
Contient un index qui identifie l'un des jeux de chaînes de texte prédéfinies associées à l'indicateur.
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |dispidFlagStringEnum  <br/> |
|Jeu de propriétés:  <br/> |PSETID_Common  <br/> |
|ID long (couvercle):  <br/> |0x000085C0  <br/> |
...
Les paramètres par défaut suggérés à l'utilisateur pour les objets contact sont les suivants:
  
|**Valeur**|**Chaîne en anglais**|
|:-----|:-----|
|0x00000000 ou non  <br/> | Suivez les instructions relatives à l'affichage de **dispidFlagRequest**.  <br/> |
|0x0000006E  <br/> |«Assurer un suivi»  <br/> |
|0x0000006F  <br/> |Contacter  <br/> |
|0x00000070  <br/> |Organiser une réunion  <br/> |
|0x00000071  <br/> |«Envoyer un message électronique»  <br/> |
|0x00000072  <br/> |«Envoyer une lettre»  <br/> |
   
Les valeurs par défaut suggérées à l'utilisateur pour tous les autres objets message sont les suivantes:
  
|**Valeur**|**Chaîne en anglais**|
|:-----|:-----|
|0x00000000 ou non  <br/> | Suivez les instructions relatives à l'affichage de **dispidFlagRequest**.  <br/> |
|0x00000001  <br/> |Contacter  <br/> |
|0x00000002  <br/> |«Ne pas transférer»  <br/> |
|0x00000003  <br/> |«Assurer un suivi»  <br/> |
|0x00000004  <br/> |«Pour plus d'informations»  <br/> |
|0x00000005  <br/> |« Transférer »  <br/> |
|0x00000006  <br/> |«Aucune réponse nécessaire»  <br/> |
|0x00000007  <br/> |Remplacé  <br/> |
|0x00000008  <br/> |« Répondre »  <br/> |
|0x00000009  <br/> |«Répondre à tous»  <br/> |
|0x0000000A  <br/> |Veuillez  <br/> |
