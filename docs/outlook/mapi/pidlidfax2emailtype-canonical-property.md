...
---
# <a name="pidlidfax2emailtype-canonical-property"></a>Propriété canonique PidLidFax2EmailType

  
  
**S’applique à**: Outlook 
  
Spécifie le type de messagerie de l’adresse de télécopie (domicile).
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |dispidFax2EmailType  <br/> |
|Jeu de propriétés :  <br/> |PSETID_Address  <br/> |
|ID de type long (capot) :  <br/> |0x000080C7  <br/> |
