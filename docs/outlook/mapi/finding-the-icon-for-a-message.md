...
1. Appelez la méthode [IMAPIProp:: GetProps](imapiprop-getprops.md) pour récupérer sa propriété **PR_MESSAGE_CLASS** ([PidTagMessageClass](pidtagmessageclass-canonical-property.md)).
    
2. Appelez [MAPIOpenFormMgr](mapiopenformmgr.md) pour récupérer un pointeur d'interface **IMAPIFormMgr** . TransMettez votre pointeur **IMAPISession** dans le paramètre _pSession_ . 
