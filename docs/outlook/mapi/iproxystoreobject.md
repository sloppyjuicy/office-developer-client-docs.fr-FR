...
|||
|:-----|:-----|
|Hérité :  <br/> |[IUnknown](http://msdn.microsoft.com/en-us/library/ms680509%28v=VS.85%29.aspx) <br/> |
...
Appeler [IUnknown::QueryInterface](http://msdn.microsoft.com/en-us/library/ms682521%28v=VS.85%29.aspx) sur la banque de messages source pour obtenir l’interface **IProxyStoreObject** . Appelez ensuite **IProxyStoreObject::UnwrapNoRef** pour obtenir l’objet store non. Si **QueryInterface** renvoie l’erreur **MAPI_E_INTERFACE_NOT_SUPPORTED**, puis la banque n’a pas été encapsulée. 
