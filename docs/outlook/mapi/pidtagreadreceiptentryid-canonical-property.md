...
Si une application cliente souhaite recevoir lui-même des rapports de lecture, elle peut laisser cette propriété non définie ou l'identificateur d'entrée contenu dans la propriété **PR_SENDER_ENTRYID** ([PidTagSenderEntryId](pidtagsenderentryid-canonical-property.md)) au moment de l'envoi du message.
