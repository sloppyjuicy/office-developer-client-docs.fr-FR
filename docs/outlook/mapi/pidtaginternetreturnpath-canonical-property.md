...
Contient la valeur du champ d'en-tête de retour d'un message MIME (Multipurpose Internet Mail Extensions). Adresse de messagerie de l'expéditeur du message.
