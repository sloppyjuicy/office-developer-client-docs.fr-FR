...
## <a name="see-also"></a><span data-ttu-id="97d5a-110">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="97d5a-110">See also</span></span>

- [<span data-ttu-id="97d5a-111">Vue d’ensemble de la programmation MAPI</span><span class="sxs-lookup"><span data-stu-id="97d5a-111">MAPI Programming Overview</span></span>](mapi-programming-overview.md)
