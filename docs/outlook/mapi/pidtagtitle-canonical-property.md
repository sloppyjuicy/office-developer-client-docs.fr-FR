...
Ces propriétés sont couramment utilisées pour indiquer la fonction formelle du destinataire, telle que le programmeur senior, plutôt que la classe professionnelle, telle que le programmeur. Il n'est généralement pas utilisé pour les titres «suffixe» tels que Esq. ou DDS.
  
Les valeurs courantes de cette propriété sont les suivantes: Managing Director, programmateur II, Associate professeur et responsable du développement. 
