...
Contient l’identificateur d’entrée de l’utilisateur de messagerie qui ne reçoive effectivement le message.
...
Cette propriété correspond à un attribut X.400 remise enveloppe par message MH_T_.
