...
Contient l'identificateur d'entrée pour l'utilisateur de messagerie représenté par l'utilisateur destinataire.
...
Une application cliente répondant à un message reçu au nom d'un autre client doit copier cette propriété à partir du message reçu dans la propriété **PR_SENT_REPRESENTING_ENTRYID** ([PidTagSentRepresentingEntryId](pidtagsentrepresentingentryid-canonical-property.md)) pour la réponse.
