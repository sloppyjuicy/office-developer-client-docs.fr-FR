...
MapI simple fournit un ensemble de fonctions qui vous permet d’ajouter un niveau de base de fonctionnalité de messagerie aux applications Microsoft Windows.
  
> [!IMPORTANT]
> La fonction MAPI Simple MAPISendMail est prise en charge par Microsoft Outlook 2013 et Microsoft Outlook 2010. D’autres fonctions MAPI simples ont été dépréciées dans Windows. 
