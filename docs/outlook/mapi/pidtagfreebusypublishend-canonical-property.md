...
La valeur de cette propriété est calculée en ajoutant la valeur de **PR_FREEBUSY_COUNT_MONTHS** ([PidTagFreeBusyCountMonths](pidtagfreebusycountmonths-canonical-property.md)) à la date de début de la plage de publication. Cette valeur est exprimée en nombre de minutes écoulées depuis minuit, le 1er janvier 1601 en temps universel coordonné (UTC).
