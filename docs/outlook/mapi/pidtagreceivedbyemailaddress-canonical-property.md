...
Contient l’adresse de messagerie de l’utilisateur de messagerie qui reçoit le message.
...
Ces propriétés sont des exemples de propriétés d’adresse de l’utilisateur de messagerie qui reçoit le message. Elles doivent être définies par le fournisseur de transport entrant.
