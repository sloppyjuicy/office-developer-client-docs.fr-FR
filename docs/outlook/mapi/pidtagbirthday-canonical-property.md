...
Cette propriété est l’une des propriétés qui fournit des informations d’identification et d’accès sur un contact. Ces propriétés sont définies par l’utilisateur et l’organisation de l’utilisateur. 
