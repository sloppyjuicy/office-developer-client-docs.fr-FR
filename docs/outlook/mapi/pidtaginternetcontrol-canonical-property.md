...
Mappe sur l'en-tête de contrôle MIME.
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |PR_INTERNET_CONTROL, PR_INTERNET_CONTROL_A, PR_INTERNET_CONTROL_W  <br/> |
|Identificateur :  <br/> |0x1031  <br/> |
