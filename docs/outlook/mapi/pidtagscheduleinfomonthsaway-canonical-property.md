...
Contient une liste des mois pour lesquels les données de disponibilité de type absent (absent (e) du Bureau sont présentes dans le message de disponibilité. 
