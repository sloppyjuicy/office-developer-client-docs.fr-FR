...
Contient une chaîne Unicode interrogée dans la liste des adresses de messagerie ou des noms d'affichage des destinataires adressés à la ligne **CCI** des messages non envoyés dans la Banque. 
...
|Access  <br/> |Rechercher  <br/> |
   
## <a name="remarks"></a>Remarques

Cette propriété s'applique uniquement aux messages de la Banque qui n'ont pas été envoyés, car les messages qui ont été envoyés ou reçus ne contiennent pas d'informations CCI.
