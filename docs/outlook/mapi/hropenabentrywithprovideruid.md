...
Ouvre **l’entryID à** l’aide du carnet d’adresses Exchange identifié  _par pEmsabpUID_. Cette fonction fonctionne de la même manière que [IAddrBook::OpenEntry,](iaddrbook-openentry.md) sauf que l’utilisation de cette fonction garantit que [IAddrBook::OpenEntry](iaddrbook-openentry.md) est ouvert à l’aide du fournisseur de carnet d’adresses Exchange attendu. 
...
> Utilisez uniquement la LA GAL pour effectuer la résolution de noms. Cet indicateur est pris en charge uniquement par le fournisseur de carnet d’adresses Exchange.
