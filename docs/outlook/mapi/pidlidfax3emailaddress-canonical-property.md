...
Spécifie l'adresse de messagerie de l'autre adresse de télécopie du contact.
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |dispidFax3EmailAddress  <br/> |
|Jeu de propriétés:  <br/> |PSETID_Address  <br/> |
|ID long (couvercle):  <br/> |0x000080D3  <br/> |
|Type de données :  <br/> |PT_UNICODE  <br/> |
|Domaine :  <br/> |Contact  <br/> |
   
## <a name="remarks"></a>Remarques

Cette propriété, si elle est présente, doit contenir un nom complet lisible par l'utilisateur, suivi du caractère «@», suivi d'un numéro de télécopie.
