...
Indique la date et l'heure auxquelles le participant a répondu à une demande de réunion ou à une mise à jour de réunion reçue.
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |dispidApptReplyTime  <br/> |
|Jeu de propriétés:  <br/> |PSETID_Appointment  <br/> |
|ID long (couvercle):  <br/> |0x00008220  <br/> |
