...
Contient un identificateur MTS (Message Transfer System) pour l'agent de transfert des messages (MTA).
...
Cette propriété est renvoyée par le MTA après réussite de l'envoi du message. Tout contact futur avec le MTA concernant ce message, comme une demande d'annulation, utilise l'identificateur MTS dans cette propriété.
