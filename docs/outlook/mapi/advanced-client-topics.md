...
[Écriture d’une visionneuse de hiérarchie](writing-a-hierarchy-viewer.md)
  
> Décrit comment écrire une visionneuse de hiérarchie, un composant d’interface utilisateur qui est utilisé pour l’affichage des tables de hiérarchie de conteneur livre dossier et l’adresse.
