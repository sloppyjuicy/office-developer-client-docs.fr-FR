...
|ID long (couvercle):  <br/> |0x0000000A  <br/> |
|Type de données :  <br/> |PT_BOOLEAN  <br/> |
|Domaine :  <br/> |Réunions  <br/> |
   
## <a name="remarks"></a>Remarques

La valeur FALSe indique que l'objet qui représente une série périodique ou une instance unique. L'absence de cette propriété pour n'importe quel objet indique une valeur FALSe, à l'exception du message incorporé d'exception, qui prend la valeur TRUE.
