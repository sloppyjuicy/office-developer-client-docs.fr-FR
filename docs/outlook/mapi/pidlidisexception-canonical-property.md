...
|ID de type long (capot) :  <br/> |0x0000000A  <br/> |
|Type de données :  <br/> |PT_BOOLEAN  <br/> |
|Domaine :  <br/> |Réunions  <br/> |
   
## <a name="remarks"></a>Remarques

La valeur FALSE indique que l’objet qui représente une série périodique ou une instance unique. L’absence de cette propriété pour tout objet indique la valeur FALSE à l’exception du message incorporé exception qui suppose que la valeur TRUE.
