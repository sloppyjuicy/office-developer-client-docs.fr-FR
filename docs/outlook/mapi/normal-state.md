...
|[IPersistMessage::HandsOffMessage](ipersistmessage-handsoffmessage.md) <br/> |Appel de manière récursive la méthode **HandsOffMessage** sur des messages incorporés ou OLE [IPersistStorage::HandsOffStorage](http://msdn.microsoft.com/library/1e5ef26f-d8e7-4fa6-bfc4-19dace35314d%28Office.15%29.aspx) sur les objets OLE incorporés. Version de l’objet du message et des messages incorporés ni objet.  <br/> |[HandsOffFromNormal](handsofffromnormal-state.md) <br/> |
