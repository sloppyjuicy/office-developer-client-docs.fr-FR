...
Sachez que certains fournisseurs de banque de messages ne permettent pas **PR_SUBJECT** est écrit dans un stream à l’interface [IStream](https://msdn.microsoft.com/library/aa380034%28VS.85%29.aspx) . 
