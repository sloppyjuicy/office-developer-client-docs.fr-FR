...
Contient l'URL du serveur proxy utilisé pour connecter Microsoft Outlook à Microsoft Exchange Server sans le protocole HTTP ou le protocole HTTPs (Hypertext Transfer Protocol Secure) qui précède l'URL.
