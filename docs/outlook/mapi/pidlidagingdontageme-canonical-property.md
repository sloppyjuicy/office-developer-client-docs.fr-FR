...
Spécifie la valeur TRUE si l'élément n'est pas archivé automatiquement.
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |dispidAgingDontAgeMe  <br/> |
|Jeu de propriétés:  <br/> |PSETID_Common  <br/> |
|ID long (couvercle):  <br/> |0x0000850E  <br/> |
...
> Effectue une conversion entre l'IETF RFC2445, RFC2446 et RFC2447, ainsi que les rendez-vous et les réunions.
