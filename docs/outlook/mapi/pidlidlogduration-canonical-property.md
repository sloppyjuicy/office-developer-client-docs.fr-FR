...
|ID long (couvercle):  <br/> |0x00008707  <br/> |
|Type de données :  <br/> |PT_LONG  <br/> |
|Domaine :  <br/> |Journal  <br/> |
   
## <a name="remarks"></a>Remarques

Durée, en minutes, de l'activité qui doit correspondre à la différence entre les propriétés **dispidLogEnd** ([PidLidLogEnd](pidlidlogend-canonical-property.md)) et **dispidLogStart** ([PidLidLogStart](pidlidlogstart-canonical-property.md)).
