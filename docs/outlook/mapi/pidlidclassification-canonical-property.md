...
Indique le nom de la classification de message.
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |dispidClassification  <br/> |
|Jeu de propriétés :  <br/> |PSETID_Common  <br/> |
|ID de type long (capot) :  <br/> |0x000085B6  <br/> |
