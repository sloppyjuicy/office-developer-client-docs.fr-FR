...
Spécifie l'option de vote qu'une personne interrogée a sélectionnée.
  
|||
|:-----|:-----|
|Propriétés associées :  <br/> |dispidVerbResponse  <br/> |
|Jeu de propriétés:  <br/> |PSETID_Common  <br/> |
|ID long (couvercle):  <br/> |0x00008524  <br/> |
|Type de données :  <br/> |PT_UNICODE  <br/> |
|Domaine :  <br/> |Messagerie générale  <br/> |
   
## <a name="remarks"></a>Remarques

Cette propriété est généralement définie sur l'une des valeurs délimitées contenues dans la propriété **dispidVerbStream** ([PidLidVerbStream](pidlidverbstream-canonical-property.md)) sur laquelle la personne interrogée vote.
