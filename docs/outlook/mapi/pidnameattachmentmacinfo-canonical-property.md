---
title: Propriété canonique PidNameAttachmentMacInfo
manager: soliver
ms.date: 03/09/2015
...
Contient une valeur de pièce jointe [RFC3282] comprenant des données de branches d'en-tête et de ressource appropriées utilisées par les clients de messagerie Macintosh.
  
|||
|:-----|:-----|
|Noms conviviaux:  <br/> |Aucun  <br/> |
|Jeu de propriétés:  <br/> |PSETID_Attachment  <br/> |
|Nom de la propriété:  <br/> |AttachmentMacInfo  <br/> |
|Type de données :  <br/> |PT_BINARY  <br/> |
|Domaine :  <br/> |Pièce jointe de message  <br/> |
   
## <a name="remarks"></a>Remarques

Pour plus d'informations, reportez-vous à la section MS-OXCMAIL section 2.2.4.2 les formats de fichiers Apple.
