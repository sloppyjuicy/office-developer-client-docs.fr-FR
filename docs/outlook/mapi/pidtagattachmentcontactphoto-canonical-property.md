...
Indique l’existence d’une pièce jointe photo d’un contact.
...
Valeur de cette propriété doit être définie sur TRUE, et il doit être uniquement une pièce jointe sur un objet Contact donné.
