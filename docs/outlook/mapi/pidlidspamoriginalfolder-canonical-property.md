...
La valeur de cette propriété est **propriété EntryID** du dossier qui contenue le message avant d’être déplacée. Cette propriété doit être définie lorsqu’un message est marqué comme courrier indésirable. 
