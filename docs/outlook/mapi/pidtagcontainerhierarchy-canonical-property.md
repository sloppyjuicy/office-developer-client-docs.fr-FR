...
Pour récupérer le contenu de la table, une application cliente doit appeler la méthode [IMAPIContainer::GetHierarchyTable.](imapicontainer-gethierarchytable.md) Pour plus d’informations, [voir Tables hiérarchiques.](hierarchy-tables.md) 
