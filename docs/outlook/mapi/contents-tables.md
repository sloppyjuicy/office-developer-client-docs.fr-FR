...
ms.openlocfilehash: f0a1bf5145dfc407e826ddb188dec64182754817
...
Les tables de contenu de conteneur de carnet d’adresses et de dossiers disposent d’une longue liste de colonnes requises , colonnes que les clients peuvent s’attendre à être disponibles après avoir récupéré la table à partir de **GetContentsTable** ou **OpenProperty**. Les fournisseurs peuvent s’ajouter à cet ensemble requis si nécessaire et les clients, via la méthode **SetColumns** , peuvent également demander des modifications.
