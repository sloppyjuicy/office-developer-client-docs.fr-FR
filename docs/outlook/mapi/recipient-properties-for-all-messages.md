...
Les propriétés suivantes sont généralement présentes à tous les destinataires du message. **ADRESSE_EMAIL_PR** et **clé PR_SEARCH_KEY** sont facultatives ; toutes les autres propriétés sont requis. 
  
**Titre de la table**

|**Propriété**|**Description**|
|:-----|:-----|
|**TYPEADR_PR** ([PidTagAddressType](pidtagaddresstype-canonical-property.md))  <br/> |Contient le type d’adresse de messagerie de l’utilisateur de messagerie, tels que SMTP.  <br/> |
...
|**ADRESSE_EMAIL_PR** ([PidTagEmailAddress](pidtagemailaddress-canonical-property.md))  <br/> |Contient l’adresse de messagerie de l’utilisateur de messagerie.  <br/> |
