...
Ces propriétés sont subordonnées à la catégorie du formulaire principal qui est fournie dans la propriété **PR_FORM_CATEGORY** ([PidTagFormCategory](pidtagformcategory-canonical-property.md)). 
