...
Le cas échéant, cette propriété doit avoir une des valeurs qui sont spécifiés dans le tableau ci-dessous ou dans [[MS-OXOCNTC]](http://msdn.microsoft.com/library/9b636532-9150-4836-9635-9c9b756c9ccf%28Office.15%29.aspx). Si ce n’est pas définie, l’application doit supposer que la valeur est « 0 x 00000000 ».
