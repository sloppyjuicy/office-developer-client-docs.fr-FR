...
Contient le contrôle de redondance cyclique (CRC) calculé pour le texte du message.
...
La fonction [RTFSync](rtfsync.md) calcule le CRC en utilisant uniquement les caractères qu'il considère comme significatifs pour le message. Par exemple, certains espaces blancs et d'autres caractères pouvant être ignorés sont omis du CRC. 
