...
Pour déterminer l'adresse SMTP d'un élément du courrier reçu, utilisez la propriété [SenderEmailAddress](https://msdn.microsoft.com/library/bb622746\(v=office.15\)) de l'objet [MailItem](https://msdn.microsoft.com/library/bb643865\(v=office.15\)). Cependant, si l'expéditeur est interne à votre organisation, **SenderEmailAddress** ne retourne pas une adresse SMTP, et vous devez utiliser l'objet [PropertyAccessor](https://msdn.microsoft.com/library/bb646034\(v=office.15\)) pour retourner l'adresse SMTP de l'expéditeur.
