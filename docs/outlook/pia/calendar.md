...
|:----|:----------|
|[Partager le planning de disponibilité pendant une période spécifiée dans un calendrier](how-to-share-free-busy-schedule-within-a-specified-period-in-a-calendar.md)  |Obtient le calendrier de disponibilité d'une semaine spécifiée à partir d'un calendrier et affiche les détails de disponibilité et d'objet à l'utilisateur.|
