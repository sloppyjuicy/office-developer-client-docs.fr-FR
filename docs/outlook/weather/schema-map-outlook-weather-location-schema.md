...
---
# <a name="schema-map-outlook-weather-location-schema"></a><span data-ttu-id="a1f85-103">Plan de schéma (schéma Outlook emplacement météo)</span><span class="sxs-lookup"><span data-stu-id="a1f85-103">Schema map (Outlook Weather Location Schema)</span></span>

<span data-ttu-id="a1f85-104">Cette rubrique présente la définition de schéma pour le Outlook XML de l’emplacement météo.</span><span class="sxs-lookup"><span data-stu-id="a1f85-104">This topic shows the schema definition for the Outlook Weather Location XML Schema.</span></span>
