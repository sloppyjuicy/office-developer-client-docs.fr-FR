...
---
# <a name="weather-element-weatherdata-element-outlook-weather-information-schema"></a>Weather, élément (élément WeatherData) (schéma météo Outlook)
...
|:-----|:-----|:-----|
|[WeatherData](weatherdata-element-outlook-weather-information-schema.md) <br/> ||Définit l'élément météorologique.  <br/> |
