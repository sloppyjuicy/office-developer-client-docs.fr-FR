...
2. Pour demander un code d’emplacement, le service web autorise Outlook à ajouter les paramètres suivants à l’URL de base :
   ...
   - weasearchstr= _city_: This parameter indicates the location, _city_, for which the user wants a weather forecast (for example, Londres).
...
3. Pour demander un code de lieu, le service web autorise également Outlook à ajouter les paramètres suivants à l’URL de base :
   ...
   - weadegreetype=_degreetype_ : ce paramètre spécifie si vous souhaitez utiliser les unités de mesure métriques ou impériales pour la température. Spécifiez c pour la métrique, f pour l’impériale _pour degreetype_. Ce paramètre est facultatif et n’est pas toujours disponible dans la demande de service web.
...
- wc:JAXX0085 pour l’attribut **weatherlocationname** étant `Tokyo, JPN`

- wc:10038604 pour l’attribut **weatherlocationname** étant `Shinjuku-ku, Tokyo, Japan`
