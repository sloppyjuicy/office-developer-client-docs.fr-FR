---
title: Plan de schéma (Outlook d’informations météorologiques)
manager: soliver
ms.date: 11/16/2014
...
description: Cette rubrique présente la définition de schéma pour le Outlook XML des informations météorologiques.
ms.openlocfilehash: b08d40040bc725bd02d48758697fe4657fe1dc8f
ms.sourcegitcommit: e7b38e37a9d79becfd679e10420a19890165606d
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 05/29/2019
ms.locfileid: "34541315"
---
# <a name="schema-map-outlook-weather-information-schema"></a><span data-ttu-id="ca760-103">Plan de schéma (Outlook d’informations météorologiques)</span><span class="sxs-lookup"><span data-stu-id="ca760-103">Schema map (Outlook Weather Information Schema)</span></span>

<span data-ttu-id="ca760-104">Cette rubrique présente la définition de schéma pour le Outlook XML des informations météorologiques.</span><span class="sxs-lookup"><span data-stu-id="ca760-104">This topic shows the schema definition for the Outlook Weather Information XML Schema.</span></span>
