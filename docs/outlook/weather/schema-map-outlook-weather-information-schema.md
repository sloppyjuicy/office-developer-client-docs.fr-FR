...
description: Cette rubrique présente la définition de schéma pour le schéma XML des informations météorologiques Outlook.
...
---
# <a name="schema-map-outlook-weather-information-schema"></a><span data-ttu-id="70bc7-103">Schema map (Outlook Weather Information Schema)</span><span class="sxs-lookup"><span data-stu-id="70bc7-103">Schema map (Outlook Weather Information Schema)</span></span>

<span data-ttu-id="70bc7-104">Cette rubrique présente la définition de schéma pour le schéma XML des informations météorologiques Outlook.</span><span class="sxs-lookup"><span data-stu-id="70bc7-104">This topic shows the schema definition for the Outlook Weather Information XML Schema.</span></span>
