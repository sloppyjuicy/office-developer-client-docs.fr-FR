...
- [Prise en main des compléments OneNote](https://docs.microsoft.com/en-us/office/dev/add-ins/quickstarts/onenote-quickstart)
  
- [Vue d'ensemble de la plateforme des compléments pour Office](https://docs.microsoft.com/en-us/office/dev/add-ins/overview/office-add-ins)
