...
- [Prise en main des compléments Excel](https://docs.microsoft.com/en-us/office/dev/add-ins/excel/excel-add-ins-get-started-overview)
  
- [Présentation de la plateforme](https://docs.microsoft.com/en-us/office/dev/add-ins/overview/office-add-ins)
  
### <a name="code-samples"></a>Exemples de code
  
- [Exemples de code Excel dans le Centre pour développeurs Office](https://developer.microsoft.com/en-us/excel/gallery/?filterBy=Samples)
  
### <a name="other-resources"></a>Autres ressources
  
- [Conseils pour éliminer les obstacles aux performances Excel](https://msdn.microsoft.com/en-us/library/office/mt709003.aspx)
