...
---
# <a name="excel-worksheet-and-expression-evaluation"></a>Feuille de calcul Excel et �valuation d�expression

 **S’applique à**: Excel 2013 | Office 2013 | Visual Studio 
  
Les contenus de cellule de feuille de calcul Microsoft�Excel se voient attribuer l�un des quatre types de base de donn�es�:
...
## <a name="long-unicode-strings"></a>Cha�nes Unicode longues

Toutes les cha�nes que l�utilisateur voit dans Excel ont depuis de nombreuses versions �t� stock�es en interne en tant que cha�nes�Unicode. Les cha�nes Unicode de feuille de calcul peuvent comporter jusqu�� 32�767 caract�res (2<sup>15</sup>-1) et peuvent contenir tout caract�re Unicode valide. 
...
> [!NOTE]
> [!REMARQUE] Les cha�nes d�octets sont toujours enti�rement prises en charge dans l�API�C pour la compatibilit� descendante. Toutefois, elles ont toujours la m�me limite de 255�caract�res. 
