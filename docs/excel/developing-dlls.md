...
<span data-ttu-id="37e5a-112">Les principaux avantages des DLL sont les suivants :</span><span class="sxs-lookup"><span data-stu-id="37e5a-112">The main benefits of DLLs are as follows:</span></span>
