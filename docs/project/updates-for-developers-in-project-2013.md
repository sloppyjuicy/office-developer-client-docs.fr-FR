...
ms.openlocfilehash: 5491af61ae0af619195e3749da4f48446517f91b
ms.sourcegitcommit: 5969c693475e22a3f5a4fdde3473ecc33013b76f
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 02/09/2022
ms.locfileid: "62461495"
---
...
L’ajout de Project Online et du Office Store (https://office.microsoft.com/store) pour les compléments Project apporte des modifications importantes, où Project Server est accessible via Microsoft Azure. L’accès basé sur le cloud à Project Server utilise un modèle objet côté client (CSOM) pour le développement de add-ins avec Microsoft .NET Framework, Microsoft Silverlight, Windows Phone et les applications web qui utilisent JavaScript. Une exigence de Project Online est que les quatre bases de données Project Server des versions précédentes soient fusionnées dans une seule base de données.
...
Project d’événements serveur sont gérés par SharePoint pour chaque instance Project Web App, plutôt que par une page Project Web App Paramètres spécifique. Dans l’application Administration centrale de SharePoint, sélectionnez Application générale **Paramètres**, gérer sous **PWA Paramètres**, puis sélectionnez l’instance dans la liste liste de listes des instances **de Project Web App** sur le PWA Paramètres   page. Pour ajouter un gestionnaire d’événements local ou un récepteur d’événements à distance, choisissez **Gestionnaires d’événements côté serveur**.
...
- **Les scénarios** [d’extension PSI des extensions](https://docs.microsoft.com/previous-versions/office/developer/office-2010/ff843378(v=office.14)) sont supprimés et ne seront pas pris en charge dans les prochaines publication. Ces scénarios locaux Project Server 2013 permettaient l’intégration à l’aide Windows services WCF (Custom Windows Communication Foundation). 
