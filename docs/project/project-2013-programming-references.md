...
[Vue d’ensemble de la référence PSI Project](project-psi-reference-overview.md) Décrit les assemblys et les espaces de noms dans la référence de la PSI pour Project Server 2013. 
  
[Conditions préalables pour les exemples de code basées sur ASMX dans Project](prerequisites-for-asmx-based-code-samples-in-project.md) Décrit comment utiliser les exemples de code dans la référence PSI qui sont créées à l’aide des services web ASMX dans vos applications de test. 
  
[Conditions préalables pour les exemples de code basée sur WCF dans Project](prerequisites-for-wcf-based-code-samples-in-project.md) Décrit comment utiliser les exemples de code dans la référence PSI qui sont créées à l’aide des services Windows Communication Foundation (WCF) dans vos applications de test. 
