...
> [!NOTE]
> Pour plus d’informations sur la programmation avec le contrôle Grille JS, voir [JS Grid Control](https://msdn.microsoft.com/library/ee535898%28office.14%29.aspx) dans la SharePoint 2010 du développeur. Pour obtenir la référence de code géré, voir [Microsoft.SharePoint.JS'espace de noms Grid](https://msdn.microsoft.com/library/microsoft.sharepoint.jsgrid%28Office.15%29.aspx). Pour les contrôles web de contrôle de grille JS, voir [la classe JSGrid](https://msdn.microsoft.com/library/microsoft.sharepoint.webcontrols.jsgrid%28Office.15%29.aspx). 
