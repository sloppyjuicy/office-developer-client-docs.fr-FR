...
5. Créez **un dictionnaire requestBody** à l’aide de **l’action Créer un dictionnaire** . Ce dictionnaire stocke toutes les mises à jour de champ que vous souhaitez appliquer.
    ...
    - **ValueType** Type du champ personnalisé que vous êtes en train de mettre à jour.
       ...
       > [!NOTE]
       > Ces valeurs sont uniquement à des fins d’illustration. Les paires clé-valeur que vous utiliserez dépendent de PWA données.
...
**Conditions préalables :** Avant de pouvoir utiliser **CreateProjectSite**, le  paramètre Autoriser les utilisateurs à choisir doit être définie pour la création de sites de projet dans **PWA Paramètres** >  **Connected SharePoint Sites** >  **Paramètres**.
