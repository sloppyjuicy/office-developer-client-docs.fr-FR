...
- Pour un add-in hébergé project (SharePoint) :
  ...
  - Accéder aux données stockées dans Project Online ou SharePoint, telles que (mais sans s’y limiter) :  
  - Champs personnalisés  
  - Listes
    
- Pour un add-in hébergé par un fournisseur Project (SharePoint) :
  ...
  - Le navigateur est redirigé de Project Online vers un site externe avec des jetons d’accès vers Project Online.  
...
- Pour un add-in externe/autonome :
  ...
  - L’application s’authentifier et appelle directement les API Project Online
    

|Type d’application|Implémentation d’API|Environnement cible|Exemples d’applications|
|:-----|:-----|:-----|:-----|
|Projet hébergé  <br/> |JSOM (Java Script Object Model)  <br/> REST  <br/> |Navigateur  <br/> |Entrée de carte de temps  <br/> Approbation de carte de temps  <br/> État du projet  <br/> Rapport des problèmes  <br/> |
|Fournisseur de projets hébergé  <br/> |Bibliothèque cliente CSOM  <br/> |Site web/application Azure  <br/> Environnement non Windows (LAMP, etc.)  <br/> |Validateur de feuille de temps externe  <br/> Importateur de projets  <br/> |
...
## <a name="project-hosted-add-in-development-environment"></a>Environnement de développement de add-in hébergé par Project
...
## <a name="project-provider-hosted-add-in-development-environment"></a>Environnement de développement de add-in hébergé par un fournisseur project
...
Voici un exemple d’environnement de développement Windows pour ce type d’application :
  
-  Visual Studio 2015 (de préférence) ou Visual Studio 2013 
    
- Microsoft Office outils de développement Visual Studio (fournis avec Visual Studio éditions Professionnel et Entreprise 2015)
    
- .NET Framework 4.0 ou une nouveauté
...
2. A apporté quelques modifications pour accéder à votre site Project Online : le nom du site, le compte d’utilisateur et le mot de passe.
...
- [Développement d’un add-in Project Online à l’aide du modèle objet JavaScript (JSOM)](developing-a-project-online-add-in-using-the-javascript-object-model-jsom.md)
