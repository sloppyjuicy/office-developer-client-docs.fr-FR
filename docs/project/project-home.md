...
- [Référence du projet VBA](https://msdn.microsoft.com/en-us/library/dn175495.aspx)
  
- [Project 2010](https://msdn.microsoft.com/EN-US/library/ee861523.aspx)
  
### <a name="office-add-ins"></a>Compléments Office
  
- [Prendre en main des compléments Project](https://docs.microsoft.com/en-us/office/dev/add-ins/quickstarts/project-quickstart )
...
- [Compléments VSTO pour Office](https://docs.microsoft.com/en-us/office/dev/add-ins/overview/office-add-ins)
