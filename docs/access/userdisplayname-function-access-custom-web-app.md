...
---
# <a name="userdisplayname-function-access-custom-web-app"></a>Fonction UserDisplayName (application Web personnalisée Access)
...
La fonction **UserDisplayName** est disponible uniquement dans les macros d'interface utilisateur (IU). 
