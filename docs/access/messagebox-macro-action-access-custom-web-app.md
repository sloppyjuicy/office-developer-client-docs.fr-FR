---
title: Action de macro MessageBox (application Web personnalisée Access)
manager: kelbow
ms.date: 09/05/2017
...
L'action **MessageBox** possède l'argument suivant. 
  
|**Argument de l'action**|**Description**|
|:-----|:-----|
|Message  <br/> |Texte de la zone de message. Vous pouvez taper jusqu'à 255 caractères ou entrer une expression (précédée d'un signe égal).  <br/> |
