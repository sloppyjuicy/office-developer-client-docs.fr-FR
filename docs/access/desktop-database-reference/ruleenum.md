...
Indique la règle à appliquer en cas de suppression d'un objet [Key](key-object-adox.md).
...
<tbody>
<tr class="odd">
<td><p><strong>propriété DeleteRule</strong></p></td>
<td><p>1</p></td>
...
<td><p>0</p></td>
<td><p>Valeur par défaut. Aucune action n'est effectuée.</p></td>
</tr>
<tr class="odd">
