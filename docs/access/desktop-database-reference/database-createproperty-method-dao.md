...
---
# <a name="databasecreateproperty-method-dao"></a>Database. CreateProperty, méthode (DAO)
...
<td><p>Facultatif</p></td>
<td><p><strong>Variant</strong></p></td>
<td><p>Valeur de type <strong>Variant</strong> (sous-type <strong>Boolean</strong>) indiquant si l'objet <strong>Property</strong> est ou non un objet DDL. La valeur par défaut est False. Si DDL a la valeur true, les utilisateurs ne peuvent pas modifier ou supprimer cet objet <strong>Property</strong> , sauf s'ils disposent de l'autorisation dbSecWriteDef.</p></td>
</tr>
</tbody>
</table>
