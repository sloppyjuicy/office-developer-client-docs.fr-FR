...
- [Configuration de DataFactory en mode sans échec ou non restreint](configuring-datafactory-for-safe-or-unrestricted-modes.md)
...
- [Spécification des threads par processeur dans IIS](specifying-threads-per-processor-on-iis.md)
