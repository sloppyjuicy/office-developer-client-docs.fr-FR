...
ms.locfileid: "28722458"
---
# <a name="marshaloptions-property-example-vb"></a><span data-ttu-id="d4940-102">MarshalOptions, propriété – Exemple (VB)</span><span class="sxs-lookup"><span data-stu-id="d4940-102">MarshalOptions property example (VB)</span></span>


<span data-ttu-id="d4940-103">**S’applique à**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="d4940-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="d4940-104">Cet exemple utilise la propriété [MarshalOptions](marshaloptions-property-ado.md) pour spécifier les lignes renvoyées au serveur : toutes les lignes ou uniquement les lignes modifiées.</span><span class="sxs-lookup"><span data-stu-id="d4940-104">This example uses the [MarshalOptions](marshaloptions-property-ado.md) property to specify what rows are sent back to the server — All Rows or only Modified Rows.</span></span>
