...
---
# <a name="cancelbatch-method-ado"></a><span data-ttu-id="7f5d9-102">CancelBatch, méthode (ADO)</span><span class="sxs-lookup"><span data-stu-id="7f5d9-102">CancelBatch method (ADO)</span></span>

<span data-ttu-id="7f5d9-103">**S’applique à** : Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="7f5d9-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="7f5d9-104">Annule une mise à jour par lot en attente.</span><span class="sxs-lookup"><span data-stu-id="7f5d9-104">Cancels a pending batch update.</span></span>
