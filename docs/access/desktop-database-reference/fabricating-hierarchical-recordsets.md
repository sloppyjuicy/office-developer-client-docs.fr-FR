...
<span data-ttu-id="4a7af-107">Une fois que l' **objet Recordset** a été créé, il peut être rempli, manipulé ou conservé dans un fichier.</span><span class="sxs-lookup"><span data-stu-id="4a7af-107">After the **Recordset** has been fabricated, it can be populated, manipulated, or persisted to a file.</span></span>
