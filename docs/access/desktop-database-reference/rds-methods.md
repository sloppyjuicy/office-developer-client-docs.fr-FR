...
<tbody>
<tr class="odd">
<td><p><a href="cancel-method-rds.md">Annuler (RDS)</a></p></td>
...
<tr class="odd">
<td><p><a href="query-method-rds.md">Requête (RDS)</a></p></td>
<td><p>Utilise une chaîne de requête SQL valide qui retourne un objet <strong>Recordset</strong>.</p></td>
</tr>
<tr class="even">
<td><p><a href="refresh-method-rds.md">Actualisation (RDS)</a></p></td>
...
<tr class="odd">
<td><p><a href="reset-method-rds.md">Réinitialisation (RDS)</a></p></td>
