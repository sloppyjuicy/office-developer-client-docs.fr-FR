...
<th><p>Contraintes de colonne</p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<td><p>0</p></td>
<td><p>Renvoie les assertions définies dans le catalogue et dont est propriétaire un utilisateur donné.
...
<td><p>1</p></td>
<td><p>Renvoie les attributs physiques associés aux catalogues accessibles depuis le DBMS.
...
<td><p>2</p></td>
<td><p>Renvoie les jeux de caractères définis dans le catalogue et accessibles par un utilisateur donné.
...
<td><p>5</p></td>
<td><p>Renvoie les contraintes de contrôle définies dans le catalogue et dont est propriétaire un utilisateur donné.
...
<td><p>3</p></td>
<td><p>Renvoie les collations de caractères définies dans le catalogue et accessibles par un utilisateur donné.
...
<td><p>13</p></td>
<td><p>Renvoie les privilèges des colonnes des tables définies dans le catalogue,  accordés à un utilisateur donné, ou accordés par ce dernier.
 (COLUMN_PRIVILEGES Rowset)</p></td>
<td><p>TABLE_CATALOG<br />
TABLE_SCHEMA<br />
NOM_DE_TABLE<br />
NOM_COLONNE<br />
FOURNISSEUR D’AUTORISATIONS<br />
BÉNÉFICIAIRE</p></td>
</tr>
<tr class="odd">
<td><p><strong>adSchemaColumns</strong></p></td>
<td><p>4</p></td>
<td><p>Renvoie les colonnes des tables (vues comprises) définies dans le catalogue et accessibles à un utilisateur donné.
 (COLUMNS Rowset)</p></td>
<td><p>TABLE_CATALOG<br />
TABLE_SCHEMA<br />
NOM_DE_TABLE<br />
...
<td><p>11</p></td>
<td><p>Renvoie les colonnes définies dans le catalogue et qui dépendent d'un domaine défini dans le catalogue et dont est propriétaire un utilisateur donné.
...
<td><p>6</p></td>
<td><p>Renvoie les colonnes utilisées par les contraintes référentielles, uniques et de contrôle, ainsi que par les assertions définies dans le catalogue et dont est propriétaire un utilisateur donné.
...
<td><p>7</p></td>
<td><p>Renvoie les tables utilisées par les contraintes référentielles, uniques et de contrôle, ainsi que par les assertions définies dans le catalogue et dont est propriétaire un utilisateur donné.
...
<td><p>32</p></td>
<td><p>Renvoie des informations sur les cubes disponibles dans un schéma (ou catalogue, si le fournisseur ne prend pas en charge les schémas).
 (CUBES Rowset*)</p></td>
...
<td><p>30</p></td>
<td><p>Renvoie la liste des mots réservés spécifiques aux fournisseur.
...
<td><p>31</p></td>
<td><p>Renvoie la liste des chaînes littérales spécifiques aux fournisseurs et utilisées dans les commandes texte.
...
<td><p>33</p></td>
<td><p>Retourne des informations sur les dimensions d’un cube donné. Il comporte une ligne pour chaque dimension. (DIMENSIONS Rowset *)</p></td>
<td><p>CATALOG_NAME<br />
SCHEMA_NAME<br />
CUBE_NAME<br />
DIMENSION_NAME<br />
...
<td><p>27</p></td>
<td><p>Renvoie les colonnes de clés étrangères définies dans le catalogue par un utilisateur donné.
...
<td><p>34</p></td>
<td><p>Renvoie des informations sur les hiérarchies disponibles dans une dimension.
...
<td><p>12</p></td>
<td><p>Renvoie les index définis dans le catalogue et dont est propriétaire un utilisateur donné.
 (INDEXES Rowset)</p></td>
<td><p>TABLE_CATALOG<br />
TABLE_SCHEMA<br />
INDEX_NAME<br />
...
<td><p>8</p></td>
<td><p>Renvoie les colonnes définies dans le catalogue et qui sont contraintes sous forme de clés par un utilisateur donné.
...
<td><p>35</p></td>
<td><p>Renvoie des informations sur les niveaux disponibles dans une dimension.
 (LEVELS Rowset*)</p></td>
<td><p>CATALOG_NAME<br />
SCHEMA_NAME<br />
CUBE_NAME<br />
...
<td><p>36</p></td>
<td><p>Renvoie des informations sur les mesures disponibles.
...
<td><p>38</p></td>
<td><p>Renvoie des informations sur les membres disponibles.
 (MEMBERS Rowset *)</p></td>
<td><p>CATALOG_NAME<br />
SCHEMA_NAME<br />
CUBE_NAME<br />
...
MEMBER_CAPTION<br />
ARBRE<br />
Opérateur d’arbre (pour plus d’informations, consultez OLE DB pour la documentation OLAP.)</p></td>
</tr>
<tr class="even">
<td><p><strong>adSchemaPrimaryKeys</strong></p></td>
<td><p>28</p></td>
<td><p>Renvoie les colonnes de clés primaires définies dans le catalogue par un utilisateur donné.
...
<td><p>29</p></td>
<td><p>Renvoie des informations sur les colonnes de jeux de lignes renvoyées par des procédures.
...
<td><p>26</p></td>
<td><p>Renvoie des informations sur les paramètres et les codes de retour des procédures.
...
<td><p>16</p></td>
<td><p>Renvoie les procédures définies dans le catalogue et dont est propriétaire un utilisateur donné.
...
<td><p>37</p></td>
<td><p>Renvoie des informations sur les propriétés disponibles pour chaque niveau de la dimension.
...
<td><p>22</p></td>
<td><p>Renvoie les types de données (primaires) pris en charge par le fournisseur de données.
...
<td><p>9</p></td>
<td><p>Renvoie les contraintes référentielles définies dans le catalogie et dont est propriétaire un utilisateur donné.
...
<td><p>17</p></td>
<td><p>Renvoie les schémas (objets de la base de données) dont est propriétaire un utilisateur donné.
...
<td><p>18</p></td>
<td><p>Renvoie les niveaux de conformité, les options et les dialectes pris en charge par les données de traitement d'implémentation SQL définies dans le catalogue.
...
<td><p>19</p></td>
<td><p>Renvoie les statistiques définies dans le catalogue et dont est propriétaire un utilisateur donné.
...
<td><p>10</p></td>
<td><p>Renvoie les contraintes de table définies dans le catalogue et dont est propriétaire un utilisateur donné.
...
<td><p>14</p></td>
<td><p>Renvoie les privilèges sur les tables définies dans le catalogue et qui sont disponibles pour un utilisateur donné, ou accordés par ce dernier.
...
<tr class="odd">
<td><p><strong>requêtes adSchemaTables</strong></p></td>
<td><p>20</p></td>
<td><p>Renvoie les tables (notamment les vues) définies dans le catalogue et accessibles par un utilisateur donné.
 (TABLES Rowset)</p></td>
<td><p>TABLE_CATALOG<br />
TABLE_SCHEMA<br />
NOM_DE_TABLE<br />
...
<td><p>21</p></td>
<td><p>Renvoie les conversions de caractères définies dans le catalogue et auxquelles un utilisateur donné a accès.
...
<td><p>15</p></td>
<td><p>Renvoie les privilèges USAGE sur les objets définis dans le catalogue et qui sont disponibles pour un utilisateur donné, ou accordés par ce dernier.
...
<td><p>24</p></td>
<td><p>Renvoie les colonnes desquelles dépendent les tables vues, définies dans le catalogue et dont est propriétaire un utilisateur donné.
...
<td><p>23</p></td>
<td><p>Renvoie les vues définies dans le catalogue et accessibles par un utilisateur donné.
 (VIEWS Rowset)</p></td>
<td><p>TABLE_CATALOG<br />
TABLE_SCHEMA<br />
NOM_DE_TABLE</p></td>
...
<td><p>25</p></td>
<td><p>Renvoie les tables desquelles dépendent les tables vues, définies dans le catalogue et dont est propriétaire un utilisateur donné.
