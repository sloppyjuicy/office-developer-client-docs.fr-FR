...
- [Prend en charge la méthode-exemple](supports-method-example-vc.md)
...
- [Propriété index et Seek, méthode-exemple](seek-method-and-index-property-example-vc.md)
...
- [Exemple de modèle d’événements ADO](ado-events-model-example-vc.md)
