...
Atteint l'enregistrement suivant d'un objet **Recordset** spécifié et en fait l'enregistrement actif.
...
Si vous utilisez **MoveNext** alors que le dernier enregistrement est actif, la propriété **EOF** a la valeur **True**, et aucun enregistrement n'est actif. Si vous utilisez à nouveau **MoveNext**, une erreur se produit et **EOF** conserve la valeur **True**.
