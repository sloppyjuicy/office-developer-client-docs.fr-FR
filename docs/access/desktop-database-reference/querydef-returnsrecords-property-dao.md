...
---
# <a name="querydefreturnsrecords-property-dao"></a><span data-ttu-id="1b5c6-102">Propriété QueryDef.ReturnsRecords (DAO)</span><span class="sxs-lookup"><span data-stu-id="1b5c6-102">QueryDef.ReturnsRecords property (DAO)</span></span>

<span data-ttu-id="1b5c6-103">**S’applique à** : Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="1b5c6-103">**Applies to**: Access 2013, Office 2013</span></span>
...
<span data-ttu-id="1b5c6-116">Cet exemple utilise la propriété **ReturnsRecords** et la propriété personnalisée **LogMessages** pour créer une requête SQL directe qui renverra les données et les messages éventuellement générés par le serveur distant.</span><span class="sxs-lookup"><span data-stu-id="1b5c6-116">This example uses the **ReturnsRecords** property and the custom **LogMessages** property to create a pass-through query that will return data and any messages generated by the remote server.</span></span>
