...
ms.locfileid: "25872353"
---
# <a name="updatebatch-and-cancelbatch-methods-example-vc"></a><span data-ttu-id="29d3e-102">UpdateBatch et CancelBatch, méthodes – Exemple (VC++)</span><span class="sxs-lookup"><span data-stu-id="29d3e-102">UpdateBatch and CancelBatch methods example (VC++)</span></span>


<span data-ttu-id="29d3e-103">**S’applique à**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="29d3e-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="29d3e-104">Cet exemple illustre la méthode [UpdateBatch](updatebatch-method-ado.md) conjointement à la méthode [CancelBatch](cancelbatch-method-ado.md).</span><span class="sxs-lookup"><span data-stu-id="29d3e-104">This example demonstrates the [UpdateBatch](updatebatch-method-ado.md) method in conjunction with the [CancelBatch](cancelbatch-method-ado.md) method.</span></span>
...
<span data-ttu-id="29d3e-105">**UpdateBatchX.h**</span><span class="sxs-lookup"><span data-stu-id="29d3e-105">**UpdateBatchX.h**</span></span>
