...
L’URL absolue dans la chaîne de connexion spécifie le serveur (YourServer) et le chemin d’accès () et le chemin d’accès (Winnt). Cette URL définit également le contexte.
