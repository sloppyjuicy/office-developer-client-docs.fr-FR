...
---
# <a name="columns-and-tables-append-methods-name-property-example-vc"></a><span data-ttu-id="3a36b-102">Columns Append et Tables Append, méthodes - Exemple de propriété Name (VC++)</span><span class="sxs-lookup"><span data-stu-id="3a36b-102">Columns and Tables Append Methods, Name Property Example (VC++)</span></span>
...
<span data-ttu-id="3a36b-104">Le code suivant illustre la création d'une table.</span><span class="sxs-lookup"><span data-stu-id="3a36b-104">The following code demonstrates how to create a new table.</span></span>
