...
ms.locfileid: "28713253"
---
# <a name="recordsetnextrecordset-method-dao"></a><span data-ttu-id="3ff6b-102">Méthode Recordset.NextRecordset (DAO)</span><span class="sxs-lookup"><span data-stu-id="3ff6b-102">Recordset.NextRecordset method (DAO)</span></span>


<span data-ttu-id="3ff6b-103">**S’applique à**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="3ff6b-103">**Applies to**: Access 2013, Office 2013</span></span>

## <a name="syntax"></a><span data-ttu-id="3ff6b-104">Syntaxe</span><span class="sxs-lookup"><span data-stu-id="3ff6b-104">Syntax</span></span>

<span data-ttu-id="3ff6b-105">*expression* . NextRecordset</span><span class="sxs-lookup"><span data-stu-id="3ff6b-105">*expression* .NextRecordset</span></span>

<span data-ttu-id="3ff6b-106">*expression* Variable qui représente un objet **Recordset** .</span><span class="sxs-lookup"><span data-stu-id="3ff6b-106">*expression* A variable that represents a **Recordset** object.</span></span>

## <a name="return-value"></a><span data-ttu-id="3ff6b-107">Valeur renvoyée</span><span class="sxs-lookup"><span data-stu-id="3ff6b-107">Return value</span></span>

<span data-ttu-id="3ff6b-108">Booléen</span><span class="sxs-lookup"><span data-stu-id="3ff6b-108">Boolean</span></span>

## <a name="remarks"></a><span data-ttu-id="3ff6b-109">Remarques</span><span class="sxs-lookup"><span data-stu-id="3ff6b-109">Remarks</span></span>

<span data-ttu-id="3ff6b-110">Dans un espace de travail ODBCDirect, vous pouvez ouvrir un **[Recordset](recordset-object-dao.md)** contenant plusieurs requêtes sélection dans l’argument source de la **méthode OpenRecordset**, ou la propriété **[SQL](querydef-sql-property-dao.md)** d’une requête sélection objet **[QueryDef](querydef-object-dao.md)** , comme dans l’exemple suivant.</span><span class="sxs-lookup"><span data-stu-id="3ff6b-110">In an ODBCDirect workspace, you can open a **[Recordset](recordset-object-dao.md)** containing more than one select query in the source argument of **OpenRecordset**, or the **[SQL](querydef-sql-property-dao.md)** property of a select query **[QueryDef](querydef-object-dao.md)** object, as in the following example.</span></span>
