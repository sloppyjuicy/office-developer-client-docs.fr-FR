...
De nombreux exemples Visual Basic sont inclus dans la documentation ADO. Pour plus d'informations, consultez [Exemples de code ADO en Microsoft Visual Basic](ado-code-examples-in-microsoft-visual-basic.md).
