...
---
# <a name="clone-method-example-vc"></a><span data-ttu-id="0fbf4-102">Clone, méthode – Exemple (VC++)</span><span class="sxs-lookup"><span data-stu-id="0fbf4-102">Clone method example (VC++)</span></span>


<span data-ttu-id="0fbf4-103">**S’applique à** : Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="0fbf4-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="0fbf4-104">Cet exemple utilise la méthode [Clone](clone-method-ado.md) pour créer des copies d'un objet [Recordset](recordset-object-ado.md) puis permet à l'utilisateur de positionner le pointeur d'enregistrement de chaque copie indépendamment des autres.</span><span class="sxs-lookup"><span data-stu-id="0fbf4-104">This example uses the [Clone](clone-method-ado.md) method to create copies of a [Recordset](recordset-object-ado.md) and then lets the user position the record pointer of each copy independently.</span></span>
...
<span data-ttu-id="0fbf4-105">**CloneX.h**</span><span class="sxs-lookup"><span data-stu-id="0fbf4-105">**CloneX.h**</span></span>
