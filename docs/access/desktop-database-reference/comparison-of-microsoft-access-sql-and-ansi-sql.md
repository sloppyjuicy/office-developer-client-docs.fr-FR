...
- La clause LIMIT TO *nn* ROWS utilisée pour limiter le nombre de lignes retournées par une requête. Vous ne pouvez utiliser que la [clause WHERE](https://docs.microsoft.com/office/vba/access/Concepts/Structured-Query-Language/where-clause-microsoft-access-sql) pour limiter l'étendue d'une requête.
