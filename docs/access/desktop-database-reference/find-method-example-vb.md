...
ms.locfileid: "25891288"
---
# <a name="find-method-example-vb"></a><span data-ttu-id="9dd49-102">Find, méthode – Exemple (VB)</span><span class="sxs-lookup"><span data-stu-id="9dd49-102">Find method example (VB)</span></span>


<span data-ttu-id="9dd49-103">**S’applique à**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="9dd49-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="9dd49-104">Cet exemple utilise la méthode [Find](find-method-ado.md) de l’objet [Recordset](recordset-object-ado.md) pour localiser et compter le nombre de titres de fonctions dans la base de données ***Pubs*** .</span><span class="sxs-lookup"><span data-stu-id="9dd49-104">This example uses the [Recordset](recordset-object-ado.md) object's [Find](find-method-ado.md) method to locate and count the number of business titles in the ***Pubs*** database.</span></span> <span data-ttu-id="9dd49-105">Il est supposé, dans l'exemple, que le fournisseur sous-jacent ne prend pas en charge de fonctionnalité similaire.</span><span class="sxs-lookup"><span data-stu-id="9dd49-105">The example assumes the underlying provider does not support similar functionality.</span></span>
