...
Contient les objets [Level](level-object-ado-md.md) qui composent une hiérarchie.

## <a name="remarks"></a>Remarques

**Levels** est une collection ADO standard. Avec les propriétés et méthodes d'une collection, vous pouvez :
