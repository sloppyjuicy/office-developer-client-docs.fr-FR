...
---
# <a name="indexcreateproperty-method-dao"></a>Index. CreateProperty, méthode (DAO)
...
> [!NOTE]
> Si vous omettez l'argument DDL, sa valeur par défaut est false (non DDL). Étant donné qu'aucune propriété DDL correspondante n'est exposée, vous devez supprimer et recréer un objet **Property** dont vous souhaitez modifier la DDL en non DDL.
