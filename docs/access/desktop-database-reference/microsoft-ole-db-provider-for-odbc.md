...
<td><p><span data-ttu-id="1f4d9-124">Spécifie le nom de la source de données.</span><span class="sxs-lookup"><span data-stu-id="1f4d9-124">Specifies the data source name.</span></span></p></td>
</tr>
<tr class="odd">
...
<span data-ttu-id="1f4d9-138">**Syntaxe sans DSN (connexion sans DSN) :**</span><span class="sxs-lookup"><span data-stu-id="1f4d9-138">**Syntax without a DSN (DSN-less connection):**</span></span>
...
<span data-ttu-id="1f4d9-168">(KAGPROP_FILEUSAGE)</span><span class="sxs-lookup"><span data-stu-id="1f4d9-168">(KAGPROP_FILEUSAGE)</span></span></p></td>
...
<td><p><span data-ttu-id="1f4d9-187">Indique le nombre maximal de colonnes autorisé dans une table.</span><span class="sxs-lookup"><span data-stu-id="1f4d9-187">Indicates the maximum number of columns allowed in a table.</span></span></p></td>
</tr>
<tr class="odd">
...
<span data-ttu-id="1f4d9-264">Les tableaux suivants répertorient les méthodes et propriétés ADO standard disponibles pour un objet **Recordset** ouvert avec ce fournisseur.</span><span class="sxs-lookup"><span data-stu-id="1f4d9-264">The following tables list the standard ADO methods and properties available on a **Recordset** object opened with this provider.</span></span>
...
<td><p><span data-ttu-id="1f4d9-281">Lecture/écriture</span><span class="sxs-lookup"><span data-stu-id="1f4d9-281">read/write</span></span></p></td>
</tr>
<tr class="odd">
...
<td><p><span data-ttu-id="1f4d9-305">Lecture/écriture</span><span class="sxs-lookup"><span data-stu-id="1f4d9-305">read/write</span></span></p></td>
...
<td><p><span data-ttu-id="1f4d9-329">Lecture/écriture</span><span class="sxs-lookup"><span data-stu-id="1f4d9-329">read/write</span></span></p></td>
...
<td><p><span data-ttu-id="1f4d9-353">Lecture/écriture</span><span class="sxs-lookup"><span data-stu-id="1f4d9-353">read/write</span></span></p></td>
...
<th><p><span data-ttu-id="1f4d9-371">Dynamic</span><span class="sxs-lookup"><span data-stu-id="1f4d9-371">Dynamic</span></span></p></th>
...
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-394"><a href="clone-method-ado.md">Clone</a></span><span class="sxs-lookup"><span data-stu-id="1f4d9-394"><a href="clone-method-ado.md">Clone</a></span></span></p></td>
...
<tr class="even">
<td><p><span data-ttu-id="1f4d9-419"><a href="movefirst-movelast-movenext-and-moveprevious-methods-ado.md">MoveFirst</a></span><span class="sxs-lookup"><span data-stu-id="1f4d9-419"><a href="movefirst-movelast-movenext-and-moveprevious-methods-ado.md">MoveFirst</a></span></span></p></td>
...
<span data-ttu-id="1f4d9-p118">Les tableaux suivants forment un index croisé des noms ADO et OLE DB de chaque propriété dynamique. Le guide OLE DB Programmer's Reference (en anglais) référence les noms de propriétés ADO sous le terme « Description ». Vous trouverez dans ce guide d'autres informations sur ces propriétés. Recherchez le nom de la propriété OLE DB dans l'Index ou consultez la rubrique « Appendix C: OLE DB Properties ».</span><span class="sxs-lookup"><span data-stu-id="1f4d9-p118">The tables below are a cross-index of the ADO and OLE DB names for each dynamic property. The OLE DB Programmer's Reference refers to an ADO property name by the term, "Description." You can find more information about these properties in the OLE DB Programmer's Reference. Search for the OLE DB property name in the Index or see Appendix C: OLE DB Properties.</span></span>

## <a name="connection-dynamic-properties"></a><span data-ttu-id="1f4d9-481">Propriétés dynamiques de connexion</span><span class="sxs-lookup"><span data-stu-id="1f4d9-481">Connection Dynamic Properties</span></span>

<span data-ttu-id="1f4d9-482">Les propriétés suivantes sont ajoutées à la collection **Properties** de l'objet **Connection**.</span><span class="sxs-lookup"><span data-stu-id="1f4d9-482">The following properties are added to the **Connection** object's **Properties** collection.</span></span>
...
<thead>
<tr class="header">
<th><p><span data-ttu-id="1f4d9-483">Nom de la propriété ADO</span><span class="sxs-lookup"><span data-stu-id="1f4d9-483">ADO Property Name</span></span></p></th>
<th><p><span data-ttu-id="1f4d9-484">Nom de la propriété OLE DB</span><span class="sxs-lookup"><span data-stu-id="1f4d9-484">OLE DB Property Name</span></span></p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-485">Active Sessions</span><span class="sxs-lookup"><span data-stu-id="1f4d9-485">Active Sessions</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-486">DBPROP_ACTIVESESSIONS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-486">DBPROP_ACTIVESESSIONS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-487">Asynchable Abort</span><span class="sxs-lookup"><span data-stu-id="1f4d9-487">Asynchable Abort</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-488">DBPROP_ASYNCTXNABORT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-488">DBPROP_ASYNCTXNABORT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-489">Asynchable Commit</span><span class="sxs-lookup"><span data-stu-id="1f4d9-489">Asynchable Commit</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-490">DBPROP_ASYNCTNXCOMMIT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-490">DBPROP_ASYNCTNXCOMMIT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-491">Autocommit Isolation Levels</span><span class="sxs-lookup"><span data-stu-id="1f4d9-491">Autocommit Isolation Levels</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-492">DBPROP_SESS_AUTOCOMMITISOLEVELS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-492">DBPROP_SESS_AUTOCOMMITISOLEVELS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-493">Catalog Location</span><span class="sxs-lookup"><span data-stu-id="1f4d9-493">Catalog Location</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-494">DBPROP_CATALOGLOCATION</span><span class="sxs-lookup"><span data-stu-id="1f4d9-494">DBPROP_CATALOGLOCATION</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-495">Catalog Term</span><span class="sxs-lookup"><span data-stu-id="1f4d9-495">Catalog Term</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-496">DBPROP_CATALOGTERM</span><span class="sxs-lookup"><span data-stu-id="1f4d9-496">DBPROP_CATALOGTERM</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-497">Column Definition</span><span class="sxs-lookup"><span data-stu-id="1f4d9-497">Column Definition</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-498">DBPROP_COLUMNDEFINITION</span><span class="sxs-lookup"><span data-stu-id="1f4d9-498">DBPROP_COLUMNDEFINITION</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-499">Connect Timeout</span><span class="sxs-lookup"><span data-stu-id="1f4d9-499">Connect Timeout</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-500">DBPROP_INIT_TIMEOUT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-500">DBPROP_INIT_TIMEOUT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-501">Current Catalog</span><span class="sxs-lookup"><span data-stu-id="1f4d9-501">Current Catalog</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-502">DBPROP_CURRENTCATALOG</span><span class="sxs-lookup"><span data-stu-id="1f4d9-502">DBPROP_CURRENTCATALOG</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-503">Data Source</span><span class="sxs-lookup"><span data-stu-id="1f4d9-503">Data Source</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-504">DBPROP_INIT_DATASOURCE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-504">DBPROP_INIT_DATASOURCE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-505">Data Source Name</span><span class="sxs-lookup"><span data-stu-id="1f4d9-505">Data Source Name</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-506">DBPROP_DATASOURCENAME</span><span class="sxs-lookup"><span data-stu-id="1f4d9-506">DBPROP_DATASOURCENAME</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-507">Data Source Object Threading Model</span><span class="sxs-lookup"><span data-stu-id="1f4d9-507">Data Source Object Threading Model</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-508">DBPROP_DSOTHREADMODEL</span><span class="sxs-lookup"><span data-stu-id="1f4d9-508">DBPROP_DSOTHREADMODEL</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-509">DBMS Name</span><span class="sxs-lookup"><span data-stu-id="1f4d9-509">DBMS Name</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-510">DBPROP_DBMSNAME</span><span class="sxs-lookup"><span data-stu-id="1f4d9-510">DBPROP_DBMSNAME</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-511">DBMS Version</span><span class="sxs-lookup"><span data-stu-id="1f4d9-511">DBMS Version</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-512">DBPROP_DBMSVER</span><span class="sxs-lookup"><span data-stu-id="1f4d9-512">DBPROP_DBMSVER</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-513">Extended Properties</span><span class="sxs-lookup"><span data-stu-id="1f4d9-513">Extended Properties</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-514">DBPROP_INIT_PROVIDERSTRING</span><span class="sxs-lookup"><span data-stu-id="1f4d9-514">DBPROP_INIT_PROVIDERSTRING</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-515">GROUP BY Support</span><span class="sxs-lookup"><span data-stu-id="1f4d9-515">GROUP BY Support</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-516">DBPROP_GROUPBY</span><span class="sxs-lookup"><span data-stu-id="1f4d9-516">DBPROP_GROUPBY</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-517">Heterogeneous Table Support</span><span class="sxs-lookup"><span data-stu-id="1f4d9-517">Heterogeneous Table Support</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-518">DBPROP_HETEROGENEOUSTABLES</span><span class="sxs-lookup"><span data-stu-id="1f4d9-518">DBPROP_HETEROGENEOUSTABLES</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-519">Identifier Case Sensitivity</span><span class="sxs-lookup"><span data-stu-id="1f4d9-519">Identifier Case Sensitivity</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-520">DBPROP_IDENTIFIERCASE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-520">DBPROP_IDENTIFIERCASE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-521">Initial Catalog</span><span class="sxs-lookup"><span data-stu-id="1f4d9-521">Initial Catalog</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-522">DBPROP_INIT_CATALOG</span><span class="sxs-lookup"><span data-stu-id="1f4d9-522">DBPROP_INIT_CATALOG</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-523">Isolation Levels</span><span class="sxs-lookup"><span data-stu-id="1f4d9-523">Isolation Levels</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-524">DBPROP_SUPPORTEDTXNISOLEVELS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-524">DBPROP_SUPPORTEDTXNISOLEVELS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-525">Isolation Retention</span><span class="sxs-lookup"><span data-stu-id="1f4d9-525">Isolation Retention</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-526">DBPROP_SUPPORTEDTXNISORETAIN</span><span class="sxs-lookup"><span data-stu-id="1f4d9-526">DBPROP_SUPPORTEDTXNISORETAIN</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-527">Locale Identifier</span><span class="sxs-lookup"><span data-stu-id="1f4d9-527">Locale Identifier</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-528">DBPROP_INIT_LCID</span><span class="sxs-lookup"><span data-stu-id="1f4d9-528">DBPROP_INIT_LCID</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-529">Location</span><span class="sxs-lookup"><span data-stu-id="1f4d9-529">Location</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-530">DBPROP_INIT_LOCATION</span><span class="sxs-lookup"><span data-stu-id="1f4d9-530">DBPROP_INIT_LOCATION</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-531">Maximum Index Size</span><span class="sxs-lookup"><span data-stu-id="1f4d9-531">Maximum Index Size</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-532">DBPROP_MAXINDEXSIZE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-532">DBPROP_MAXINDEXSIZE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-533">Maximum Row Size</span><span class="sxs-lookup"><span data-stu-id="1f4d9-533">Maximum Row Size</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-534">DBPROP_MAXROWSIZE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-534">DBPROP_MAXROWSIZE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-535">Maximum Row Size Includes BLOB</span><span class="sxs-lookup"><span data-stu-id="1f4d9-535">Maximum Row Size Includes BLOB</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-536">DBPROP_MAXROWSIZEINCLUDESBLOB</span><span class="sxs-lookup"><span data-stu-id="1f4d9-536">DBPROP_MAXROWSIZEINCLUDESBLOB</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-537">Maximum Tables in SELECT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-537">Maximum Tables in SELECT</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-538">DBPROP_MAXTABLESINSELECT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-538">DBPROP_MAXTABLESINSELECT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-539">Mode</span><span class="sxs-lookup"><span data-stu-id="1f4d9-539">Mode</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-540">DBPROP_INIT_MODE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-540">DBPROP_INIT_MODE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-541">Multiple Parameter Sets</span><span class="sxs-lookup"><span data-stu-id="1f4d9-541">Multiple Parameter Sets</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-542">DBPROP_MULTIPLEPARAMSETS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-542">DBPROP_MULTIPLEPARAMSETS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-543">Multiple Results</span><span class="sxs-lookup"><span data-stu-id="1f4d9-543">Multiple Results</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-544">DBPROP_MULTIPLERESULTS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-544">DBPROP_MULTIPLERESULTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-545">Multiple Storage Objects</span><span class="sxs-lookup"><span data-stu-id="1f4d9-545">Multiple Storage Objects</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-546">DBPROP_MULTIPLESTORAGEOBJECTS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-546">DBPROP_MULTIPLESTORAGEOBJECTS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-547">Multi-Table Update</span><span class="sxs-lookup"><span data-stu-id="1f4d9-547">Multi-Table Update</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-548">DBPROP_MULTITABLEUPDATE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-548">DBPROP_MULTITABLEUPDATE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-549">NULL Collation Order</span><span class="sxs-lookup"><span data-stu-id="1f4d9-549">NULL Collation Order</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-550">DBPROP_NULLCOLLATION</span><span class="sxs-lookup"><span data-stu-id="1f4d9-550">DBPROP_NULLCOLLATION</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-551">NULL Concatenation Behavior</span><span class="sxs-lookup"><span data-stu-id="1f4d9-551">NULL Concatenation Behavior</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-552">DBPROP_CONCATNULLBEHAVIOR</span><span class="sxs-lookup"><span data-stu-id="1f4d9-552">DBPROP_CONCATNULLBEHAVIOR</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-553">OLE DB Services</span><span class="sxs-lookup"><span data-stu-id="1f4d9-553">OLE DB Services</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-554">DBPROP_INIT_OLEDBSERVICES</span><span class="sxs-lookup"><span data-stu-id="1f4d9-554">DBPROP_INIT_OLEDBSERVICES</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-555">OLE DB Version</span><span class="sxs-lookup"><span data-stu-id="1f4d9-555">OLE DB Version</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-556">DBPROP_PROVIDEROLEDBVER</span><span class="sxs-lookup"><span data-stu-id="1f4d9-556">DBPROP_PROVIDEROLEDBVER</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-557">OLE Object Support</span><span class="sxs-lookup"><span data-stu-id="1f4d9-557">OLE Object Support</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-558">DBPROP_OLEOBJECTS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-558">DBPROP_OLEOBJECTS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-559">Open Rowset Support</span><span class="sxs-lookup"><span data-stu-id="1f4d9-559">Open Rowset Support</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-560">DBPROP_OPENROWSETSUPPORT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-560">DBPROP_OPENROWSETSUPPORT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-561">ORDER BY Columns in Select List</span><span class="sxs-lookup"><span data-stu-id="1f4d9-561">ORDER BY Columns in Select List</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-562">DBPROP_ORDERBYCOLUMNSINSELECT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-562">DBPROP_ORDERBYCOLUMNSINSELECT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-563">Output Parameter Availability</span><span class="sxs-lookup"><span data-stu-id="1f4d9-563">Output Parameter Availability</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-564">DBPROP_OUTPUTPARAMETERAVAILABILITY</span><span class="sxs-lookup"><span data-stu-id="1f4d9-564">DBPROP_OUTPUTPARAMETERAVAILABILITY</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-565">Password</span><span class="sxs-lookup"><span data-stu-id="1f4d9-565">Password</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-566">DBPROP_AUTH_PASSWORD</span><span class="sxs-lookup"><span data-stu-id="1f4d9-566">DBPROP_AUTH_PASSWORD</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-567">Pass By Ref Accessors</span><span class="sxs-lookup"><span data-stu-id="1f4d9-567">Pass By Ref Accessors</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-568">DBPROP_BYREFACCESSORS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-568">DBPROP_BYREFACCESSORS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-569">Persist Security Info</span><span class="sxs-lookup"><span data-stu-id="1f4d9-569">Persist Security Info</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-570">DBPROP_AUTH_PERSIST_SENSITIVE_AUTHINFO</span><span class="sxs-lookup"><span data-stu-id="1f4d9-570">DBPROP_AUTH_PERSIST_SENSITIVE_AUTHINFO</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-571">Persistent ID Type</span><span class="sxs-lookup"><span data-stu-id="1f4d9-571">Persistent ID Type</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-572">DBPROP_PERSISTENTIDTYPE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-572">DBPROP_PERSISTENTIDTYPE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-573">Prepare Abort Behavior</span><span class="sxs-lookup"><span data-stu-id="1f4d9-573">Prepare Abort Behavior</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-574">DBPROP_PREPAREABORTBEHAVIOR</span><span class="sxs-lookup"><span data-stu-id="1f4d9-574">DBPROP_PREPAREABORTBEHAVIOR</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-575">Prepare Commit Behavior</span><span class="sxs-lookup"><span data-stu-id="1f4d9-575">Prepare Commit Behavior</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-576">DBPROP_PREPARECOMMITBEHAVIOR</span><span class="sxs-lookup"><span data-stu-id="1f4d9-576">DBPROP_PREPARECOMMITBEHAVIOR</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-577">Procedure Term</span><span class="sxs-lookup"><span data-stu-id="1f4d9-577">Procedure Term</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-578">DBPROP_PROCEDURETERM</span><span class="sxs-lookup"><span data-stu-id="1f4d9-578">DBPROP_PROCEDURETERM</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-579">Prompt</span><span class="sxs-lookup"><span data-stu-id="1f4d9-579">Prompt</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-580">DBPROP_INIT_PROMPT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-580">DBPROP_INIT_PROMPT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-581">Provider Friendly Name</span><span class="sxs-lookup"><span data-stu-id="1f4d9-581">Provider Friendly Name</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-582">DBPROP_PROVIDERFRIENDLYNAME</span><span class="sxs-lookup"><span data-stu-id="1f4d9-582">DBPROP_PROVIDERFRIENDLYNAME</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-583">Provider Name</span><span class="sxs-lookup"><span data-stu-id="1f4d9-583">Provider Name</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-584">DBPROP_PROVIDERFILENAME</span><span class="sxs-lookup"><span data-stu-id="1f4d9-584">DBPROP_PROVIDERFILENAME</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-585">Provider Version</span><span class="sxs-lookup"><span data-stu-id="1f4d9-585">Provider Version</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-586">DBPROP_PROVIDERVER</span><span class="sxs-lookup"><span data-stu-id="1f4d9-586">DBPROP_PROVIDERVER</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-587">Read-Only Data Source</span><span class="sxs-lookup"><span data-stu-id="1f4d9-587">Read-Only Data Source</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-588">DBPROP_DATASOURCEREADONLY</span><span class="sxs-lookup"><span data-stu-id="1f4d9-588">DBPROP_DATASOURCEREADONLY</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-589">Rowset Conversions on Command</span><span class="sxs-lookup"><span data-stu-id="1f4d9-589">Rowset Conversions on Command</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-590">DBPROP_ROWSETCONVERSIONSONCOMMAND</span><span class="sxs-lookup"><span data-stu-id="1f4d9-590">DBPROP_ROWSETCONVERSIONSONCOMMAND</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-591">Schema Term</span><span class="sxs-lookup"><span data-stu-id="1f4d9-591">Schema Term</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-592">DBPROP_SCHEMATERM</span><span class="sxs-lookup"><span data-stu-id="1f4d9-592">DBPROP_SCHEMATERM</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-593">Schema Usage</span><span class="sxs-lookup"><span data-stu-id="1f4d9-593">Schema Usage</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-594">DBPROP_SCHEMAUSAGE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-594">DBPROP_SCHEMAUSAGE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-595">SQL Support</span><span class="sxs-lookup"><span data-stu-id="1f4d9-595">SQL Support</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-596">DBPROP_SQLSUPPORT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-596">DBPROP_SQLSUPPORT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-597">Structured Storage</span><span class="sxs-lookup"><span data-stu-id="1f4d9-597">Structured Storage</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-598">DBPROP_STRUCTUREDSTORAGE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-598">DBPROP_STRUCTUREDSTORAGE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-599">Subquery Support</span><span class="sxs-lookup"><span data-stu-id="1f4d9-599">Subquery Support</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-600">DBPROP_SUBQUERIES</span><span class="sxs-lookup"><span data-stu-id="1f4d9-600">DBPROP_SUBQUERIES</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-601">Table Term</span><span class="sxs-lookup"><span data-stu-id="1f4d9-601">Table Term</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-602">DBPROP_TABLETERM</span><span class="sxs-lookup"><span data-stu-id="1f4d9-602">DBPROP_TABLETERM</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-603">Transaction DDL</span><span class="sxs-lookup"><span data-stu-id="1f4d9-603">Transaction DDL</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-604">DBPROP_SUPPORTEDTXNDDL</span><span class="sxs-lookup"><span data-stu-id="1f4d9-604">DBPROP_SUPPORTEDTXNDDL</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-605">User ID</span><span class="sxs-lookup"><span data-stu-id="1f4d9-605">User ID</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-606">DBPROP_AUTH_USERID</span><span class="sxs-lookup"><span data-stu-id="1f4d9-606">DBPROP_AUTH_USERID</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-607">User Name</span><span class="sxs-lookup"><span data-stu-id="1f4d9-607">User Name</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-608">DBPROP_USERNAME</span><span class="sxs-lookup"><span data-stu-id="1f4d9-608">DBPROP_USERNAME</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-609">Window Handle</span><span class="sxs-lookup"><span data-stu-id="1f4d9-609">Window Handle</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-610">DBPROP_INIT_HWND</span><span class="sxs-lookup"><span data-stu-id="1f4d9-610">DBPROP_INIT_HWND</span></span></p></td>
</tr>
</tbody>
</table>


## <a name="recordset-dynamic-properties"></a><span data-ttu-id="1f4d9-611">Propriétés dynamiques du jeu d'enregitrements</span><span class="sxs-lookup"><span data-stu-id="1f4d9-611">Recordset Dynamic Properties</span></span>

<span data-ttu-id="1f4d9-612">Les propriétés suivantes sont ajoutées à la collection **Properties** de l'objet **Recordset**.</span><span class="sxs-lookup"><span data-stu-id="1f4d9-612">The following properties are added to the **Recordset** object's **Properties** collection.</span></span>
...
<thead>
<tr class="header">
<th><p><span data-ttu-id="1f4d9-613">Nom de la propriété ADO</span><span class="sxs-lookup"><span data-stu-id="1f4d9-613">ADO Property Name</span></span></p></th>
<th><p><span data-ttu-id="1f4d9-614">Nom de la propriété OLE DB</span><span class="sxs-lookup"><span data-stu-id="1f4d9-614">OLE DB Property Name</span></span></p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-615">Access Order</span><span class="sxs-lookup"><span data-stu-id="1f4d9-615">Access Order</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-616">DBPROP_ACCESSORDER</span><span class="sxs-lookup"><span data-stu-id="1f4d9-616">DBPROP_ACCESSORDER</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-617">Blocking Storage Objects</span><span class="sxs-lookup"><span data-stu-id="1f4d9-617">Blocking Storage Objects</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-618">DBPROP_BLOCKINGSTORAGEOBJECTS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-618">DBPROP_BLOCKINGSTORAGEOBJECTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-619">Bookmark Type</span><span class="sxs-lookup"><span data-stu-id="1f4d9-619">Bookmark Type</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-620">DBPROP_BOOKMARKTYPE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-620">DBPROP_BOOKMARKTYPE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-621">Bookmarkable</span><span class="sxs-lookup"><span data-stu-id="1f4d9-621">Bookmarkable</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-622">DBPROP_IROWSETLOCATE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-622">DBPROP_IROWSETLOCATE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-623">Change Inserted Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-623">Change Inserted Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-624">DBPROP_CHANGEINSERTEDROWS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-624">DBPROP_CHANGEINSERTEDROWS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-625">Column Privileges</span><span class="sxs-lookup"><span data-stu-id="1f4d9-625">Column Privileges</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-626">DBPROP_COLUMNRESTRICT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-626">DBPROP_COLUMNRESTRICT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-627">Column Set Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-627">Column Set Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-628">DBPROP_NOTIFYCOLUMNSET</span><span class="sxs-lookup"><span data-stu-id="1f4d9-628">DBPROP_NOTIFYCOLUMNSET</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-629">Delay Storage Object Updates</span><span class="sxs-lookup"><span data-stu-id="1f4d9-629">Delay Storage Object Updates</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-630">DBPROP_DELAYSTORAGEOBJECTS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-630">DBPROP_DELAYSTORAGEOBJECTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-631">Fetch Backwards</span><span class="sxs-lookup"><span data-stu-id="1f4d9-631">Fetch Backwards</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-632">DBPROP_CANFETCHBACKWARDS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-632">DBPROP_CANFETCHBACKWARDS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-633">Hold Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-633">Hold Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-634">DBPROP_CANHOLDROWS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-634">DBPROP_CANHOLDROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-635">IAccessor</span><span class="sxs-lookup"><span data-stu-id="1f4d9-635">IAccessor</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-636">DBPROP_IAccessor</span><span class="sxs-lookup"><span data-stu-id="1f4d9-636">DBPROP_IAccessor</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-637">IColumnsInfo</span><span class="sxs-lookup"><span data-stu-id="1f4d9-637">IColumnsInfo</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-638">DBPROP_IColumnsInfo</span><span class="sxs-lookup"><span data-stu-id="1f4d9-638">DBPROP_IColumnsInfo</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-639">IColumnsRowset</span><span class="sxs-lookup"><span data-stu-id="1f4d9-639">IColumnsRowset</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-640">DBPROP_IColumnsRowset</span><span class="sxs-lookup"><span data-stu-id="1f4d9-640">DBPROP_IColumnsRowset</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-641">IConnectionPointContainer</span><span class="sxs-lookup"><span data-stu-id="1f4d9-641">IConnectionPointContainer</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-642">DBPROP_IConnectionPointContainer</span><span class="sxs-lookup"><span data-stu-id="1f4d9-642">DBPROP_IConnectionPointContainer</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-643">IConvertType</span><span class="sxs-lookup"><span data-stu-id="1f4d9-643">IConvertType</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-644">DBPROP_IConvertType</span><span class="sxs-lookup"><span data-stu-id="1f4d9-644">DBPROP_IConvertType</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-645">Immobile Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-645">Immobile Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-646">DBPROP_IMMOBILEROWS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-646">DBPROP_IMMOBILEROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-647">IRowset</span><span class="sxs-lookup"><span data-stu-id="1f4d9-647">IRowset</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-648">DBPROP_IRowset</span><span class="sxs-lookup"><span data-stu-id="1f4d9-648">DBPROP_IRowset</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-649">IRowsetChange</span><span class="sxs-lookup"><span data-stu-id="1f4d9-649">IRowsetChange</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-650">DBPROP_IRowsetChange</span><span class="sxs-lookup"><span data-stu-id="1f4d9-650">DBPROP_IRowsetChange</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-651">IRowsetIdentity</span><span class="sxs-lookup"><span data-stu-id="1f4d9-651">IRowsetIdentity</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-652">DBPROP_IRowsetIdentity</span><span class="sxs-lookup"><span data-stu-id="1f4d9-652">DBPROP_IRowsetIdentity</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-653">IRowsetInfo</span><span class="sxs-lookup"><span data-stu-id="1f4d9-653">IRowsetInfo</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-654">DBPROP_IRowsetInfo</span><span class="sxs-lookup"><span data-stu-id="1f4d9-654">DBPROP_IRowsetInfo</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-655">IRowsetLocate</span><span class="sxs-lookup"><span data-stu-id="1f4d9-655">IRowsetLocate</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-656">DBPROP_IRowsetLocate</span><span class="sxs-lookup"><span data-stu-id="1f4d9-656">DBPROP_IRowsetLocate</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-657">IRowsetResynch</span><span class="sxs-lookup"><span data-stu-id="1f4d9-657">IRowsetResynch</span></span></p></td>
<td><p></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-658">IRowsetUpdate</span><span class="sxs-lookup"><span data-stu-id="1f4d9-658">IRowsetUpdate</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-659">DBPROP_IRowsetUpdate</span><span class="sxs-lookup"><span data-stu-id="1f4d9-659">DBPROP_IRowsetUpdate</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-660">ISequentialStream</span><span class="sxs-lookup"><span data-stu-id="1f4d9-660">ISequentialStream</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-661">DBPROP_ISequentialStream</span><span class="sxs-lookup"><span data-stu-id="1f4d9-661">DBPROP_ISequentialStream</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-662">ISupportErrorInfo</span><span class="sxs-lookup"><span data-stu-id="1f4d9-662">ISupportErrorInfo</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-663">DBPROP_ISupportErrorInfo</span><span class="sxs-lookup"><span data-stu-id="1f4d9-663">DBPROP_ISupportErrorInfo</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-664">Literal Bookmarks</span><span class="sxs-lookup"><span data-stu-id="1f4d9-664">Literal Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-665">DBPROP_LITERALBOOKMARKS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-665">DBPROP_LITERALBOOKMARKS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-666">Literal Row Identity</span><span class="sxs-lookup"><span data-stu-id="1f4d9-666">Literal Row Identity</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-667">DBPROP_LITERALIDENTITY</span><span class="sxs-lookup"><span data-stu-id="1f4d9-667">DBPROP_LITERALIDENTITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-668">Maximum Open Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-668">Maximum Open Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-669">DBPROP_MAXOPENROWS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-669">DBPROP_MAXOPENROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-670">Maximum Pending Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-670">Maximum Pending Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-671">DBPROP_MAXPENDINGROWS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-671">DBPROP_MAXPENDINGROWS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-672">Maximum Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-672">Maximum Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-673">DBPROP_MAXROWS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-673">DBPROP_MAXROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-674">Notification Granularity</span><span class="sxs-lookup"><span data-stu-id="1f4d9-674">Notification Granularity</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-675">DBPROP_NOTIFICATIONGRANULARITY</span><span class="sxs-lookup"><span data-stu-id="1f4d9-675">DBPROP_NOTIFICATIONGRANULARITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-676">Notification Phases</span><span class="sxs-lookup"><span data-stu-id="1f4d9-676">Notification Phases</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-677">DBPROP_NOTIFICATIONPHASES</span><span class="sxs-lookup"><span data-stu-id="1f4d9-677">DBPROP_NOTIFICATIONPHASES</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-678">Objects Transacted</span><span class="sxs-lookup"><span data-stu-id="1f4d9-678">Objects Transacted</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-679">DBPROP_TRANSACTEDOBJECT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-679">DBPROP_TRANSACTEDOBJECT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-680">Own Changes Visible</span><span class="sxs-lookup"><span data-stu-id="1f4d9-680">Own Changes Visible</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-681">DBPROP_OWNUPDATEDELETE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-681">DBPROP_OWNUPDATEDELETE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-682">Own Inserts Visible</span><span class="sxs-lookup"><span data-stu-id="1f4d9-682">Own Inserts Visible</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-683">DBPROP_OWNINSERT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-683">DBPROP_OWNINSERT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-684">Preserve on Abort</span><span class="sxs-lookup"><span data-stu-id="1f4d9-684">Preserve on Abort</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-685">DBPROP_ABORTPRESERVE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-685">DBPROP_ABORTPRESERVE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-686">Preserve on Commit</span><span class="sxs-lookup"><span data-stu-id="1f4d9-686">Preserve on Commit</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-687">DBPROP_COMMITPRESERVE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-687">DBPROP_COMMITPRESERVE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-688">Quick Restart</span><span class="sxs-lookup"><span data-stu-id="1f4d9-688">Quick Restart</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-689">DBPROP_QUICKRESTART</span><span class="sxs-lookup"><span data-stu-id="1f4d9-689">DBPROP_QUICKRESTART</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-690">Reentrant Events</span><span class="sxs-lookup"><span data-stu-id="1f4d9-690">Reentrant Events</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-691">DBPROP_REENTRANTEVENTS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-691">DBPROP_REENTRANTEVENTS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-692">Remove Deleted Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-692">Remove Deleted Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-693">DBPROP_REMOVEDELETED</span><span class="sxs-lookup"><span data-stu-id="1f4d9-693">DBPROP_REMOVEDELETED</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-694">Report Multiple Changes</span><span class="sxs-lookup"><span data-stu-id="1f4d9-694">Report Multiple Changes</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-695">DBPROP_REPORTMULTIPLECHANGES</span><span class="sxs-lookup"><span data-stu-id="1f4d9-695">DBPROP_REPORTMULTIPLECHANGES</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-696">Return Pending Inserts</span><span class="sxs-lookup"><span data-stu-id="1f4d9-696">Return Pending Inserts</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-697">DBPROP_RETURNPENDINGINSERTS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-697">DBPROP_RETURNPENDINGINSERTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-698">Row Delete Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-698">Row Delete Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-699">DBPROP_NOTIFYROWDELETE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-699">DBPROP_NOTIFYROWDELETE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-700">Row First Change Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-700">Row First Change Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-701">DBPROP_NOTIFYROWFIRSTCHANGE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-701">DBPROP_NOTIFYROWFIRSTCHANGE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-702">Row Insert Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-702">Row Insert Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-703">DBPROP_NOTIFYROWINSERT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-703">DBPROP_NOTIFYROWINSERT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-704">Row Privileges</span><span class="sxs-lookup"><span data-stu-id="1f4d9-704">Row Privileges</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-705">DBPROP_ROWRESTRICT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-705">DBPROP_ROWRESTRICT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-706">Row Resynchronization Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-706">Row Resynchronization Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-707">DBPROP_NOTIFYROWRESYNCH</span><span class="sxs-lookup"><span data-stu-id="1f4d9-707">DBPROP_NOTIFYROWRESYNCH</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-708">Row Threading Model</span><span class="sxs-lookup"><span data-stu-id="1f4d9-708">Row Threading Model</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-709">DBPROP_ROWTHREADMODEL</span><span class="sxs-lookup"><span data-stu-id="1f4d9-709">DBPROP_ROWTHREADMODEL</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-710">Row Undo Change Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-710">Row Undo Change Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-711">DBPROP_NOTIFYROWUNDOCHANGE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-711">DBPROP_NOTIFYROWUNDOCHANGE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-712">Row Undo Delete Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-712">Row Undo Delete Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-713">DBPROP_NOTIFYROWUNDODELETE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-713">DBPROP_NOTIFYROWUNDODELETE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-714">Row Undo Insert Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-714">Row Undo Insert Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-715">DBPROP_NOTIFYROWUNDOINSERT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-715">DBPROP_NOTIFYROWUNDOINSERT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-716">Row Update Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-716">Row Update Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-717">DBPROP_NOTIFYROWUPDATE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-717">DBPROP_NOTIFYROWUPDATE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-718">Rowset Fetch Position Change Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-718">Rowset Fetch Position Change Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-719">DBPROP_NOTIFYROWSETFETCHPOSISIONCHANGE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-719">DBPROP_NOTIFYROWSETFETCHPOSISIONCHANGE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-720">Rowset Release Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-720">Rowset Release Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-721">DBPROP_NOTIFYROWSETRELEASE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-721">DBPROP_NOTIFYROWSETRELEASE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-722">Scroll Backwards</span><span class="sxs-lookup"><span data-stu-id="1f4d9-722">Scroll Backwards</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-723">DBPROP_CANSCROLLBACKWARDS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-723">DBPROP_CANSCROLLBACKWARDS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-724">Skip Deleted Bookmarks</span><span class="sxs-lookup"><span data-stu-id="1f4d9-724">Skip Deleted Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-725">DBPROP_BOOKMARKSKIPPED</span><span class="sxs-lookup"><span data-stu-id="1f4d9-725">DBPROP_BOOKMARKSKIPPED</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-726">Strong Row Identity</span><span class="sxs-lookup"><span data-stu-id="1f4d9-726">Strong Row Identity</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-727">DBPROP_STRONGITDENTITY</span><span class="sxs-lookup"><span data-stu-id="1f4d9-727">DBPROP_STRONGITDENTITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-728">Unique Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-728">Unique Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-729">DBPROP_UNIQUEROWS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-729">DBPROP_UNIQUEROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-730">Updatability</span><span class="sxs-lookup"><span data-stu-id="1f4d9-730">Updatability</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-731">DBPROP_UPDATABILITY</span><span class="sxs-lookup"><span data-stu-id="1f4d9-731">DBPROP_UPDATABILITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-732">Use Bookmarks</span><span class="sxs-lookup"><span data-stu-id="1f4d9-732">Use Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-733">DBPROP_BOOKMARKS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-733">DBPROP_BOOKMARKS</span></span></p></td>
</tr>
</tbody>
</table>


## <a name="command-dynamic-properties"></a><span data-ttu-id="1f4d9-734">Propriétés dynamiques de la commande</span><span class="sxs-lookup"><span data-stu-id="1f4d9-734">Command Dynamic Properties</span></span>

<span data-ttu-id="1f4d9-735">Les propriétés suivantes sont ajoutées à la collection **Properties** de l'objet **Command**.</span><span class="sxs-lookup"><span data-stu-id="1f4d9-735">The following properties are added to the **Command** object's **Properties** collection.</span></span>
...
<thead>
<tr class="header">
<th><p><span data-ttu-id="1f4d9-736">Nom de la propriété ADO</span><span class="sxs-lookup"><span data-stu-id="1f4d9-736">ADO Property Name</span></span></p></th>
<th><p><span data-ttu-id="1f4d9-737">Nom de la propriété OLE DB</span><span class="sxs-lookup"><span data-stu-id="1f4d9-737">OLE DB Property Name</span></span></p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-738">Access Order</span><span class="sxs-lookup"><span data-stu-id="1f4d9-738">Access Order</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-739">DBPROP_ACCESSORDER</span><span class="sxs-lookup"><span data-stu-id="1f4d9-739">DBPROP_ACCESSORDER</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-740">Blocking Storage Objects</span><span class="sxs-lookup"><span data-stu-id="1f4d9-740">Blocking Storage Objects</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-741">DBPROP_BLOCKINGSTORAGEOBJECTS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-741">DBPROP_BLOCKINGSTORAGEOBJECTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-742">Bookmark Type</span><span class="sxs-lookup"><span data-stu-id="1f4d9-742">Bookmark Type</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-743">DBPROP_BOOKMARKTYPE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-743">DBPROP_BOOKMARKTYPE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-744">Bookmarkable</span><span class="sxs-lookup"><span data-stu-id="1f4d9-744">Bookmarkable</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-745">DBPROP_IROWSETLOCATE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-745">DBPROP_IROWSETLOCATE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-746">Change Inserted Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-746">Change Inserted Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-747">DBPROP_CHANGEINSERTEDROWS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-747">DBPROP_CHANGEINSERTEDROWS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-748">Column Privileges</span><span class="sxs-lookup"><span data-stu-id="1f4d9-748">Column Privileges</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-749">DBPROP_COLUMNRESTRICT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-749">DBPROP_COLUMNRESTRICT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-750">Column Set Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-750">Column Set Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-751">DBPROP_NOTIFYCOLUMNSET</span><span class="sxs-lookup"><span data-stu-id="1f4d9-751">DBPROP_NOTIFYCOLUMNSET</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-752">Delay Storage Object Updates</span><span class="sxs-lookup"><span data-stu-id="1f4d9-752">Delay Storage Object Updates</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-753">DBPROP_DELAYSTORAGEOBJECTS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-753">DBPROP_DELAYSTORAGEOBJECTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-754">Fetch Backwards</span><span class="sxs-lookup"><span data-stu-id="1f4d9-754">Fetch Backwards</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-755">DBPROP_CANFETCHBACKWARDS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-755">DBPROP_CANFETCHBACKWARDS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-756">Hold Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-756">Hold Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-757">DBPROP_CANHOLDROWS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-757">DBPROP_CANHOLDROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-758">IAccessor</span><span class="sxs-lookup"><span data-stu-id="1f4d9-758">IAccessor</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-759">DBPROP_IAccessor</span><span class="sxs-lookup"><span data-stu-id="1f4d9-759">DBPROP_IAccessor</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-760">IColumnsInfo</span><span class="sxs-lookup"><span data-stu-id="1f4d9-760">IColumnsInfo</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-761">DBPROP_IColumnsInfo</span><span class="sxs-lookup"><span data-stu-id="1f4d9-761">DBPROP_IColumnsInfo</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-762">IColumnsRowset</span><span class="sxs-lookup"><span data-stu-id="1f4d9-762">IColumnsRowset</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-763">DBPROP_IColumnsRowset</span><span class="sxs-lookup"><span data-stu-id="1f4d9-763">DBPROP_IColumnsRowset</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-764">IConnectionPointContainer</span><span class="sxs-lookup"><span data-stu-id="1f4d9-764">IConnectionPointContainer</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-765">DBPROP_IConnectionPointContainer</span><span class="sxs-lookup"><span data-stu-id="1f4d9-765">DBPROP_IConnectionPointContainer</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-766">IConvertType</span><span class="sxs-lookup"><span data-stu-id="1f4d9-766">IConvertType</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-767">DBPROP_IConvertType</span><span class="sxs-lookup"><span data-stu-id="1f4d9-767">DBPROP_IConvertType</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-768">Immobile Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-768">Immobile Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-769">DBPROP_IMMOBILEROWS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-769">DBPROP_IMMOBILEROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-770">IRowset</span><span class="sxs-lookup"><span data-stu-id="1f4d9-770">IRowset</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-771">DBPROP_IRowset</span><span class="sxs-lookup"><span data-stu-id="1f4d9-771">DBPROP_IRowset</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-772">IRowsetChange</span><span class="sxs-lookup"><span data-stu-id="1f4d9-772">IRowsetChange</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-773">DBPROP_IRowsetChange</span><span class="sxs-lookup"><span data-stu-id="1f4d9-773">DBPROP_IRowsetChange</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-774">IRowsetIdentity</span><span class="sxs-lookup"><span data-stu-id="1f4d9-774">IRowsetIdentity</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-775">DBPROP_IRowsetIdentity</span><span class="sxs-lookup"><span data-stu-id="1f4d9-775">DBPROP_IRowsetIdentity</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-776">IRowsetInfo</span><span class="sxs-lookup"><span data-stu-id="1f4d9-776">IRowsetInfo</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-777">DBPROP_IRowsetInfo</span><span class="sxs-lookup"><span data-stu-id="1f4d9-777">DBPROP_IRowsetInfo</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-778">IRowsetLocate</span><span class="sxs-lookup"><span data-stu-id="1f4d9-778">IRowsetLocate</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-779">DBPROP_IRowsetLocate</span><span class="sxs-lookup"><span data-stu-id="1f4d9-779">DBPROP_IRowsetLocate</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-780">IRowsetResynch</span><span class="sxs-lookup"><span data-stu-id="1f4d9-780">IRowsetResynch</span></span></p></td>
<td><p></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-781">IRowsetUpdate</span><span class="sxs-lookup"><span data-stu-id="1f4d9-781">IRowsetUpdate</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-782">DBPROP_IRowsetUpdate</span><span class="sxs-lookup"><span data-stu-id="1f4d9-782">DBPROP_IRowsetUpdate</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-783">ISequentialStream</span><span class="sxs-lookup"><span data-stu-id="1f4d9-783">ISequentialStream</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-784">DBPROP_ISequentialStream</span><span class="sxs-lookup"><span data-stu-id="1f4d9-784">DBPROP_ISequentialStream</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-785">ISupportErrorInfo</span><span class="sxs-lookup"><span data-stu-id="1f4d9-785">ISupportErrorInfo</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-786">DBPROP_ISupportErrorInfo</span><span class="sxs-lookup"><span data-stu-id="1f4d9-786">DBPROP_ISupportErrorInfo</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-787">Literal Bookmarks</span><span class="sxs-lookup"><span data-stu-id="1f4d9-787">Literal Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-788">DBPROP_LITERALBOOKMARKS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-788">DBPROP_LITERALBOOKMARKS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-789">Literal Row Identity</span><span class="sxs-lookup"><span data-stu-id="1f4d9-789">Literal Row Identity</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-790">DBPROP_LITERALIDENTITY</span><span class="sxs-lookup"><span data-stu-id="1f4d9-790">DBPROP_LITERALIDENTITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-791">Maximum Open Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-791">Maximum Open Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-792">DBPROP_MAXOPENROWS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-792">DBPROP_MAXOPENROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-793">Maximum Pending Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-793">Maximum Pending Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-794">DBPROP_MAXPENDINGROWS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-794">DBPROP_MAXPENDINGROWS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-795">Maximum Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-795">Maximum Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-796">DBPROP_MAXROWS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-796">DBPROP_MAXROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-797">Notification Granularity</span><span class="sxs-lookup"><span data-stu-id="1f4d9-797">Notification Granularity</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-798">DBPROP_NOTIFICATIONGRANULARITY</span><span class="sxs-lookup"><span data-stu-id="1f4d9-798">DBPROP_NOTIFICATIONGRANULARITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-799">Notification Phases</span><span class="sxs-lookup"><span data-stu-id="1f4d9-799">Notification Phases</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-800">DBPROP_NOTIFICATIONPHASES</span><span class="sxs-lookup"><span data-stu-id="1f4d9-800">DBPROP_NOTIFICATIONPHASES</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-801">Objects Transacted</span><span class="sxs-lookup"><span data-stu-id="1f4d9-801">Objects Transacted</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-802">DBPROP_TRANSACTEDOBJECT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-802">DBPROP_TRANSACTEDOBJECT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-803">Own Changes Visible</span><span class="sxs-lookup"><span data-stu-id="1f4d9-803">Own Changes Visible</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-804">DBPROP_OWNUPDATEDELETE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-804">DBPROP_OWNUPDATEDELETE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-805">Own Inserts Visible</span><span class="sxs-lookup"><span data-stu-id="1f4d9-805">Own Inserts Visible</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-806">DBPROP_OWNINSERT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-806">DBPROP_OWNINSERT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-807">Preserve on Abort</span><span class="sxs-lookup"><span data-stu-id="1f4d9-807">Preserve on Abort</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-808">DBPROP_ABORTPRESERVE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-808">DBPROP_ABORTPRESERVE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-809">Preserve on Commit</span><span class="sxs-lookup"><span data-stu-id="1f4d9-809">Preserve on Commit</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-810">DBPROP_COMMITPRESERVE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-810">DBPROP_COMMITPRESERVE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-811">Quick Restart</span><span class="sxs-lookup"><span data-stu-id="1f4d9-811">Quick Restart</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-812">DBPROP_QUICKRESTART</span><span class="sxs-lookup"><span data-stu-id="1f4d9-812">DBPROP_QUICKRESTART</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-813">Reentrant Events</span><span class="sxs-lookup"><span data-stu-id="1f4d9-813">Reentrant Events</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-814">DBPROP_REENTRANTEVENTS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-814">DBPROP_REENTRANTEVENTS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-815">Remove Deleted Rows</span><span class="sxs-lookup"><span data-stu-id="1f4d9-815">Remove Deleted Rows</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-816">DBPROP_REMOVEDELETED</span><span class="sxs-lookup"><span data-stu-id="1f4d9-816">DBPROP_REMOVEDELETED</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-817">Report Multiple Changes</span><span class="sxs-lookup"><span data-stu-id="1f4d9-817">Report Multiple Changes</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-818">DBPROP_REPORTMULTIPLECHANGES</span><span class="sxs-lookup"><span data-stu-id="1f4d9-818">DBPROP_REPORTMULTIPLECHANGES</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-819">Return Pending Inserts</span><span class="sxs-lookup"><span data-stu-id="1f4d9-819">Return Pending Inserts</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-820">DBPROP_RETURNPENDINGINSERTS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-820">DBPROP_RETURNPENDINGINSERTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-821">Row Delete Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-821">Row Delete Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-822">DBPROP_NOTIFYROWDELETE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-822">DBPROP_NOTIFYROWDELETE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-823">Row First Change Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-823">Row First Change Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-824">DBPROP_NOTIFYROWFIRSTCHANGE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-824">DBPROP_NOTIFYROWFIRSTCHANGE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-825">Row Insert Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-825">Row Insert Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-826">DBPROP_NOTIFYROWINSERT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-826">DBPROP_NOTIFYROWINSERT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-827">Row Privileges</span><span class="sxs-lookup"><span data-stu-id="1f4d9-827">Row Privileges</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-828">DBPROP_ROWRESTRICT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-828">DBPROP_ROWRESTRICT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-829">Row Resynchronization Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-829">Row Resynchronization Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-830">DBPROP_NOTIFYROWRESYNCH</span><span class="sxs-lookup"><span data-stu-id="1f4d9-830">DBPROP_NOTIFYROWRESYNCH</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-831">Row Threading Model</span><span class="sxs-lookup"><span data-stu-id="1f4d9-831">Row Threading Model</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-832">DBPROP_ROWTHREADMODEL</span><span class="sxs-lookup"><span data-stu-id="1f4d9-832">DBPROP_ROWTHREADMODEL</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-833">Row Undo Change Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-833">Row Undo Change Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-834">DBPROP_NOTIFYROWUNDOCHANGE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-834">DBPROP_NOTIFYROWUNDOCHANGE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-835">Row Undo Delete Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-835">Row Undo Delete Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-836">DBPROP_NOTIFYROWUNDODELETE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-836">DBPROP_NOTIFYROWUNDODELETE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-837">Row Undo Insert Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-837">Row Undo Insert Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-838">DBPROP_NOTIFYROWUNDOINSERT</span><span class="sxs-lookup"><span data-stu-id="1f4d9-838">DBPROP_NOTIFYROWUNDOINSERT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-839">Row Update Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-839">Row Update Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-840">DBPROP_NOTIFYROWUPDATE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-840">DBPROP_NOTIFYROWUPDATE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-841">Rowset Fetch Position Change Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-841">Rowset Fetch Position Change Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-842">DBPROP_NOTIFYROWSETFETCHPOSITIONCHANGE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-842">DBPROP_NOTIFYROWSETFETCHPOSITIONCHANGE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-843">Rowset Release Notification</span><span class="sxs-lookup"><span data-stu-id="1f4d9-843">Rowset Release Notification</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-844">DBPROP_NOTIFYROWSETRELEASE</span><span class="sxs-lookup"><span data-stu-id="1f4d9-844">DBPROP_NOTIFYROWSETRELEASE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-845">Scroll Backwards</span><span class="sxs-lookup"><span data-stu-id="1f4d9-845">Scroll Backwards</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-846">DBPROP_CANSCROLLBACKWARDS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-846">DBPROP_CANSCROLLBACKWARDS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-847">Skip Deleted Bookmarks</span><span class="sxs-lookup"><span data-stu-id="1f4d9-847">Skip Deleted Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-848">DBPROP_BOOKMARKSKIP</span><span class="sxs-lookup"><span data-stu-id="1f4d9-848">DBPROP_BOOKMARKSKIP</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-849">Strong Row Identity</span><span class="sxs-lookup"><span data-stu-id="1f4d9-849">Strong Row Identity</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-850">DBPROP_STRONGIDENTITY</span><span class="sxs-lookup"><span data-stu-id="1f4d9-850">DBPROP_STRONGIDENTITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="1f4d9-851">Updatability</span><span class="sxs-lookup"><span data-stu-id="1f4d9-851">Updatability</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-852">DBPROP_UPDATABILITY</span><span class="sxs-lookup"><span data-stu-id="1f4d9-852">DBPROP_UPDATABILITY</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="1f4d9-853">Use Bookmarks</span><span class="sxs-lookup"><span data-stu-id="1f4d9-853">Use Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="1f4d9-854">DBPROP_BOOKMARKS</span><span class="sxs-lookup"><span data-stu-id="1f4d9-854">DBPROP_BOOKMARKS</span></span></p></td>
</tr>
</tbody>
</table>


## <a name="see-also"></a><span data-ttu-id="1f4d9-855">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="1f4d9-855">See also</span></span>

<span data-ttu-id="1f4d9-856">Pour plus d’informations concernant l’implémentation et des informations fonctionnelles sur le fournisseur Microsoft OLE DB pour ODBC, consultez le [Guide du programmeur OLE DB](https://docs.microsoft.com/previous-versions/windows/desktop/ms713643(v=vs.85)) ou visitez le [Centre de développement de plateforme de données](https://docs.microsoft.com/sql/connect/sql-data-developer?view=sql-server-2017).</span><span class="sxs-lookup"><span data-stu-id="1f4d9-856">For details regarding specific implementation and functional information about the Microsoft OLE DB Provider for ODBC, consult the [OLE DB Programmer's Guide](https://docs.microsoft.com/previous-versions/windows/desktop/ms713643(v=vs.85)) or visit the [Data Platform Developer Center](https://docs.microsoft.com/sql/connect/sql-data-developer?view=sql-server-2017).</span></span>
