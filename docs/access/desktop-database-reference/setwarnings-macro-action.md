...
---
# <a name="setwarnings-macro-action"></a><span data-ttu-id="3de16-102">SetWarnings, action de macro</span><span class="sxs-lookup"><span data-stu-id="3de16-102">SetWarnings macro action</span></span>

<span data-ttu-id="3de16-103">**S’applique à** : Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="3de16-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="3de16-104">L'action **Avertissements** permet d'activer ou de désactiver les messages système.</span><span class="sxs-lookup"><span data-stu-id="3de16-104">You can use the **SetWarnings** action to turn system messages on or off.</span></span>

> [!NOTE]
> <span data-ttu-id="3de16-105">Cette action ne sera pas autorisée si la base de données n’est pas approuvée.</span><span class="sxs-lookup"><span data-stu-id="3de16-105">This action will not be allowed if the database is not trusted.</span></span> 

## <a name="setting"></a><span data-ttu-id="3de16-106">Setting</span><span class="sxs-lookup"><span data-stu-id="3de16-106">Setting</span></span>

<span data-ttu-id="3de16-107">L’action **Avertissements** utilise les arguments suivants :</span><span class="sxs-lookup"><span data-stu-id="3de16-107">The **SetWarnings** action has the following argument.</span></span>
