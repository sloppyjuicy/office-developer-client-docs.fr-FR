...
---
# <a name="resync-method-example-vc"></a><span data-ttu-id="74725-102">Resync, méthode - Exemple (VC++)</span><span class="sxs-lookup"><span data-stu-id="74725-102">Resync Method Example (VC++)</span></span>


<span data-ttu-id="74725-103">**S’applique à**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="74725-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="74725-104">Cet exemple montre comment utiliser la méthode [Resync](resync-method-ado.md) pour actualiser les données d'un jeu d'enregistrements statique.</span><span class="sxs-lookup"><span data-stu-id="74725-104">This example demonstrates using the [Resync](resync-method-ado.md) method to refresh data in a static recordset.</span></span>
