...
Cet exemple illustre les méthodes [GetObjectOwner](getobjectowner-method-adox.md) et [SetObjectOwner](https://docs.microsoft.com/office/vba/access/concepts/miscellaneous/setobjectowner-method-adox). Ce code suppose l'existence du groupe Accounting (voir les [groupes et les utilisateurs Append, ChangePassword, méthodes-exemple (VB)](groups-and-users-append-changepassword-methods-example-vb.md) pour savoir comment ajouter ce groupe au système). Le propriétaire de la table Categories est Accounting.
