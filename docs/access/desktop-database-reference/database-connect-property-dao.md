...
Définit ou renvoie une valeur qui fournit des informations sur la source d'une base de données ouverte. Type de données **String** en lecture-écriture.
...
> [!NOTE]
> - Vous devez définir la propriété **Connect** avant la propriété **ReturnsRecords**.
