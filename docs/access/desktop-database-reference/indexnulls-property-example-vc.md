...
---
# <a name="indexnulls-property-example-vc"></a><span data-ttu-id="10c90-102">IndexNulls, propriété – Exemple (VC++)</span><span class="sxs-lookup"><span data-stu-id="10c90-102">IndexNulls property example (VC++)</span></span>
...
<span data-ttu-id="10c90-104">Cet exemple illustre la propriété [IndexNulls](indexnulls-property-adox.md) d’un objet [Index](index-object-adox.md).</span><span class="sxs-lookup"><span data-stu-id="10c90-104">This example demonstrates the [IndexNulls](indexnulls-property-adox.md) property of an [Index](index-object-adox.md).</span></span> <span data-ttu-id="10c90-105">Le code crée un index et définit la valeur de **IndexNulls** en fonction de l’entrée utilisateur.</span><span class="sxs-lookup"><span data-stu-id="10c90-105">The code creates a new index and sets the value of **IndexNulls** based on user input.</span></span> <span data-ttu-id="10c90-106">Ensuite, **l’index** est appendué à la [table](table-object-adox.md) **Employees** dans *le catalogue Northwind* [.](catalog-object-adox.md)</span><span class="sxs-lookup"><span data-stu-id="10c90-106">Then, the **Index** is appended to the **Employees** [Table](table-object-adox.md) in the *Northwind* [Catalog](catalog-object-adox.md).</span></span> <span data-ttu-id="10c90-107">Le nouvel objet **Index** est appliqué à un objet [Recordset](recordset-object-ado.md) basé sur la table **Employees** et le **Recordset** est ouvert.</span><span class="sxs-lookup"><span data-stu-id="10c90-107">The new **Index** is applied to a [Recordset](recordset-object-ado.md) based on the **Employees** table, and the **Recordset** is opened.</span></span> <span data-ttu-id="10c90-108">Un nouvel enregistrement est ajouté à la table **Employees**, avec la valeur **Null** dans le champ indexé.</span><span class="sxs-lookup"><span data-stu-id="10c90-108">A new record is added to the **Employees** table, with a **Null** value in the indexed field.</span></span> <span data-ttu-id="10c90-109">Selon le paramètre de la propriété **IndexNulls**, ce nouvel enregistrement est affiché ou non.</span><span class="sxs-lookup"><span data-stu-id="10c90-109">Whether this new record is displayed depends on the setting of the **IndexNulls** property.</span></span>
...
<span data-ttu-id="10c90-110">**IndexNullX.h**</span><span class="sxs-lookup"><span data-stu-id="10c90-110">**IndexNullX.h**</span></span>
