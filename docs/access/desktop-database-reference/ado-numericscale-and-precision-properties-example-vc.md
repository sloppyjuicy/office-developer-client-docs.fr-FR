...
---
# <a name="ado-numericscale-and-precision-properties-example-vc"></a><span data-ttu-id="ffce2-102">ADO NumericScale et preCision, propriétés-exemple (VC + +)</span><span class="sxs-lookup"><span data-stu-id="ffce2-102">ADO NumericScale and Precision properties example (VC++)</span></span>


<span data-ttu-id="ffce2-103">**S’applique à** : Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="ffce2-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="ffce2-104">Cet exemple utilise les propriétés [NumericScale](numericscale-property-ado.md) et [Precision](precision-property-ado.md) pour afficher l’échelle numérique et la précision des champs de la table ***Discounts*** dans la base de données ***Pubs***.</span><span class="sxs-lookup"><span data-stu-id="ffce2-104">This example uses the [NumericScale](numericscale-property-ado.md) and [Precision](precision-property-ado.md) properties to display the numeric scale and precision of fields in the ***Discounts*** table of the ***Pubs*** database.</span></span>
