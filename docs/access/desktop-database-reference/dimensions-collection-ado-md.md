...
Contient les objets [Dimension](dimension-object-ado-md.md) constituant un cube.

## <a name="remarks"></a>Remarques

**Dimensions** est une collection ADO standard. Avec les propriétés et méthodes d'une collection, vous pouvez :
