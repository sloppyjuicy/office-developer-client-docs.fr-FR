...
## <a name="parameters"></a>Paramètres
  ...
  - Valeur [AffectEnum](affectenum.md) qui détermine le nombre d'enregistrements concernés par la méthode **Delete**. La valeur par défaut est **adAffectCurrent**.


> [!NOTE]
> <P>[!REMARQUE] <STRONG>adAffectAll</STRONG> et <STRONG>adAffectAllChapters</STRONG> ne sont pas des arguments valides de la méthode <STRONG>Delete</STRONG>.</P>
