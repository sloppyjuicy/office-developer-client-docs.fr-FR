...
Une collection **Parameters** contient tous les objets **Parameters** d’un objet **QueryDef**.

## <a name="remarks"></a>Remarques

La collection **Parameters** fournit des informations relatives aux paramètres existants uniquement. Vous ne pouvez pas ajouter ou supprimer des objets de la collection **Parameters**.
