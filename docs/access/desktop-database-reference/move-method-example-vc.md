...
ms.locfileid: "25470180"
---
# <a name="move-method-example-vc"></a><span data-ttu-id="c027d-102">Move, méthode - Exemple (VC++)</span><span class="sxs-lookup"><span data-stu-id="c027d-102">Move Method Example (VC++)</span></span>

<span data-ttu-id="c027d-103">**S’applique à**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="c027d-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="c027d-104">Cet exemple utilise la méthode [Move](move-method-ado.md) pour positionner le pointeur d'enregistrement, selon l'entrée utilisateur.</span><span class="sxs-lookup"><span data-stu-id="c027d-104">This example uses the [Move](move-method-ado.md) method to position the record pointer based on user input.</span></span>
...
<span data-ttu-id="c027d-105">**MoveX.h**</span><span class="sxs-lookup"><span data-stu-id="c027d-105">**MoveX.h**</span></span>
