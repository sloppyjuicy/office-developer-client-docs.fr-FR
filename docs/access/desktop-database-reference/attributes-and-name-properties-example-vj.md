...
---
# <a name="attributes-and-name-properties-example-vj"></a><span data-ttu-id="7fe36-102">Attributes et Name, propriétés – Exemple (VJ++)</span><span class="sxs-lookup"><span data-stu-id="7fe36-102">Attributes and Name properties example (VJ++)</span></span>


<span data-ttu-id="7fe36-103">**S’applique à** : Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="7fe36-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="7fe36-p101">Cet exemple affiche la valeur de la propriété [Attributes](attributes-property-ado.md) des objets [Connection](connection-object-ado.md), [Field](field-object-ado.md) et [Property](property-object-ado.md). Il utilise la propriété [Name](name-property-ado.md) pour afficher le nom de chaque objet **Field** et **Property**.</span><span class="sxs-lookup"><span data-stu-id="7fe36-p101">This example displays the value of the [Attributes](attributes-property-ado.md) property for [Connection](connection-object-ado.md), [Field](field-object-ado.md), and [Property](property-object-ado.md) objects. It uses the [Name](name-property-ado.md) property to display the name of each **Field** and **Property** object.</span></span>
