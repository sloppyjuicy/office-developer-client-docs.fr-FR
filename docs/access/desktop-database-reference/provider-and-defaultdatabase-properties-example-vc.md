...
ms.locfileid: "25889832"
---
# <a name="provider-and-defaultdatabase-properties-example-vc"></a><span data-ttu-id="5fc8f-102">Provider et DefaultDatabase, propriétés – Exemple (VC++)</span><span class="sxs-lookup"><span data-stu-id="5fc8f-102">Provider and DefaultDatabase properties example (VC++)</span></span>


<span data-ttu-id="5fc8f-103">**S’applique à**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="5fc8f-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="5fc8f-p101">Cet exemple illustre la propriété [Provider](provider-property-ado.md) en ouvrant trois objets [Connection](connection-object-ado.md) provenant de différents fournisseurs. Il utilise également la propriété [DefaultDatabase](defaultdatabase-property-ado.md) pour définir la base de données par défaut du fournisseur Microsoft ODBC.</span><span class="sxs-lookup"><span data-stu-id="5fc8f-p101">This example demonstrates the [Provider](provider-property-ado.md) property by opening three [Connection](connection-object-ado.md) objects using different providers. It also uses the [DefaultDatabase](defaultdatabase-property-ado.md) property to set the default database for the Microsoft ODBC Provider.</span></span>
