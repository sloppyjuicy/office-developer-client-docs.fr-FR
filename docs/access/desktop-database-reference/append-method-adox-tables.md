...
*Tables*. Ajout*de Table*

## <a name="parameters"></a>Paramètres

  - *Table*

  - Valeur de type **Variant** qui contient une référence à la **table** à ajouter ou au nom de la table à créer et à ajouter.
