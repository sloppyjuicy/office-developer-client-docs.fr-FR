...
---
# <a name="openschema-method-example-vj"></a><span data-ttu-id="42b0b-102">OpenSchema, méthode – Exemple (VJ++)</span><span class="sxs-lookup"><span data-stu-id="42b0b-102">OpenSchema method example (VJ++)</span></span>


<span data-ttu-id="42b0b-103">**S’applique à** : Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="42b0b-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="42b0b-104">Cet exemple utilise la méthode [OpenSchema](openschema-method-ado.md) pour afficher le nom et le type de chaque table de la base de données ***Pubs***.</span><span class="sxs-lookup"><span data-stu-id="42b0b-104">This example uses the [OpenSchema](openschema-method-ado.md) method to display the name and type of each table in the ***Pubs*** database.</span></span>
