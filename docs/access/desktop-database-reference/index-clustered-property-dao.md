...
> - Pour les sources de données ODBC **** , la propriété Clustered renvoie toujours la **valeur false**; il ne détecte pas si la source de données ODBC dispose ou non d'un index cluster.
