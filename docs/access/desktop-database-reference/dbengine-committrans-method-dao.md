...
---
# <a name="dbenginecommittrans-method-dao"></a><span data-ttu-id="7dbef-102">DBEngine.CommitTrans, méthode (DAO)</span><span class="sxs-lookup"><span data-stu-id="7dbef-102">DBEngine.CommitTrans method (DAO)</span></span>


<span data-ttu-id="7dbef-103">**S’applique à** : Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="7dbef-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="7dbef-104">Met fin à la transaction en cours et enregistre les modifications.</span><span class="sxs-lookup"><span data-stu-id="7dbef-104">Ends the current transaction and saves the changes.</span></span>

## <a name="syntax"></a><span data-ttu-id="7dbef-105">Syntaxe</span><span class="sxs-lookup"><span data-stu-id="7dbef-105">Syntax</span></span>

<span data-ttu-id="7dbef-106">*.* CommitTrans(***Option***)</span><span class="sxs-lookup"><span data-stu-id="7dbef-106">*expression* .CommitTrans(***Option***)</span></span>

<span data-ttu-id="7dbef-107">*expression* Variable représentant un objet **DBEngine**.</span><span class="sxs-lookup"><span data-stu-id="7dbef-107">*expression* A variable that represents a **DBEngine** object.</span></span>

## <a name="parameters"></a><span data-ttu-id="7dbef-108">Paramètres</span><span class="sxs-lookup"><span data-stu-id="7dbef-108">Parameters</span></span>
