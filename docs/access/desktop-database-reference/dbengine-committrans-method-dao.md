...
ms.locfileid: "25870759"
---
# <a name="dbenginecommittrans-method-dao"></a><span data-ttu-id="1ddf2-102">DBEngine.CommitTrans Method (DAO)</span><span class="sxs-lookup"><span data-stu-id="1ddf2-102">DBEngine.CommitTrans Method (DAO)</span></span>


<span data-ttu-id="1ddf2-103">**S’applique à**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="1ddf2-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="1ddf2-104">Met fin à la transaction en cours et enregistre les modifications.</span><span class="sxs-lookup"><span data-stu-id="1ddf2-104">Ends the current transaction and saves the changes.</span></span>

## <a name="syntax"></a><span data-ttu-id="1ddf2-105">Syntaxe</span><span class="sxs-lookup"><span data-stu-id="1ddf2-105">Syntax</span></span>

<span data-ttu-id="1ddf2-106">*expression* . CommitTrans (***Option***)</span><span class="sxs-lookup"><span data-stu-id="1ddf2-106">*expression* .CommitTrans(***Option***)</span></span>

<span data-ttu-id="1ddf2-107">*expression* Variable qui représente un objet **DBEngine** .</span><span class="sxs-lookup"><span data-stu-id="1ddf2-107">*expression* A variable that represents a **DBEngine** object.</span></span>

### <a name="parameters"></a><span data-ttu-id="1ddf2-108">Paramètres</span><span class="sxs-lookup"><span data-stu-id="1ddf2-108">Parameters</span></span>
