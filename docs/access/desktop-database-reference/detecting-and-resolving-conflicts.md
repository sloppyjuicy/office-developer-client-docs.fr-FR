...
<span data-ttu-id="df6c9-128">Vous pouvez utiliser la propriété **Status** de l'objet **Record** actif ou d'un objet **Field** spécifique pour déterminer le type de conflit en cours.</span><span class="sxs-lookup"><span data-stu-id="df6c9-128">You can use the **Status** property of the current **Record** or of a specific **Field** to determine what kind of a conflict has occurred.</span></span>

<span data-ttu-id="df6c9-129">Pour plus d'informations sur la gestion des erreurs, consultez le [chapitre 6 : Gestion des erreurs](chapter-6-error-handling.md).</span><span class="sxs-lookup"><span data-stu-id="df6c9-129">For more detailed information on error handling, see [Chapter 6: Error Handling](chapter-6-error-handling.md).</span></span>
