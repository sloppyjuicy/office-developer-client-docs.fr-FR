...
> [!NOTE]
> Il n'est pas recommandé d'utiliser la propriété **PercentPosition** pour déplacer l'enregistrement actif vers un enregistrement spécifique dans un objet **Recordset** . La propriété **[Bookmark](recordset2-bookmark-property-dao.md)** est mieux adaptée à cette tâche.
