...
WillChangeRecordset** adStatus, adStatus, ** *Recordset*

RecordsetChangeComplete*adReason*, *perror*, adStatus, ** preobjet **
...
Un événement **WillChangeRecordset** ou **RecordsetChangeComplete** peut se produire en raison des méthodes Requery ou [Open](open-method-ado-recordset.md) de l' **objet Recordset** [](requery-method-ado.md) .
