...
---
# <a name="parametervalue-property-dao"></a><span data-ttu-id="484b6-102">Parameter.Value Property (DAO)</span><span class="sxs-lookup"><span data-stu-id="484b6-102">Parameter.Value Property (DAO)</span></span>


<span data-ttu-id="484b6-103">**S’applique à**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="484b6-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="484b6-p101">Définit ou renvoie la valeur d'un objet. Type de données **Variant** en lecture/écriture.</span><span class="sxs-lookup"><span data-stu-id="484b6-p101">Sets or returns the value of an object. Read/write **Variant**.</span></span>

## <a name="syntax"></a><span data-ttu-id="484b6-106">Syntaxe</span><span class="sxs-lookup"><span data-stu-id="484b6-106">Syntax</span></span>

<span data-ttu-id="484b6-107">*expression* . Valeur</span><span class="sxs-lookup"><span data-stu-id="484b6-107">*expression* .Value</span></span>

<span data-ttu-id="484b6-108">*expression* Variable qui représente un objet **Parameter** .</span><span class="sxs-lookup"><span data-stu-id="484b6-108">*expression* A variable that represents a **Parameter** object.</span></span>

## <a name="remarks"></a><span data-ttu-id="484b6-109">Remarques</span><span class="sxs-lookup"><span data-stu-id="484b6-109">Remarks</span></span>

<span data-ttu-id="484b6-110">Le paramètre ou la valeur de retour est un type de données Variant qui est évalué à une valeur appropriée pour le type de données, tel que spécifié par la propriété **Type** d'un objet.</span><span class="sxs-lookup"><span data-stu-id="484b6-110">The setting or return value is a Variant data type that evaluates to a value appropriate for the data type, as specified by the **Type** property of an object.</span></span>

<span data-ttu-id="484b6-111">En général, la propriété **Value** est utilisée pour récupérer et modifier les données dans les objets **Recordset**.</span><span class="sxs-lookup"><span data-stu-id="484b6-111">Generally, the **Value** property is used to retrieve and alter data in **Recordset** objects.</span></span>
