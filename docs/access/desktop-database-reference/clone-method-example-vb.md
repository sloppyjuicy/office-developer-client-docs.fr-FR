...
ms.locfileid: "32296352"
---
# <a name="clone-method-example-vb"></a><span data-ttu-id="6f407-102">Clone, méthode – Exemple (VB)</span><span class="sxs-lookup"><span data-stu-id="6f407-102">Clone method example (VB)</span></span>


<span data-ttu-id="6f407-103">**S’applique à** : Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="6f407-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="6f407-104">Cet exemple utilise la méthode [Clone](clone-method-ado.md) pour créer des copies d'un objet [Recordset](recordset-object-ado.md) puis permet à l'utilisateur de positionner le pointeur d'enregistrement de chaque copie indépendamment des autres.</span><span class="sxs-lookup"><span data-stu-id="6f407-104">This example uses the [Clone](clone-method-ado.md) method to create copies of a [Recordset](recordset-object-ado.md) and then lets the user position the record pointer of each copy independently.</span></span>
