...
La documentation ADO contient des exemples VBScript plus spécifiques. Pour plus d’informations, voir [exemples de code ADO en Microsoft Visual Basic Scripting Edition](ado-code-examples-in-microsoft-visual-basic-scripting-edition.md).
