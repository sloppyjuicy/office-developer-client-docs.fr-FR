...
ms.openlocfilehash: 4c4cc5b1befffcdec0218600efb358a37d2a99e5
ms.sourcegitcommit: a1d9041c20256616c9c183f7d1049142a7ac6991
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59590120"
---
...
> [!NOTE]
> [!REMARQUE] Collez tout l'exemple de code, du début à la fin, dans votre éditeur de code. Il se peut que l'exemple ne s'exécute pas correctement si vous utilisez des exemples partiels ou ne respectez pas la mise en forme de paragraphes.
...
- [CompareBookmarks, méthode - Exemple](comparebookmarks-method-example-vb.md)
- [ConvertToString, méthode - Exemple](converttostring-method-example-vb.md)
- [CopyRecord, CopyTo et SaveToFile, méthodes - Exemple](copyrecord-copyto-and-savetofile-methods-example-vb.md)
- [CreateRecordset, méthode - Exemple](createrecordset-method-example-vb.md)
- [Delete, méthode - Exemple](delete-method-example-vb.md)
- [DeleteRecord et MoveRecord, méthodes - Exemple](deleterecord-and-moverecord-methods-example-vb.md)
...
- [Méthode Seek et propriété Index - Exemple](seek-method-and-index-property-example-vb.md)
...
- [Propriétés EOS et LineSeparator, méthode SkipLine - Exemple](eos-and-lineseparator-properties-and-skipline-method-example-vb.md)
...
- [Type, propriété - Exemple (Field)](type-property-example-field-vb.md)
