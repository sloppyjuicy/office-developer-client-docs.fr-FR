...
Compare deux expressions. Lorsque vous comparez des expressions non nulles, le résultat est TRUE si l'opérande gauche a une valeur inférieure à celle de l'opérande droit; dans le cas contraire, le résultat est FALSe.
