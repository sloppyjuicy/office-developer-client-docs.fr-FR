---
title: QuitterPourChaqueEnregistrement, Action de Macro (accès personnalisé web app)
manager: kelbow
ms.date: 09/05/2017
...
ms.locfileid: "19781808"
---
# <a name="exitforeachrecord-macro-action-access-custom-web-app"></a><span data-ttu-id="65d08-103">QuitterPourChaqueEnregistrement, Action de Macro (accès personnalisé web app)</span><span class="sxs-lookup"><span data-stu-id="65d08-103">ExitForEachRecord Macro Action (Access custom web app)</span></span>
