...
Renvoie une valeur numérique qui représente la partie de la date spécifiée de la date spécifiée.
...
|:-----|:-----|
| *DatePart*  <br/> |Partie de la *Date* (valeur de date ou d'heure) pour laquelle un entier est renvoyé. RePortez-vous à la section Remarques pour obtenir la liste des abréviations valides.  <br/> |
