...
|<span data-ttu-id="435cb-130">Mode</span><span class="sxs-lookup"><span data-stu-id="435cb-130">Mode</span></span>  |<span data-ttu-id="435cb-131">Description</span><span class="sxs-lookup"><span data-stu-id="435cb-131">Description</span></span>  |<span data-ttu-id="435cb-132">Lorsque la résolution change</span><span class="sxs-lookup"><span data-stu-id="435cb-132">When DPI changes</span></span>  |
|---------|---------|---------|
|<span data-ttu-id="435cb-133">Système PPP ignoré</span><span class="sxs-lookup"><span data-stu-id="435cb-133">DPI unaware</span></span> |  <span data-ttu-id="435cb-134">L’application s’affiche toujours comme si elle est sur une résolution de valeur 96.</span><span class="sxs-lookup"><span data-stu-id="435cb-134">Application always renders as if it is on a display with a DPI value of 96.</span></span> |  <span data-ttu-id="435cb-135">L’application est étirée bitmap à la taille attendue sur l’affichage principal et secondaire.</span><span class="sxs-lookup"><span data-stu-id="435cb-135">Application is bitmap stretched to expected size on primary and secondary displays.</span></span>    |
|<span data-ttu-id="435cb-136">Système PPP pris en compte</span><span class="sxs-lookup"><span data-stu-id="435cb-136">System DPI aware</span></span> |  <span data-ttu-id="435cb-137">L’application détecte la résolution du moniteur principal connecté à Windows, mais ne peut pas répondre aux modifications PPP.</span><span class="sxs-lookup"><span data-stu-id="435cb-137">Application detects the DPI of the primary connected monitor at Windows login but cannot respond to DPI changes.</span></span> <span data-ttu-id="435cb-138">Pour plus d’informations, voir la section [Configurer Windows pour corriger les](#configure-windows-to-fix-blurry-apps) applications floues dans cet article.</span><span class="sxs-lookup"><span data-stu-id="435cb-138">For more information, see the [Configure Windows to fix blurry apps](#configure-windows-to-fix-blurry-apps) section in this article.</span></span>  | <span data-ttu-id="435cb-139">L’application est étirée bitmap lorsqu’elle est déplacée vers un nouvel affichage avec une résolution différente.</span><span class="sxs-lookup"><span data-stu-id="435cb-139">Application is bitmap stretched when moved to a new display with a different DPI.</span></span>    |
|<span data-ttu-id="435cb-140">Par moniteur PPP pris en compte</span><span class="sxs-lookup"><span data-stu-id="435cb-140">Per Monitor DPI aware</span></span> |  <span data-ttu-id="435cb-141">L’application est capable de s’afficher correctement d’elle-même lorsque le PPP change.</span><span class="sxs-lookup"><span data-stu-id="435cb-141">Application is capable of redrawing itself correctly when the DPI changes.</span></span>  |   <span data-ttu-id="435cb-142">Windows envoie des notifications PPP aux fenêtres de niveau supérieur dans l’application, de sorte qu’elle peut ajuster son affichage en cas de modification de la résolution.</span><span class="sxs-lookup"><span data-stu-id="435cb-142">Windows will send DPI notifications to top-level windows in the application so that it can redraw when the DPI changes.</span></span>     |
|<span data-ttu-id="435cb-143">Par moniteur v2</span><span class="sxs-lookup"><span data-stu-id="435cb-143">Per Monitor v2</span></span> |  <span data-ttu-id="435cb-144">L’application est capable de s’afficher correctement d’elle-même lorsque le PPP change.</span><span class="sxs-lookup"><span data-stu-id="435cb-144">Application is capable of redrawing itself correctly when the DPI changes.</span></span>  |   <span data-ttu-id="435cb-145">Windows envoie des notifications PPP aux fenêtres de niveau supérieur et aux fenêtres enfants dans l’application, de sorte qu’elle peut ajuster son affichage en cas de modification de la résolution.</span><span class="sxs-lookup"><span data-stu-id="435cb-145">Windows will send DPI notifications to both top-level and child windows so that the application can redraw when the DPI changes.</span></span> |

## <a name="how-office-supports-dpi-scaling"></a><span data-ttu-id="435cb-146">Comment Office prend en charge la mise à l’échelle PPP</span><span class="sxs-lookup"><span data-stu-id="435cb-146">How Office supports DPI scaling</span></span>

<span data-ttu-id="435cb-147">Le facteur le plus significatif dans la détermination de comment votre solution Office peut gérer la mise à l’échelle PPP est si votre solution est une fenêtre de niveau supérieur ou une fenêtre enfant.</span><span class="sxs-lookup"><span data-stu-id="435cb-147">The most significant factor in determining how your Office solution can handle DPI scaling is whether your solution is a top-level window, or a child window.</span></span> <span data-ttu-id="435cb-148">L’image suivante montre quelques exemples de solutions Office opérationnelles en tant que fenêtres de niveau supérieur ou enfants, et quel mode de présence PPP elles utilisent sur la mise à jour Windows avril 2018 (1803) et versions ultérieures.</span><span class="sxs-lookup"><span data-stu-id="435cb-148">The following picture shows a few examples of Office solutions running as top-level or child windows, and which DPI awareness mode they will use on Windows April 2018 Update (1803) and later.</span></span>
...
<span data-ttu-id="435cb-152">Dans cette image :</span><span class="sxs-lookup"><span data-stu-id="435cb-152">In this image:</span></span>
...
#### <a name="native-code-context-block"></a><span data-ttu-id="435cb-173">Bloc de contexte code natif</span><span class="sxs-lookup"><span data-stu-id="435cb-173">Native code context block</span></span>
...
<h2 id="top-level-window-management"><span data-ttu-id="435cb-174">Gestion de fenêtre de niveau supérieur</span><span class="sxs-lookup"><span data-stu-id="435cb-174">Top-level window management</span></span></h2>
...
## <a name="office-and-windows-dpi-compatibility-settings"></a><span data-ttu-id="435cb-210">Paramètres de compatibilité Office et Windows PPP</span><span class="sxs-lookup"><span data-stu-id="435cb-210">Office and Windows DPI compatibility settings</span></span>
...
## <a name="how-to-support-dpi-scaling-in-your-solution"></a><span data-ttu-id="435cb-225">Comment prendre en charge le redimensionnement PPP dans votre solution</span><span class="sxs-lookup"><span data-stu-id="435cb-225">How to support DPI scaling in your solution</span></span>
...
<tr>
        <td><span data-ttu-id="435cb-244">Enfant apparenté à la fenêtre Office</span><span class="sxs-lookup"><span data-stu-id="435cb-244">Child parented to Office window</span></span></td>
...
<tr>
    ...
    <tr>
        ...
        <td><span data-ttu-id="435cb-266">N/A</span><span class="sxs-lookup"><span data-stu-id="435cb-266">NA</span></span></td>
...
<h3 id="custom-task-panes"><span data-ttu-id="435cb-280">Volets des tâches personnalisés</span><span class="sxs-lookup"><span data-stu-id="435cb-280">Custom task panes</span></span></h3>
...
<h3 id="ribbon-extensibility"><span data-ttu-id="435cb-310">Extensibilité du ruban </span><span class="sxs-lookup"><span data-stu-id="435cb-310">Custom ribbon extensibility</span></span></h3>
...
## <a name="see-also"></a><span data-ttu-id="435cb-335">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="435cb-335">See also</span></span>
...
### <a name="code-samples"></a><span data-ttu-id="435cb-345">Exemples de code</span><span class="sxs-lookup"><span data-stu-id="435cb-345">Code samples</span></span>
