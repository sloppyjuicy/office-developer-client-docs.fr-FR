...
<span data-ttu-id="e842a-270">Identifie un objet COM de la consommation de communication bidirectionnelle.</span><span class="sxs-lookup"><span data-stu-id="e842a-270">Identifies the consumer's COM object for two-way communication.</span></span> <span data-ttu-id="e842a-271">Doit être vide avec un maximum de 39 caractères.</span><span class="sxs-lookup"><span data-stu-id="e842a-271">Must be non-empty with a maximum of 39 characters.</span></span> <span data-ttu-id="e842a-272">Voir [ \<ProgID\> clé](http://msdn.microsoft.com/en-us/library/ms690196.aspx.aspx) pour plus d’informations sur le ProgID.</span><span class="sxs-lookup"><span data-stu-id="e842a-272">See [\<ProgID\> Key](http://msdn.microsoft.com/en-us/library/ms690196.aspx.aspx) for more information on ProgIDs.</span></span> 
