...
|UICat  <br/> |Détermine la catégorie d’un champ inséré. Cette cellule est utilisée par les boîtes de dialogue Champ et Format de données pour déterminer les informations de champ et de catégorie. |[UICategory, cellule (section Text Fields)](uicategory-cell-text-fields-section.md) <br/> |
|UICod  <br/> |Détermine le code d’un champ inséré. Cette cellule est utilisée par les boîtes de dialogue Champ et Format de données pour déterminer les informations de champ et de catégorie. |[UICode, cellule (section Text Fields)](uicode-cell-text-fields-section.md) <br/> |
