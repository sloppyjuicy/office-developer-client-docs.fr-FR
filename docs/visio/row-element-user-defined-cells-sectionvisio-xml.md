---
title: Élément de ligne (section cellules définies par l’utilisateur) (XML Visio)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="row-element-user-defined-cells-section-visio-xml"></a>Élément de ligne (section cellules définies par l’utilisateur) (XML Visio)
