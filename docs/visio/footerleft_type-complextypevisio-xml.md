---
title: Type complexe FooterLeft_Type (« Visio XML »)
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "25396798"
---
# <a name="footerlefttype-complextype-visio-xml"></a>Type complexe FooterLeft_Type (« Visio XML »)
