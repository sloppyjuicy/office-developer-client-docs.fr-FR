---
title: Élément de ligne (section dégradé de remplissage) (XML Visio)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="row-element-fill-gradient-section-visio-xml"></a>Élément de ligne (section dégradé de remplissage) (XML Visio)
