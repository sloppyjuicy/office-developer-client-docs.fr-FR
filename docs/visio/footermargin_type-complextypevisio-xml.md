...
ms.locfileid: "19788684"
---
# <a name="footermargintype-complextype-visio-xml"></a>Type complexe FooterMargin_Type (« Visio XML »)
...
|:-----|:-----|:-----|:-----|:-----|
|Unité  <br/> |XSD : String  <br/> |facultatif  <br/> ||Valeurs du type xsd : String.  <br/> |
