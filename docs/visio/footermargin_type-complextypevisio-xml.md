...
---
# <a name="footermargintype-complextype-visio-xml"></a>ComplexType FooterMargin_Type (Visio XML)
...
|:-----|:-----|:-----|:-----|:-----|
|Unit  <br/> |xsd: String  <br/> |facultatif  <br/> ||Valeurs du type xsd: String.  <br/> |
