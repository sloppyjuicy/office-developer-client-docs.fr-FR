...
---
# <a name="rulesetflags-element-rulesettype-complextype-visio-xml"></a>Élément RuleSetFlags (complexType RuleSet_Type) (XML Visio)
...
|:-----|:-----|:-----|:-----|:-----|
|Hidden  <br/> |xsd: Boolean  <br/> |facultatif  <br/> |Indique si l’ensemble de règles apparaît dans la liste règles à vérifier.  <br/> |Valeurs du type xsd: Boolean.  <br/> |
