...
Contient x- ou la coordonnée y du sommet de fin d’un segment de trait droit.
...
|:-----|:-----|:-----|
|[Row, élément (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[LineTo_Type](lineto_type-complextypevisio-xml.md) <br/> |Contient x- ou la coordonnée y du sommet de fin d’un segment de trait droit.  <br/> |
