...
Contrôle le type de comportement de la coordonnée *y* de la poignée de contrôle une fois que cette dernière a été déplacée. Les formules suivantes sont disponibles. 
...
| n°2  <br/> | Décalé du bord inférieur  <br/> | La poignée de contrôle est décalée d'une valeur constante par rapport au bas de la forme.  <br/> |**visCtlOffsetMin** <br/> |
...
|||
|:-----|:-----|
| Nom de la cellule :  <br/> | Vérifie.  *nom* . Contrôles YConwhere.  *Name* est le nom de la ligne Controls.  <br/> |
