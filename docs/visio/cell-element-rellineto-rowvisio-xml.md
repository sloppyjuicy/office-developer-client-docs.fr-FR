...
ms.openlocfilehash: d985a1abe2ab61f52cc6d718119e5dc0f68f05a6
ms.sourcegitcommit: 7b410a51d1e8c97e9cce8d4aa75074162b7d9485
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 03/12/2022
ms.locfileid: "63448439"
---
...
|:-----|:-----|:-----|
|[Élément Row (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[RelLineTo_Type](rellineto_type-complextypevisio-xml.md) <br/> |Contient les coordonnées x ou y du sommet de fin d’un segment de trait droit par rapport à la largeur et à la hauteur d’une forme. |
...
|:-----|:-----|:-----|
|X  <br/> |Coordonnée x du sommet de fin d’un segment de trait droit par rapport à la largeur de la forme. |[RelLineTo Row (Geometry Section)](rellineto-row-geometry-section.md) <br/> |
|v  <br/> |Coordonnée y du sommet de fin d’un segment de trait droit par rapport à la hauteur de la forme. |[RelLineTo Row (Geometry Section)](rellineto-row-geometry-section.md) <br/> |
