...
Pour obtenir une référence à la cellule IndFirst par un nom à partir d’une autre formule ou d’un programme à la propriété **CellsU** , utilisez : 
  
|||
|:-----|:-----|
| Nom de la cellule :  <br/> | Para.IndFirst [ *i* ] où *i* = < 1 >, 2, 3...  <br/> |
   
Pour obtenir une référence à la cellule IndFirst par index dans un programme, utilisez la propriété **CellsSRC** avec les arguments suivants : 
