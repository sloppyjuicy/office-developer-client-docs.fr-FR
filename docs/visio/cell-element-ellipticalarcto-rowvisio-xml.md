---
title: Élément de cellule (ligne EllipticalArcTo) (XML Visio)
manager: soliver
ms.date: 03/09/2015
...
description: Contient les coordonnées x ou y du point de terminaison d’un arc elliptique, les coordonnées x ou y des points de contrôle de l’arc, l’angle entre l’axe x et l’axe principal de l’ellipse, ou le rapport entre les axes principal et secondaire de l’ellipse.
...
---
# <a name="cell-element-ellipticalarcto-row-visio-xml"></a>Élément de cellule (ligne EllipticalArcTo) (XML Visio)

Contient les coordonnées x ou y du point de terminaison d’un arc elliptique, les coordonnées x ou y des points de contrôle de l’arc, l’angle entre l’axe x et l’axe principal de l’ellipse, ou le rapport entre les axes principal et secondaire de l’ellipse.
...
|:-----|:-----|:-----|
|[Élément de ligne (géométrie)](row-element-geometry-sectionvisio-xml.md) <br/> |[EllipticalArcTo_Type](ellipticalarcto_type-complextypevisio-xml.md) <br/> |Contient les coordonnées x ou y du point de terminaison d’un arc elliptique, les coordonnées x ou y des points de contrôle de l’arc, l’angle entre l’axe x et l’axe principal de l’ellipse, ou le rapport entre les axes principal et secondaire de l’ellipse.  <br/> |
