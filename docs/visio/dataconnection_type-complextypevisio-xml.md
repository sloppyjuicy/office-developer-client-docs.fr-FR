...
---
# <a name="dataconnectiontype-complextype-visio-xml"></a>Type complexe DataConnection_Type (« Visio XML »)
...
|:-----|:-----|:-----|:-----|:-----|
|AlwaysUseConnectionFile  <br/> |type xsd : Boolean  <br/> |facultatif  <br/> ||Valeurs du type de type xsd : Boolean.  <br/> |
