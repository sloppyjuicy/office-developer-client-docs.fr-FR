...
---
# <a name="issues-element-validationtype-complextype-visio-xml"></a>Élément issues (Validation_Type complexType) (XML Visio)

Contient tous les éléments de problème pour le document.
