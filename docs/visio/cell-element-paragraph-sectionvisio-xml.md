---
title: Élément de cellule (section paragraphe) (XML Visio)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="cell-element-paragraph-section-visio-xml"></a>Élément de cellule (section paragraphe) (XML Visio)
