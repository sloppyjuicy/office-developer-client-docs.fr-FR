...
---
# <a name="colors-element-visiodocumenttype-complextype-visio-xml"></a>Colors, élément (VisioDocument_Type complexType) (Visio XML)
...
|**Élément**|**Type**|**Description**|
|:-----|:-----|:-----|
|[ColorEntry](colorentry-element-colors_type-complextypevisio-xml.md) <br/> |[ColorEntry_Type](colorentry_type-complextypevisio-xml.md) <br/> |Contient une entrée de table de couleurs.  <br/> |
