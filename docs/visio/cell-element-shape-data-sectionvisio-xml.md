...
|:-----|:-----|:-----|
|[Row, élément (Section Shape Data)](row-element-shape-data-sectionvisio-xml.md) <br/> |[Forme type_de_données](propertyrow_type-complextypevisio-xml.md) <br/> |Spécifie une entrée de données de forme pour associer les données à une forme.  <br/> |
...
|Invisible  <br/> |Spécifie si l’élément de données de forme est visible dans la fenêtre données de forme.  <br/> |[Invisible, cellule (section Shape Data)](invisible-cell-shape-data-section.md) <br/> |
|Étiquette  <br/> |Indique l’intitulé qui s’affiche dans la fenêtre données de forme. Une étiquette est constituée de caractères alphanumériques, y compris le caractère de soulignement (_).  <br/> |[Label, cellule (section Shape Data)](label-cell-shape-data-section.md) <br/> |
...
|Prompt  <br/> |Spécifie le texte descriptif ou d’instructions qui apparaît comme une info-bulle lorsque vous positionnez la souris sur une valeur dans la fenêtre données de forme.  <br/> |[Prompt, cellule (section Shape Data)](prompt-cell-shape-data-section.md) <br/> |
|SortKey  <br/> |Correspond à une chaîne qui détermine l’ordre dans lequel les éléments dans la fenêtre données de forme sont répertoriés.  <br/> |[SortKey, cellule (section Shape Data)](sortkey-cell-shape-data-section.md) <br/> |
|Type  <br/> |Indique le type des données de forme.  <br/> |[Type, cellule (section Shape Data)](type-cell-shape-data-section.md) <br/> |
|Valeur  <br/> |Contient la valeur de l’élément de données de forme entré dans la boîte de dialogue Définir les données de forme.  <br/> |[Value, cellule (section Shape Data)](value-cell-shape-data-section.md) <br/> |
