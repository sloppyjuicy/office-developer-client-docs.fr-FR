...
description: Cette référence contient une rubrique de présentation conceptuelle et des rubriques de référence, y compris des exemples, qui vous guideront dans le développement de solutions avec le format de fichier Visio.
...
Cette référence contient une rubrique de présentation conceptuelle et des rubriques de référence, y compris des exemples, qui vous guideront dans le développement\*de solutions avec le format de fichier Visio (. vsdx).
...
- [Elements](elementsvisio-xml.md): fournit des informations sur les éléments XML pouvant apparaître au format de fichier Visio.
