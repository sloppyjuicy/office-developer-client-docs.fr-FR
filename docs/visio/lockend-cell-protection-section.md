...
Pour obtenir une référence à la cellule LockEnd par un nom à partir d’une autre formule ou d’un programme à la propriété **CellsU** , utilisez : 
  
|||
|:-----|:-----|
| Nom de la cellule :  <br/> | LockEnd  <br/> |
   
Pour obtenir une référence à la cellule LockEnd par index dans un programme, utilisez la propriété **CellsSRC** avec les arguments suivants : 
