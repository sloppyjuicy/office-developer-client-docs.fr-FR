...
Pour obtenir une référence à la cellule DontMoveChildren par un nom à partir d’une autre formule ou d’un programme à la propriété **CellsU** , utilisez : 
  
|||
|:-----|:-----|
| Nom de la cellule :  <br/> | DontMoveChildren  <br/> |
   
Pour obtenir une référence à la cellule DontMoveChildren par index dans un programme, utilisez la propriété **CellsSRC** avec les arguments suivants : 
