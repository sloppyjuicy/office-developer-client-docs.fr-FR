...
---
# <a name="cell-element-relcubbezto-row-visio-xml"></a>Élément de cellule (ligne RelCubBezTo) (XML Visio)

Contient les coordonnées x ou y du point de fin d’une courbe de Bézier cubique par rapport à la largeur et la hauteur de la forme, les coordonnées x ou y du point de contrôle du début de la largeur et de la hauteur de la forme relative de la courbe, ou les coordonnées x ou y du point de contrôle de la fin de la largeur et de la hauteur de la forme relative de courbe.
...
|:-----|:-----|:-----|
|[Élément de ligne (géométrie)](row-element-geometry-sectionvisio-xml.md) <br/> |[RelCubBezTo_Type](relcubbezto_type-complextypevisio-xml.md) <br/> |Contient les coordonnées x ou y du point de fin d’une courbe de Bézier cubique par rapport à la largeur et la hauteur de la forme, les coordonnées x ou y du point de contrôle du début de la largeur et de la hauteur de la forme relative de la courbe, ou les coordonnées x ou y du point de contrôle de la fin de la largeur et de la hauteur de la forme relative de courbe.  <br/> |
...
|v  <br/> |Coordonnée y du sommet de fin d’une courbe de Bézier cubique par rapport à la hauteur de la forme.  <br/> |[RelCubBezTo Row (Geometry Section)](relcubbezto-row-geometry-section.md) <br/> |
|A  <br/> |Coordonnée x du point de contrôle de début de la courbe par rapport à la largeur de la forme; point sur l’arc. Le point de contrôle est le mieux situé entre les sommets de début et de fin de l’arc.  <br/> |[RelCubBezTo Row (Geometry Section)](relcubbezto-row-geometry-section.md) <br/> |
...
|C  <br/> |Coordonnée x du point de contrôle de fin de la courbe par rapport à la largeur de la forme; point sur l’arc. Le point de contrôle est le mieux situé entre le point de contrôle de début et les sommets de fin de l’arc.  <br/> |[RelCubBezTo Row (Geometry Section)](relcubbezto-row-geometry-section.md) <br/> |
