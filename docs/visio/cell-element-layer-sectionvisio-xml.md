---
title: Élément de cellule (section calque) («Visio XML»)
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "32318171"
---
# <a name="cell-element-layer-section-visio-xml"></a>Élément de cellule (section calque) («Visio XML»)
