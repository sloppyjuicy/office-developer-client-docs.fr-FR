---
title: Élément de ligne (section paragraphe) ('Visio XML')
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "32283576"
---
# <a name="row-element-paragraph-section-visio-xml"></a>Élément de ligne (section paragraphe) ('Visio XML')
