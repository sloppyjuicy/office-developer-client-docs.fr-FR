...
Détermine si la page peut être dupliquée, sous la forme d'une valeur booléenne.
  
|||
|:-----|:-----|
|TRUE  <br/> |**** Les doublons dans le menu contextuel page et la méthode Automation **page. Duplicate** sont tous deux désactivés pour la page.  <br/> |
|FALSE  <br/> |La page peut être dupliquée.  <br/> |
   
## <a name="remarks"></a>Remarques

Pour obtenir une référence à la cellule **PageLockDuplicate** par un nom à partir d'une autre formule, par valeur de l'attribut **N** d'un élément de **cellule** ou d'un programme en faisant appel à la propriété **CellsU** , utilisez: 
