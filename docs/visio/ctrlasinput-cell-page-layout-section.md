...
Pour obtenir une référence à la cellule CtrlAsInput par un nom à partir d’une autre formule ou d’un programme à la propriété **CellsU** , utilisez : 
  
|||
|:-----|:-----|
| Nom de la cellule :  <br/> | CtrlAsInput  <br/> |
   
Pour obtenir une référence à la cellule CtrlAsInput par index dans un programme, utilisez la propriété **CellsSRC** avec les arguments suivants : 
