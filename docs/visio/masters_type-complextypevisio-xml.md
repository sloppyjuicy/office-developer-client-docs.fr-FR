...
---
# <a name="masterstype-complextype-visio-xml"></a>Type complexe Masters_Type (« Visio XML »)
...
|:-----|:-----|:-----|
|[Forme de base](master-element-masters_type-complextypevisio-xml.md) <br/> |[Master_Type](master_type-complextypevisio-xml.md) <br/> ||
