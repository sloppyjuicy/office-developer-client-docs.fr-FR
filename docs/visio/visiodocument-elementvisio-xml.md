...
---
# <a name="visiodocument-element-visio-xml"></a>Élément VisioDocument (XML Visio)

Élément racine d’un document Microsoft Visio.
...
|[PublishSettings](publishsettings-element-visiodocument_type-complextypevisio-xml.md) <br/> |[PublishSettings_Type](publishsettings_type-complextypevisio-xml.md) <br/> |Cette énumération spécifie l’ensemble des pages de dessin pouvant être affichées et des jeux d’enregistrements qui sont actualisables dans un dessin.  <br/> |
