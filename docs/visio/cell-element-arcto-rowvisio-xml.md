...
Contient le x coordonnée, coordonnée y ou courbure d’un arc circulaire.
...
|**Élément**|**Type**|**Description**|
|:-----|:-----|:-----|
|[RefBy](refby-element-cell_type-complextypevisio-xml.md) <br/> |[RefBy_Type](refby_type-complextypevisio-xml.md) <br/> |Contient le x coordonnée, coordonnée y ou courbure d’un arc circulaire.  <br/> |
