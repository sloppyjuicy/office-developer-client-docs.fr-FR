...
---
# <a name="facenamestype-complextype-visio-xml"></a>Type complexe FaceNames_Type (« Visio XML »)
...
|:-----|:-----|:-----|
|[Nom de la police](facename-element-facenames_type-complextypevisio-xml.md) <br/> |[FaceName_Type](facename_type-complextypevisio-xml.md) <br/> ||
