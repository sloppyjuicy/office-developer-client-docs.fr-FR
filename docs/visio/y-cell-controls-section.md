...
Représente la coordonnée *y* qui indique l'emplacement de la poignée de contrôle d'une forme en coordonnées locales. 
...
|||
|:-----|:-----|
| Nom de cellule :  <br/> | Vérifie.  *nom* . Contrôles Yoù.  *Name* est le nom de la ligne Controls.  <br/> |
