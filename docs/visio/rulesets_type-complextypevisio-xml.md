...
---
# <a name="rulesetstype-complextype-visio-xml"></a>Type complexe RuleSets_Type (« Visio XML »)
...
|:-----|:-----|:-----|
|[Ensemble de règles](ruleset-element-rulesets_type-complextypevisio-xml.md) <br/> |[RuleSet_Type](ruleset_type-complextypevisio-xml.md) <br/> ||
