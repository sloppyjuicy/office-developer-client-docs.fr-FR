...
|:-----|:-----|:-----|
| Centimètres  <br/> | Manager  <br/> |**visCentimeters (69)** <br/> |
| Cicéros  <br/> | c  <br/> |**visCiceros (54)** <br/> |
| Date ou heure  <br/> | date  <br/> |**visDate (40)** <br/> |
| Degrees  <br/> | °  <br/> |**visDegrees (81)** <br/> |
| Didots  <br/> | d  <br/> |**visDidots (53)** <br/> |
| Semaines écoulées  <br/> | ouveau  <br/> |**visElapsedWeek (43)** <br/> |
| Jours écoulés  <br/> | non  <br/> |**visElapsedDay (44)** <br/> |
| Heures écoulées  <br/> | IA  <br/> |**visElapsedHour (45)** <br/> |
| Minutes écoulées  <br/> | em  <br/> |**visElapsedMin (46)** <br/> |
| Secondes écoulées  <br/> | es  <br/> |**visElapsedSec (47)** <br/> |
| Ft  <br/> | pied  <br/> |**visFeet (66)** <br/> |
| Po  <br/> | dans  <br/> |**visInches (65)** <br/> |
| Km  <br/> | accueillant  <br/> |**visKilometers (72)** <br/> |
| Débitmètre  <br/> | m  <br/> |**visMeters (71)** <br/> |
| Kilomètres  <br/> | mi  <br/> |**visMiles (68)** <br/> |
| Millimètres  <br/> | mm  <br/> |**visMillimeters (70)** <br/> |
| Minutes  <br/> | '  <br/> |**visMin (84)** <br/> |
| Milles nautiques  <br/> | Gravure  <br/> |**visNautMiles (76)** <br/> |
...
| Pieds et pouces  <br/> | MÈTRES/POUCE  <br/> |**visFeetAndInches (67)** <br/> |
...
Vous pouvez spécifier des unités de mesure en fraction dans la cellule **DrawingScale** pour modifier le nombre de graduations de la règle que Visio affiche dans la fenêtre de dessin. Par défaut, les unités des règles sont divisés en dixièmes. Si vous utilisez des unités de mesure en fraction dans la cellule **DrawingScale** , Visio divise la distance comme suit: 
...
|:-----|:-----|:-----|
| Acre  <br/> | HA  <br/> |**visAcre (36)** <br/> |
| Centimètres  <br/> | CM. CARRE, CM CARRE, CM.^2, CM^2  <br/> |**visCentimeters (69)** <br/> |
| Ft  <br/> | PI. CARRE, PI CARRE, PIEDS^2, PI^2  <br/> |**visFeet (66)** <br/> |
| Hectare  <br/> | HECTARES, HECTARE, HA., HA  <br/> |**visHectare (37)** <br/> |
| Po  <br/> | PO. CARRE, PO CARRE, POUCES^2, PO^2  <br/> |**visInches (65)** <br/> |
| Km  <br/> | KM. CARRE, KM CARRE, KM.^2, KM ^2  <br/> |**visKilometers (72)** <br/> |
| Débitmètre  <br/> | M. CARRE, M CARRE, M.^2, M ^2  <br/> |**visMeters (71)** <br/> |
| Kilomètres  <br/> | MI. CARRE, MI CARRE, MI.^2, MI ^2  <br/> |**visMiles (68)** <br/> |
...
|**For**|**Utiliser**|
|:-----|:-----|
| Centimètres  <br/> | Manager  <br/> |
| Cicéros  <br/> | C  <br/> |
| Cicéros et didots  <br/> | CICERO/DIDOT  <br/> |
| Date ou heure  <br/> | JOURS  <br/> |
| Degrees  <br/> | °  <br/> |
| Degrés, minutes, secondes  <br/> | °  <br/> |
| Didots  <br/> | D  <br/> |
| Semaine écoulée  <br/> | OUVEAU  <br/> |
| Jour écoulé  <br/> | ED  <br/> |
| Heure écoulée  <br/> | IA  <br/> |
| Minute écoulée  <br/> | 1/2  <br/> |
| Seconde écoulée  <br/> | E-mail  <br/> |
| Ft  <br/> | PIED  <br/> |
| Pieds et pouces  <br/> | MÈTRES/POUCE  <br/> |
| Po  <br/> | DANS  <br/> |
| Pouces avec leurs divisions  <br/> | IN_F  <br/> |
| Km  <br/> | ACCUEILLANT  <br/> |
| Débitmètre  <br/> | M  <br/> |
| Kilomètres  <br/> | INITIALE  <br/> |
| Miles avec leurs divisions  <br/> | MI_F  <br/> |
| Millimètres  <br/> | MM  <br/> |
| Minutes  <br/> | '  <br/> |
| Milles nautiques  <br/> | Gravure  <br/> |
| Pourcentage  <br/> | %  <br/> |
| Picas  <br/> | P  <br/> |
...
| _non_ <br/> |Unités dans lesquelles le _nombre_ est à l'origine exprimé.  <br/> |
...
L' _indicateur_ de paramètre est l'une des lettres suivantes (majuscules ou minuscules) indiquant le système de mesure à utiliser lorsque l'unité de valeur implicite est affichée. 
...
|**visTypeUnits** <br/> |Unités sélectionnées dans la zone de **texte** sous **affichage** dans l'onglet options **avancées** de la boîte de dialogue **options Visio** (cliquez sur l'onglet **fichier** , puis sur **options**).  <br/> |
