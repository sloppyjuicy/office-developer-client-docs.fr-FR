...
ms.locfileid: "25401418"
---
# <a name="footermargin-element-headerfootertype-complextype-visio-xml"></a>FooterMargin, élément (HeaderFooter_Type, complexType) (« Visio XML »)

Indique la marge du pied de page d’un document.
...
|:-----|:-----|:-----|:-----|:-----|
|Unité  <br/> |XSD : String  <br/> |facultatif  <br/> |Représente une unité de mesure. La valeur par défaut est in.  <br/> |Valeurs du type xsd : String.  <br/> |
