...
Contient les coordonnées x ou y du point de contrôle ou le nœud d’une spline.
...
|:-----|:-----|:-----|
|[Row, élément (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[SplineKot_Type](splineknot_type-complextypevisio-xml.md) <br/> |Contient les coordonnées x ou y du point de contrôle ou le nœud d’une spline.  <br/> |
