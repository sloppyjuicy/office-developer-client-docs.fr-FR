...
---
# <a name="cell-element-splineknot-row-visio-xml"></a>Élément de cellule (ligne SplineKnot) (XML Visio)
...
|:-----|:-----|:-----|
|[Élément de ligne (géométrie)](row-element-geometry-sectionvisio-xml.md) <br/> |[SplineKot_Type](splineknot_type-complextypevisio-xml.md) <br/> |Contient des coordonnées x ou y pour le point de contrôle d’une spline ou le nœud d’une spline.  <br/> |
