---
title: Type complexe StencilGroup_Type (« Visio XML »)
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "25391345"
---
# <a name="stencilgrouptype-complextype-visio-xml"></a>Type complexe StencilGroup_Type (« Visio XML »)
