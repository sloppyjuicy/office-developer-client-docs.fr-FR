---
title: ComplexType StencilGroup_Type ('Visio XML')
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "32329868"
---
# <a name="stencilgrouptype-complextype-visio-xml"></a>ComplexType StencilGroup_Type ('Visio XML')
