...
Détermine la largeur de la plaque du haut en points. 
  
## <a name="remarks"></a>Remarques

Pour obtenir une référence à la cellule **BevelTopWidth** par un nom à partir d'une autre formule, par valeur de l'attribut **N** d'un élément de **cellule** ou d'un programme en faisant appel à la propriété **CellsU** , utilisez: 
