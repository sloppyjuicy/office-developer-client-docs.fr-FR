---
title: Élément FooterCenter (HeaderFooter_Type complexType) (Visio XML)
manager: soliver
ms.date: 03/09/2015
...
description: Contient la chaîne de texte qui apparaît dans la partie centrale du pied de ligne d’un document.
