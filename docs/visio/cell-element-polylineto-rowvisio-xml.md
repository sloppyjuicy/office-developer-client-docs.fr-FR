...
ms.openlocfilehash: f72bf2eca1ad0e6b306373d00a9414e85980d73b
ms.sourcegitcommit: c0fae34cd3a9c75a7cffcf9ae8e417ddde07a989
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 02/12/2022
ms.locfileid: "62774516"
---
...
|:-----|:-----|:-----|
|[Élément Row (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[PolylineTo_Type](polylineto_type-complextypevisio-xml.md) <br/> |Contient les coordonnées x ou y du dernier point d’une polyligne ou d’une formule polyligne. |
...
|:-----|:-----|:-----|
|X  <br/> |Coordonnée x du sommet de fin d'une polyligne. |[PolylineTo, ligne (section Geometry)](polylineto-row-geometry-section.md) <br/> |
|v  <br/> |Coordonnée y du sommet de fin d'une polyligne. |[PolylineTo, ligne (section Geometry)](polylineto-row-geometry-section.md) <br/> |
|A  <br/> |Formule de la polyligne. |[PolylineTo, ligne (section Geometry)](polylineto-row-geometry-section.md) <br/> |
