...
ms.locfileid: "32282585"
---
# <a name="quickstylelinematrix-cell-quick-style-section"></a>QuickStyleLineMatrix Cell (Quick Style Section)

Détermine le style de ligne rapide hérité par la forme, sous la forme d'un nombre entier compris entre 0-6. 
  
## <a name="remarks"></a>Remarques

Pour obtenir une référence à la cellule **QuickStyleLineMatrix** par un nom à partir d'une autre formule, par valeur de l'attribut **N** d'un élément de **cellule** ou d'un programme en faisant appel à la propriété **CellsU** , utilisez: 
