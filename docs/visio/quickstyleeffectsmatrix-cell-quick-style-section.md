...
Détermine les effets de style rapide que la forme hérite du thème actif, sous la forme d'un nombre entier compris entre 0-6. 
  
## <a name="remarks"></a>Remarques

Pour obtenir une référence à la cellule **QuickStyleEffectsMatrix** par un nom à partir d'une autre formule, par valeur de l'attribut **N** d'un élément de **cellule** ou d'un programme en faisant appel à la propriété **CellsU** , utilisez: 
