...
Pour obtenir une référence à la cellule PageBottomMargin par un nom à partir d’une autre formule ou d’un programme à la propriété **CellsU** , utilisez : 
  
|||
|:-----|:-----|
| Nom de la cellule :  <br/> | PageBottomMargin  <br/> |
   
Pour obtenir une référence à la cellule PageBottomMargin par index dans un programme, utilisez la propriété **CellsSRC** avec les arguments suivants : 
