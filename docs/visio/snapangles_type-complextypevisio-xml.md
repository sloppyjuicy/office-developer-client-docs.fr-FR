---
title: Type complexe SnapAngles_Type (« Visio XML »)
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "25399073"
---
# <a name="snapanglestype-complextype-visio-xml"></a>Type complexe SnapAngles_Type (« Visio XML »)
