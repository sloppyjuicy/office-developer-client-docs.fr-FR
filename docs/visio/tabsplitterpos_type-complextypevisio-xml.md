---
title: Type complexe TabSplitterPos_Type (« Visio XML »)
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "25398793"
---
# <a name="tabsplitterpostype-complextype-visio-xml"></a>Type complexe TabSplitterPos_Type (« Visio XML »)
