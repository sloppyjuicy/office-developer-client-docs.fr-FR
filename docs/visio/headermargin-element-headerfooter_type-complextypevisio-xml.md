...
ms.locfileid: "19788763"
---
# <a name="headermargin-element-headerfootertype-complextype-visio-xml"></a>HeaderMargin, élément (HeaderFooter_Type, complexType) (« Visio XML »)

Indique la marge de l’en-tête d’un document.
...
|:-----|:-----|:-----|:-----|:-----|
|Unité  <br/> |XSD : String  <br/> |facultatif  <br/> |Représente une unité de mesure. La valeur par défaut est le point de distribution.  <br/> |Valeurs du type xsd : String.  <br/> |
