...
Renvoie l'arctangente d'un nombre, par exemple, l'angle dont la tangente a la _valeur nombre_. L’angle obtenu se situe dans la limite -PI/2 <= angle <= PI/2 radians (soit -90 <= angle <= 90 degrés). 
