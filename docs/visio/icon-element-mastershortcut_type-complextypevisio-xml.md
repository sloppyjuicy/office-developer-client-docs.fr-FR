---
title: Élément Icon (MasterShortcut_Type complexType) (XML Visio)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="icon-element-mastershortcuttype-complextype-visio-xml"></a>Élément Icon (MasterShortcut_Type complexType) (XML Visio)
...
|:-----|:-----|:-----|
|[MasterShortcut](mastershortcut-element-masters_type-complextypevisio-xml.md) <br/> |[MasterShortcut_Type](mastershortcut_type-complextypevisio-xml.md) <br/> |Spécifie un format de base non utilisé.  <br/> |
