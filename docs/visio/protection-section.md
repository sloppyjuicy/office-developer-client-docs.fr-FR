...
Affiche les paramètres de verrouillage actuels définis à l'aide de la commande **protection** (onglet [développeur](run-in-developer-mode-display-the-developer-tab.md) ), ainsi que quelques verrous supplémentaires qui ne peuvent être définis que dans une fenêtre ShapeSheet. 
...
Pour empêcher la modification d'une formule, utilisez la fonction **Guard** . 
