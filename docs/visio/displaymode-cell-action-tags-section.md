...
Détermine si la balise d'action apparaît lorsque l'utilisateur déplace le pointeur sur la balise, quand la forme est sélectionnée ou tout le temps.
...
| 0,1  <br/> | Apparaît tant que la forme est sélectionnée.  <br/> |**visSmartTagDispModeShapeSelected** <br/> |
| n°2  <br/> | Apparaît tout le temps.  <br/> |**visSmartTagDispModeAlways** <br/> |
...
|||
|:-----|:-----|
| Nom de cellule :  <br/> | SmartTag.  *nom* . DisplayMode où SmartTags. *Name* est le nom de la ligne de balise d'action  <br/> |
