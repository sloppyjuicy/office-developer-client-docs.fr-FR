...
Détermine l'angle de l'éclair par rapport au biseau en degrés. 
  
## <a name="remarks"></a>Remarques

Pour obtenir une référence à la cellule **BevelLightingAngle** par un nom à partir d'une autre formule, par valeur de l'attribut **N** d'un élément de **cellule** ou d'un programme en faisant appel à la propriété **CellsU** , utilisez: 
