...
ms.locfileid: "19788010"
---
# <a name="alignment-section"></a>Alignment,section

Indique l’alignement d’une forme en ce qui concerne la Controls.x pointez sur laquelle la forme est collée. La section **Alignment** s’affiche uniquement pour les formes attachées aux repères. 
