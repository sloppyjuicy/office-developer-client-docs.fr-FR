...
---
# <a name="master-element-masterstype-complextype-visio-xml"></a>Élément Master (Masters_Type complexType) (XML Visio)
...
|Hidden  <br/> |xsd: Boolean  <br/> |facultatif  <br/> |Indique si la forme de base est masquée dans l’interface utilisateur.  <br/> |Valeurs du type xsd: Boolean.  <br/> |
