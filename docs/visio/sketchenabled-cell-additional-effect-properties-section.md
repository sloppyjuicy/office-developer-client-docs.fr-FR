...
Détermine si un effet d'esquisse est affiché sur la forme ou non, en tant que valeur booléenne. 
  
## <a name="remarks"></a>Remarques

Pour obtenir une référence à la cellule **SketchEnabled** par un nom à partir d'une autre formule, par valeur de l'attribut **N** d'un élément de **cellule** ou d'un programme en faisant appel à la propriété **CellsU** , utilisez: 
