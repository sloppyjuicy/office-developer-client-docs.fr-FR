...
---
# <a name="cell-element-user-defined-cells-section-visio-xml"></a>Élément de cellule (section cellules définies par l’utilisateur) (XML Visio)

Une propriété d’une information spécifiée par l’utilisateur qui peut être référencée par d’autres cellules et outils complémentaires.
...
|:-----|:-----|:-----|
|[Élément de ligne (section cellules définies par l’utilisateur)](row-element-user-defined-cells-sectionvisio-xml.md) <br/> |[UserRow_Type](userrow_type-complextypevisio-xml.md) <br/> |Une propriété d’une information spécifiée par l’utilisateur qui peut être référencée par d’autres cellules et outils complémentaires.  <br/> |
