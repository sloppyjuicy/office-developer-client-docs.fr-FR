...
Si vous souhaitez lier un contrôle de contenu de section répétitif à un tableau, insérez le tableau, *puis* le contrôle de contenu de section répétitif, et non l'inverse. (Sinon, vous ne pourrez pas sélectionner uniquement le tableau).
