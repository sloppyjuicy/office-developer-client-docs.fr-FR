...
> [!NOTE]
> [!REMARQUE] Vous voulez développer des solutions qui étendent l'expérience Office sur [plusieurs plateformes](https://docs.microsoft.com/en-us/office/dev/add-ins/overview/office-add-in-availability) ? Consultez le nouveau [modèle de compléments Office](https://docs.microsoft.com/en-us/office/dev/add-ins/). 
...
- [Prendre en main des compléments PowerPoint](https://docs.microsoft.com/en-us/office/dev/add-ins/quickstarts/powerpoint-quickstart)
  
- [Présentation de la plateforme](https://docs.microsoft.com/en-us/office/dev/add-ins/overview/office-add-ins)
  
### <a name="code-samples"></a>Exemples de code
  
- [Exemples de code de PowerPoint dans le Centre pour développeurs Office](https://dev.office.com/code-samples#?filters=powerpoint)
  
### <a name="other-resources"></a>Autres ressources

- [Référence de la bibliothèque d'objets VBA Office](https://msdn.microsoft.com/en-us/VBA/Office-Shared-VBA/articles/office-vba-object-library-reference)

- [Référence de langage VBA pour Office](https://msdn.microsoft.com/en-us/VBA/VBA-Language-Reference) 

- [Ouvrir le Kit de développement logiciel (SDK) XML](https://msdn.microsoft.com/en-us/library/bb448854.aspx)
