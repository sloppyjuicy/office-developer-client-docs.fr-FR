...
- <span data-ttu-id="3e3b9-110">En cas d'échec d'une contrainte de validation personnalisée.</span><span class="sxs-lookup"><span data-stu-id="3e3b9-110">When a custom validation constraint fails.</span></span>
