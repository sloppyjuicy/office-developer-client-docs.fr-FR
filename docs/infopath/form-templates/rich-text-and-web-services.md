...
1. <span data-ttu-id="c52dc-133">Ouvrez le concepteur de formulaires InfoPath.</span><span class="sxs-lookup"><span data-stu-id="c52dc-133">Open the InfoPath form designer.</span></span>
