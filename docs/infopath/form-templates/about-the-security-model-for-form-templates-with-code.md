...
Pour plus d’informations sur la création et la configuration du groupe de codes Modèles de formulaire InfoPath, voir Configurer les paramètres de sécurité des modèles de formulaire [avec code.](how-to-configure-security-settings-for-form-templates-with-code.md)
